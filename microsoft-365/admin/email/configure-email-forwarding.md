...
- Depois de configurar o encaminhamento de email, somente **novos** emails enviados para a caixa  *de*  correio serão encaminhados.

- O encaminhamento de email requer que  *a conta de*  o usuário tenha uma licença. Se você estiver configurando o encaminhamento de email porque o usuário saiu da sua organização, outra opção é converter sua caixa de correio em [uma caixa de correio compartilhada.](convert-user-mailbox-to-shared-mailbox.md) Dessa forma, várias pessoas podem acessá-lo. No entanto, uma caixa de correio compartilhada não pode exceder 50 GB.

Você deve ser um administrador do Exchange ou um administrador global no Microsoft 365 para seguir estas etapas. Para obter mais informações, consulte o tópico [Sobre funções de administrador.](../add-users/about-admin-roles.md)
...
4. Na página de encaminhamento de email, selecione Encaminhar todos os **emails** enviados para essa caixa de correio, insira o endereço de encaminhamento e escolha se deseja manter uma cópia dos emails encaminhados. Se você não vir essa opção, certifique-se de que uma licença está atribuída à conta de usuário. Selecione **Salvar alterações**.
...
5. Não exclua a conta do usuário que está encaminhando ou remova a licença dele!  Se você fizer isso, o encaminhamento de email será parada.

::: moniker-end

::: moniker range="o365-germany"

1. No centro de administração, vá para a página **Usuários** \> **[Ativos.](https://go.microsoft.com/fwlink/p/?linkid=847686)**
...
1. No centro de administração, vá para a página **Usuários** \> **[Ativos.](https://go.microsoft.com/fwlink/p/?linkid=850628)**
