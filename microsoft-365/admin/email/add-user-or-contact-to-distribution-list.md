...
ms.locfileid: "44400167"
---
# <a name="add-a-user-or-contact-to-a-distribution-group"></a>Adicionar um usuário ou contato a um grupo de distribuição

Como administrador de uma organização, talvez seja necessário adicionar um de seus usuários ou contatos a um grupo de distribuição (consulte [Create Distribution groups in Microsoft 365](../setup/create-distribution-lists.md).) Por exemplo, você pode adicionar funcionários ou parceiros ou fornecedores externos a um grupo de distribuição de email.
...
Saiba como [Enviar email como um grupo de distribuição no Microsoft 365](../manage/send-email-as-distribution-list.md).
