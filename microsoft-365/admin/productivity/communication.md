...
Para começar com as informações de comunicação, as pessoas em sua organização precisam ser licenciadas para:
...
Para Comunicação, fornecemos uma visão principal, que contém as principais métricas associadas à comunicação em sua organização, combinada com uma estrutura de pontuação para usar essas métricas para calcular a pontuação da sua organização.
...
4. **Exibir recursos de comunicação:** Clicar aqui incluiria todo o conteúdo de suporte na forma de vídeos/artigos relacionados à Comunicação. A partir deles, você pode navegar até a playlist personalizada para Comunicação e, subsequentemente, para todas as categorias de Pontuação de Produtividade.

#### <a name="trend-visualization-of-primary-insight"></a>Visualização de tendências do insight primário

 Este gráfico fornece a tendência do numerador da métrica principal no insight principal , ou seja, o número de pessoas em sua organização usando mais de um modo de comunicação nos últimos 180 dias. Aqui, o valor diário é um agregado do número de pessoas que usam várias formas de comunicação nos últimos 28 dias.
...
A pontuação de comunicação da sua organização mede em um nível agregado (organização) se as pessoas estão se comunicando consistentemente usando vários modos entre emails, chats e postagens de comunidade em uma janela de 28 dias.  
...
Também fornecemos informações que ajudam você a obter visibilidade sobre como sua organização se comunica. Essas métricas adicionais não influenciam diretamente sua Pontuação de Produtividade, mas podem ajudá-lo a criar um plano de ação como parte da transformação digital.

### <a name="breakdown-of-communication-by-modes"></a>Divisão da comunicação por modos
...
3. **Visualização:** Divide a taxa de resposta para novos threads de email com base na @mentions ou não:

   - **Respostas a emails com \@ menções:** A parte colorida e a fração representam a taxa de resposta para novos threads de email que contêm @mentions. Esta fração é construída a partir de:
   ...
   - **Respostas a emails sem \@ menções:** A parte colorida e a fração representam a taxa de resposta para novos threads de email que contêm @mentions. Esta fração é construída a partir de:
...
3. **Visualização:** Interrompe o uso do recurso perguntas e respostas em sua organização:
   ...
   - **Perguntas com as melhores respostas:** A parte colorida da barra e o número associado representa o número de postagens que foram marcadas como perguntas e também receberam uma melhor resposta nos &quot; &quot; últimos 28 dias.
