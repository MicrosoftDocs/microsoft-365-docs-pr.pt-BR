...
Microsoft OneDrive para Empresas e SharePoint ajudar as pessoas a criar, ler e descobrir seu conteúdo individual e compartilhado em Microsoft 365 entre dispositivos e aplicativos. Eles também permitem que as pessoas compartilhem e colaborem com segurança no conteúdo. O insight principal contém informações de todos que podem usar OneDrive for Business e SharePoint. Além disso, ele divide os detalhes sobre quantas pessoas leem, criam e colaboram no conteúdo armazenado em OneDrive for Business e SharePoint.
...
1. **Header:** Mostra a porcentagem de pessoas em sua organização que têm acesso OneDrive ou SharePoint que estão colaborando no conteúdo.
...
3. **Visualização (estado atual):**
    - Barras horizontais onde as partes coloridas em azul representam a porcentagem de pessoas habilitadas para colaboração de  arquivos por meio de OneDrive ou SharePoint que foram **leitores,** criadores ou colaboradores em arquivos online nos últimos 28 dias.

        Eles são definidos da seguinte forma:</br>
        **Leitores:** Pessoas que acessam ou baixam arquivos online OneDrive ou SharePoint.</br>
        **Criadores:** Pessoas que criam, modificam, carregam, sincronizam, verificam, copiam ou movem arquivos OneDrive ou SharePoint online.</br>
        **Colaboradores:** Pessoas que colaboram com arquivos online usando OneDrive ou SharePoint. Duas pessoas serão colaboradoras se uma delas ler ou editar um arquivo Aplicativo do Office ou PDF online após a outra pessoa ter criado ou modificado, em uma janela de 28 dias.

        > [!NOTE]
        > Os arquivos considerados na visualização são arquivos Word, Excel, PowerPoint, OneNote ou PDF que estão online e salvos em OneDrive ou SharePoint. 
    ...
    - O destaque (numerador/denominador) da fração é usado para calcular a porcentagem expressa em cada uma das barras horizontais.
      ...
      - **Leitores:**</br>
          - Numerador: número de pessoas que acessam ou baixam arquivos online OneDrive ou SharePoint nos últimos 28 dias</br>
          - Denominador: número de pessoas que tiveram acesso OneDrive ou SharePoint pelo menos um dos últimos 28 dias</br>
      - **Criadores:**</br>
        - Numerador: número de pessoas que criam, modificam, carregam, sincronizam, verificam, copiam ou movem arquivos online OneDrive ou SharePoint nos últimos 28 dias</br>
        - Denominador: Número de pessoas que tiveram acesso a OneDrive ou SharePoint pelo menos um dos últimos 28 dias. </br> 
      - **Colaboradores:**</br>
        - Numerador: número de pessoas que colaboraram em arquivos online OneDrive ou SharePoint nos últimos 28 dias</br>
        - Denominador: número de pessoas que tiveram acesso a OneDrive ou SharePoint pelo menos um dos últimos 28 dias

    - O valor de referência par para cada um dos leitores, criadores e colaboradores também é mostrado como uma porcentagem. Em outras palavras, o valor do número de criadores é mostrado como uma porcentagem do número de pessoas que têm acesso a OneDrive ou SharePoint.
...
A pontuação de colaboração de conteúdo para sua organização mede em um nível agregado (organização) se as pessoas estão lendo, criando ou colaborando consistentemente em arquivos de Office online, como Word, Excel, PowerPoint, OneNote ou PDFs, ou em OneDrive ou SharePoint.
...
### <a name="creating-files-in-onedrive-or-sharepoint"></a>Criar arquivos em OneDrive ou SharePoint
...
1. **Header:** Realça a porcentagem de pessoas ativas Microsoft 365 Office aplicativos que criam arquivos OneDrive ou SharePoint.
2. **Corpo:** Fornece informações sobre o valor da criação de conteúdo em OneDrive e SharePoint.
3. **Visualização:** A divisão na visualização representa até que ponto as pessoas que estão usando Microsoft Office aplicativos para criar arquivos em OneDrive e SharePoint, da seguinte maneira:
      - **OneDrive:** A parte azul (colorida) da barra e a fração na barra representam a porcentagem de pessoas ativas em aplicativos Office criando conteúdo no OneDrive da seguinte forma:
        - Numerador: o número de pessoas que criam, modificam, carregam, sincronizam, verificam, copiam ou movem arquivos online Office arquivos OneDrive nos últimos 28 dias.</br>
        - Denominador: o número de pessoas que têm acesso a OneDrive ou SharePoint e acessar arquivos do office nos últimos 28 dias.
      - **SharePoint:** A parte azul (colorida) da barra e a fração na barra representam a porcentagem de pessoas que estão ativas em aplicativos Office e criam conteúdo em SharePoint como:</br>
         - Numerador: o número de pessoas que criam, modificam, carregam, sincronizam, verificam, copiam ou movem arquivos Office online (arquivos Microsoft Word, Excel, PowerPoint ou OneNote) no SharePoint nos últimos 28 dias.</br>
        - Denominador: o número de pessoas que têm acesso a OneDrive ou SharePoint e acessaram Office arquivos nos últimos 28 dias.
...
**Uso de anexos no email** Entenda quantos usuários estão anexando arquivos físicos no email em vez de links para conteúdo na nuvem e monitore a redução desse número ao longo do tempo.

:::image type="content" source="../../media/emailattachments.png" alt-text="Uso de anexos de email.":::

1. **Header:** Realça a porcentagem de pessoas que usam anexos em emails que não foram salvos para OneDrive ou SharePoint.
...
3. **Visualização:** A divisão na visualização deve representar a extensão em que as pessoas que estão anexando conteúdo nos emails estão usando modos diferentes (arquivos que não estão no OneDrive ou no SharePoint; links para arquivos online e links incorporados no email):
      - **Anexar arquivos:** A parte azul (colorida) da barra e a fração (numerador/denominador) na barra representa a porcentagem de pessoas que usam anexos em emails.
        - Numerador: o número de pessoas que anexam arquivos a emails que não foram salvos OneDrive ou SharePoint nos últimos 28 dias.
        - Denominador: o número de pessoas que tiveram acesso a Exchange e OneDrive, SharePoint, ou ambos nos últimos 28 dias.
      - **Links para arquivos online:** A parte azul (colorida) da barra e a fração (numerador/denominador) na barra representam a porcentagem de pessoas usando anexos e anexando links a arquivos em emails.
        - Numerador: o número de pessoas anexando links a arquivos online (salvos OneDrive ou SharePoint) aos emails nos últimos 28 dias.
        - Denominador: o número de pessoas que têm acesso a Exchange e OneDrive, SharePoint, ou ambos nos últimos 28 dias.
4. **Link para recursos:** Selecione este link para exibir o conteúdo da ajuda.
...
1. **Header:** Realça a porcentagem de pessoas que têm acesso a OneDrive ou SharePoint que estão compartilhando arquivos externamente.
...
3. **Visualização:** Representa até que ponto as pessoas que têm acesso a OneDrive ou SharePoint estão compartilhando arquivos interna ou externamente:
      - **Externamente:** A parte azul (colorida) da barra e a fração (numerador/denominador) na barra representam a porcentagem de pessoas que têm acesso a OneDrive ou SharePoint e estão compartilhando arquivos externamente.
        -  Numerador: o número de pessoas que compartilharam arquivos externamente nos últimos 28 dias
        - Denominador: o número total de pessoas que tiveram acesso OneDrive ou SharePoint pelo menos um dos últimos 28 dias.
      - **Somente internamente:** A parte azul (colorida) da barra e a fração (numerador/denominador) na barra representam a porcentagem de pessoas que têm acesso a OneDrive ou SharePoint e estão compartilhando arquivos internamente apenas.
...
1. **Header:** Realça a porcentagem de pessoas que têm acesso a OneDrive ou SharePoint que estão colaborando em 4 ou mais arquivos.
2. **Corpo:** Fornece informações sobre como as pessoas podem aproveitar arquivos online para melhor colaboração.
3. **Visualização:** Mostra uma distribuição das pessoas que têm acesso a OneDrive ou SharePoint, com base no número de arquivos em que colaboram. Isso é mostrado pelas 4 categorias a seguir (para cada uma, a parte azul da barra e a fração representam a porcentagem de pessoas que têm acesso a OneDrive ou SharePoint que se enquadram nessa categoria):
      - **Nenhuma colaboração:**
        - Numerador: número de pessoas que não colaboraram em nenhum arquivo nos últimos 28 dias.
        - Denominador: Número total de pessoas que têm acesso OneDrive ou SharePoint pelo menos um dos últimos 28 dias.
      - **Colaboração em arquivos de 1 a 3:**
        - Numerador: número de pessoas colaborando em arquivos de 1 a 3 nos últimos 28 dias.
        - Denominador: Número total de pessoas que tiveram acesso a OneDrive ou SharePoint pelo menos um dos últimos 28 dias.
...
1. **Header:** Realça a porcentagem de dispositivos fora de todos os testados que têm conexão de rede ruim para OneDrive e SharePoint. 
2. **Corpo:** Fornece informações sobre por que o desempenho da conexão de rede é importante para a colaboração. 
3. **Visualização:** Mostra uma porcentagem de dispositivos com níveis diferentes de desempenho de conectividade de rede relacionados OneDrive e SharePoint:
