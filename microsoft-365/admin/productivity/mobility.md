...
Para começar a ter ideias de mobilidade, as pessoas em sua organização precisam ser licenciadas para:
...
3. **Visualização:** A vertical agrupada deve representar o número de pessoas que estão usando cada um dos aplicativos considerados– Word, Excel, PowerPoint e OneNote — em plataformas simples ou múltiplas. Para cada um desses aplicativos, as barras representam o seguinte:
      ...
      - **Somente web:** O número de usuários ativos no aplicativo apenas na plataforma Web nos últimos 28 dias.
      - **Somente para dispositivos móveis:** O número de usuários ativos no aplicativo somente na plataforma móvel nos últimos 28 dias.
