...
|Conformidade do dispositivo|Definir e gerenciar políticas de segurança, como bloqueio de PIN de nível de dispositivo e detecção de jailbreak. |Limitações no Android 9 e dispositivos posteriores. Para obter detalhes, consulte [recursos de mobilidade básica e segurança](capabilities-of-basic-mobility-and-secruity.md).|Sim|
...
|Configuração do dispositivo  |Definir configurações de dispositivo (por exemplo, desabilitar a câmera). |Conjunto limitado de configurações.Para obter detalhes, consulte [recursos de mobilidade básica e segurança](capabilities-of-basic-mobility-and-secruity.md). |Sim|
