...
4. Os usuários que tiverem uma política aplicada a eles serão solicitados a registrar seus dispositivos quando tentarem acessar os dados do Microsoft 365. Para saber mais, confira [registrar seu dispositivo móvel usando mobilidade básica e segurança](enroll-your-mobile-device-using-basic-mobility-and-security.md).

Para obter mais detalhes, consulte [Configurar mobilidade básica e segurança](set-up-basic-mobility-and-security.md).
...
Se o registro ainda não funcionar, confira [solucionar problemas de mobilidade básica e segurança](troubleshoot-basic-mobility-and-security.md).
...
Para obter instruções detalhadas sobre como criar e implantar políticas de dispositivo, consulte [Create Device Security Policies in Basic Mobility and Security](create-device-security-policies-in-basic-mmobility-and-security.md).
