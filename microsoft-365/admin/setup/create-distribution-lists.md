...
Grupos de distribuição às vezes são chamados de listas de distribuição.
...
2. Selecione **Grupos** \> **grupos** no painel de navegação esquerdo e selecione **Adicionar um grupo**. 
      
3. No campo **Escolher um tipo de** grupo, escolha **Distribuição** e escolha **Próximo**.
  
4. Insira um nome, descrição e alias de email para seu novo grupo e escolha se deseja que pessoas de fora da sua organização enviem emails para o grupo. 
