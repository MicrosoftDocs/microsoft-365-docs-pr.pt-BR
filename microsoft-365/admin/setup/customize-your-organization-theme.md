...
Sua experiência na guia Geral depende se você está adicionando ou modificando o tema padrão ou um tema de grupo.

### <a name="update-the-default-theme"></a>Atualizar o tema padrão

O tema padrão é o primeiro tema exibido.  

1. Se você personalizou anteriormente um tema para sua organização, **selecione** Tema Padrão e use uma de suas personalizações salvas ou, selecione **Adicionar tema**.
2. Na página **Geral,** você pode impedir que os usuários sobressuam o tema e mostrar o nome de exibição do usuário.
...
Você pode criar até quatro temas de grupo adicionais.

1. Na página **Geral,** insira um nome para seu novo tema.
...
Na página **Cores,** você pode definir as cores padrão e escolher qual logotipo deve ser usado.
...
Somente administradores globais podem personalizar temas da empresa.Leitores globais têm acesso somente leitura.

### <a name="how-many-different-themes-can-i-set-up-for-my-organization"></a>Quantos temas diferentes posso configurar para minha organização?  
...
Os usuários atribuídos a vários temas de grupo serão mostrados como tema padrão.  

### <a name="why-cant-i-delete-the-default-theme"></a>Por que não posso excluir o tema padrão?  

O tema padrão só pode ser excluído depois que todos os temas do grupo são excluídos. Certifique-se de excluir todos os temas de grupo antes de tentar excluir o tema do grupo.
