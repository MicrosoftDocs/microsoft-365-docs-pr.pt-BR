...
Quando você atualiza para o Microsoft 365 Business Standard, lhe damos uma nova *identidade comercial.* Você pode obter uma nova conta de email e uma conta separada do OneDrive para seus dados comerciais. 
...
2. Acesse e entre usando a conta da Microsoft que você usa para acessar sua assinatura do [https://onedrive.live.com/](https://onedrive.live.com/) Microsoft 365 Family. 
    
3. Copie os arquivos que você deseja usar com o Microsoft 365 para empresas para a pasta local que você criou na etapa 1.
    
 **Importar arquivos do OneDrive para o Microsoft 365 para empresas**
1. Vá para [admin.microsoft.com](https://go.microsoft.com/fwlink/?LinkId=816877) e entre com seu nome de usuário e senha do Microsoft 365 Apps para Empresas. 
    
2. Selecione o ícone do **inicializador de aplicativos** no canto superior esquerdo e escolha **OneDrive**.
  
    > [!TIP]
    > Na primeira vez que abrir o OneDrive for Business, você precisará configurá-lo. Se isso ocorrer, na página **Bem-vindo ao OneDrive for Business,** selecione **Próximo**. Após a configuração do OneDrive, selecione **Seu OneDrive está pronto.** 
  
3. Você será direcionado para uma pasta vazia do OneDrive. Se você quiser criar sub pastas, selecione **Nova** \> **Pasta.**

4. Selecione **Carregar** para copiar os arquivos do disco rígido onde você copiou os arquivos do OneDrive. 
...
1. Cada usuário precisa configurar sua nova conta de email que veio com a assinatura do Microsoft 365 para empresas. Para isso, eles precisam do endereço da nova conta de email. A conta de email de cada usuário é a mesma que o nome de usuário usado para entrar no Microsoft 365 para empresas. Se parecerá com laura@contoso.onmicrosoft.com ou henrique@contoso.com.
...
1. Isso mescla o email, calendário, tarefas e contatos armazenados no arquivo PST em sua conta de email do Microsoft 365 para empresas.
    
2. Para importar as informações armazenadas no arquivo PST para sua conta de email do Microsoft 365 para empresas, que cada usuário conclua as etapas em Importar email, contatos e calendário de um arquivo [.pst](https://support.microsoft.com/office/431a8e9a-f99f-4d5f-ae48-ded54b3440ac)do Outlook.
