...
Na página **usuários ativos** no centro de administração do Microsoft 365, é possível filtrar pelos seguintes tipos de usuários. 
  
|||
|:-----|:-----|
|**Tipo de usuário** <br/> |**Definição** <br/> |
|Usuários licenciados  <br/> |Estes usuários receberam uma licença da Microsoft 365, como o Microsoft 365 Business Standard ou o Office 365 Enterprise E3, para que eles possam usar os serviços do Microsoft 365.  <br/> |
...
|Usuários não licenciados  <br/> |Esses usuários não têm licença da Microsoft 365, como o Microsoft 365 Business Standard ou o Office 365 Enterprise E3, portanto, não podem usar os recursos do Microsoft 365. Os exemplos são administradores que só precisam gerenciar o Microsoft 365, funcionários que saíram da empresa ou caixas de correio compartilhadas e de recursos que não estão associadas a pessoas.  <br/> |
