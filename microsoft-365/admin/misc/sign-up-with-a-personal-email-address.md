...
Ao se inscrever no Office 365 com seu endereço de email pessoal e ignorar [a adição](../get-help-with-domains/what-is-a-domain.md) de um domínio personalizado por enquanto, você limita o acesso a determinados recursos. 
  
Se você optar por adicionar um domínio personalizado agora, terá acesso a todos os recursos premium abaixo:
  
|**Característica**|**Office 365 com email pessoal**|**Office 365 com domínio personalizado**|
|:-----|:-----|:-----|
...
|**Aplicativos do Office: Word, Excel, PowerPoint, OneNote, Outlook, Access (somente pc),**| Sim | Sim 
|**Aplicativos <sup>de negócios 3</sup> : Microsoft Connections, Invoicing, Listings, Bookings, MileIQ e Outlook Customer Manager**| Não | Sim 
|**Acesso ao Centro de administração do Microsoft 365**| Acesso Limitado (Configuração de Cobrança, Suporte e Domínio) | Sim
