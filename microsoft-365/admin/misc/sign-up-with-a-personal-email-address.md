...
## <a name="when-you-skip-adding-a-custom-domain"></a>Ao pular a adição de um domínio personalizado

  
Ao se inscrever no Office 365 com seu endereço de email pessoal e ignorar a adição [de um domínio personalizado](../get-help-with-domains/what-is-a-domain.md) por enquanto, você limita seu acesso a determinados recursos. 
