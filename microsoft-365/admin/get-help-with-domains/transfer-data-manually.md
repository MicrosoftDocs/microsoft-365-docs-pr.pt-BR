...
Prepare-se para acumular suas mangas e bloquear um bloco de tempo no seu calendário: transferir dados entre duas contas do Office 365 é um processo manual, complicado e demorado. Este não é um processo automatizado ou com suporte. Vamos começar.
  
> [!CAUTION]
> Haverá tempo de inatividade durante o processo em que o email, o Skype for Business e um site público hospedado no Office 365 não funcionarão. Os usuários receberão novos nomes de usuário e senhas, e eles precisarão redefinir o Outlook.
...
|Cancele a assinatura para o plano que você concluiu chamando o suporte da Microsoft para o Office 365.  <br/> | Verifique se a nova assinatura está funcionando e se todos os dados foram transferidos.  <br/>  [Entre em contato com o suporte ao cliente](../contact-support-for-business-products.md) para cancelar sua assinatura antiga.  <br/> |
...
Se você estiver transferindo dados do Office 365 para o Office 365 médio Business ou o Office 365 Enterprise, as páginas de Administração serão estruturadas de forma diferente. Assista a um [vídeo: introdução ao Office 365 Enterprise](https://support.office.com/article/11f7b4a0-1294-4e94-9238-beaae26efa9c.aspx)e vá para os seguintes locais para ver as configurações de administração.
...
|**Administração** \> **do SharePoint** <br/> | Configurações do SharePoint Online  <br/> |
|**Administrador** \> **do Skype for Business** <br/> |Configurações adicionais do Skype for Business  <br/> |
...
Se você tiver um site público hospedado no Office 365, você precisa salvá-lo e recriá-lo em sua nova assinatura.
...
- Para transferir dados de lista, salve um [modelo de lista](https://support.office.com/article/c3884ad1-bc49-44b8-b3d6-3bc6a01eb393.aspx)e use o modelo salvo para recriar a lista no novo site.
