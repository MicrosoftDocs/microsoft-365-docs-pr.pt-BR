...
Prepare-se para arregaçar as mangas e bloquear uma parte do tempo no calendário: transferir dados entre duas contas Microsoft 365 é um processo manual, complicado e demorado. Esse não é um processo automatizado ou suportado. Vamos começar.
  
> [!CAUTION]
> Haverá tempo inotivo durante o processo em que o email, Skype for Business e um site público hospedado no Microsoft 365 não funcionarão. Os usuários receberão novos nomes de usuário e senhas, e eles precisarão redefinir Outlook.
...
|Cancele a assinatura do plano com o que você terminou chamando o Suporte da Microsoft para Microsoft 365.  <br/> | Verifique se sua nova assinatura está funcionando e se todos os dados foram transferidos.  <br/>  [Contate o suporte ao cliente](../../business-video/get-help-support.md) para cancelar sua assinatura antiga.  <br/> |
...
Se você estiver transferindo dados do Microsoft 365 para Microsoft 365 Midsize Business ou Microsoft 365 Enterprise, as páginas de administração serão estruturadas de forma diferente. Assista a [um vídeo: apresentando Microsoft 365 Enterprise](../index.yml), e vá para os seguintes locais para ver as configurações de administrador.
...
|**Admin** \> **Exchange** <br/> | Exchange Online configurações  <br/> |
|**Admin** \> **SharePoint** <br/> | SharePoint Configurações online  <br/> |
|**Admin** \> **Skype for Business** <br/> |Configurações Skype for Business adicionais  <br/> |

Para Microsoft 365 Pequenas Empresas
...
Para salvar uma biblioteca de documentos ou conteúdo de lista de um ambiente SharePoint Online para compartilhamentos de arquivos ou para um computador local, consulte [Migração manual](/sharepoint/troubleshoot/migration-tool/content-manual-migration)do conteúdo SharePoint Online.
...
- Para transferir documentos, primeiro recrie manualmente sua hierarquia no novo site. Em seguida, você pode abrir os SharePoint de equipe ao mesmo tempo, abrir as duas bibliotecas de documentos com Windows Explorer e copiar e colar os documentos. Consulte [Vídeo: Copie ou mova arquivos de biblioteca usando Abrir com o Explorer](../../business-video/store-files.md).
...
- Para salvar uma biblioteca de documentos ou conteúdo de lista de um ambiente do SharePoint Online (OneDrive for Business ou sites de equipe) para compartilhamentos de arquivos ou para um computador local, consulte Informações sobre a migração manual do [conteúdo SharePoint Online.](/sharepoint/troubleshoot/migration-tool/content-manual-migration)
...
### <a name="onedrive-for-business-data"></a>OneDrive Dados para Empresas:

Peça aos usuários para [copiar/sincronizar OneDrive for Business conteúdo no](https://support.microsoft.com/office/59b1de2b-519e-4d3a-8f45-51647cf291cd)computador e, em seguida, adicioná-lo novamente à nova assinatura.

### <a name="onenote"></a>OneNote 

Peça aos usuários [para fazer backup OneNote](https://support.microsoft.com/office/back-up-notes-f58b34b0-611d-435e-87fa-7942a1767af4?ui=en-us&rs=en-us&ad=us) e restaurar [anotações de um backup](https://support.microsoft.com/en-us/office/restore-notes-from-a-backup-5daf9cb0-6769-4998-a5de-f044fdd0d831?ui=en-us&rs=en-us&ad=us) para suas novas assinaturas.