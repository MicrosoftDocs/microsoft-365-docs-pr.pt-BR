...
Você pode adicionar e gerenciar registros DNS usando as ferramentas administrativas em seu host de domínio ou dar à Microsoft o controle de seus registros de domínio e os configuraremos para você.
  
Selecione seu host de domínio abaixo para as etapas exatas. Se você não tiver certeza de quem é seu host, consulte [Find your domain registrar](find-your-domain-registrar.md).
...
| [eNomCentral](../dns/create-dns-records-at-enomcentral.md)| [Registrar365 para o Microsoft 365](../dns/create-dns-records-at-register365.md)  |
...
[Preciso de instruções gerais, porque meu host de domínio não está nesta lista. ](create-dns-records-at-any-dns-hosting-provider.md)
