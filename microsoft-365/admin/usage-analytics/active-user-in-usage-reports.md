...
---
# <a name="active-user-in-microsoft-365-usage-reports"></a>Usuário ativo em relatórios Microsoft 365 uso

## <a name="active-user-in-usage-reports"></a>Usuário ativo em relatórios de uso

Um usuário ativo de Microsoft 365 para análise de Microsoft 365 [de](usage-analytics.md) uso e os Relatórios de Atividades no centro de administração [é](../activity-reports/activity-reports.md) definido da seguinte forma. 
...
[Microsoft 365 análise de uso](usage-analytics.md) contém métricas de adoção adicionais relacionadas a usuários ativos para mostrar a adoção dos produtos ao longo do tempo. Essas métricas são válidas para o mês, ano e produto selecionado e são definidas da seguinte forma. 
...
MoMReturningUsers, FirstTimeUsers, CumulativeActiveUsers foram redefinidos a partir de 1º de janeiro de 2018 com a inclusão de &amp; Microsoft Teams.
