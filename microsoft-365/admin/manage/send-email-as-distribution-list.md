...
4. Na parte inferior da mensagem, selecione **Mais** \> **Mostrar de**.<br/> ![Selecione Mais e escolha Mostrar de](../../media/534f13b7-9f15-48ea-8835-ea2ed1863ece.png)
...
6. Em seguida, digite o endereço da lista de distribuição como support@contoso.com e envie a mensagem. Na próxima vez que você responder da lista de distribuição, seu endereço aparecerá como uma opção na **lista De.**<br/>![Alias da caixa de correio compartilhada é exibido](../../media/f7632a9a-9cab-446c-9e37-23ef50c5b975.png)
...
[Adicionar um usuário ou contato a um grupo de distribuição](../email/add-user-or-contact-to-distribution-list.md) (artigo)