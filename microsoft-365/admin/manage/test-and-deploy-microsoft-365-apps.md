...
description: Encontre, teste e implante aplicativos de parceiros microsoft e microsoft para usuários e grupos em sua organização a partir do portal aplicativos integrados no Microsoft 365 de administração.
...
8. Selecione **Próximo para** revisar a implantação e escolha Concluir **implantação**. Você pode exibir a implantação na guia **Visão** Geral escolhendo **Exibir essa implantação**. No centro Microsoft 365 de administração, você pode ver o status de cada aplicativo implantado e a data em que implantou o aplicativo.
...
## <a name="upload-custom-line-of-business-apps-for-testing-and-full-deployment"></a>Upload de aplicativos de negócios personalizados para testes e implantação completa
...
- O administrador conectado é um administrador Exchange administrador.
...
Aplicativos integrados permitem a implantação de aplicativos Web, Teams, Excel, PowerPoint, Word, Outlook e aplicativos SPFx. Para os complementos, os aplicativos integrados suportam a implantação para Exchange caixas de correio online e não caixas de correio Exchange locais.
