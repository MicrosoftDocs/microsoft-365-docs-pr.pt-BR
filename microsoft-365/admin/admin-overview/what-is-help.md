...
* **Assistência inteligente** - auto-ajuda alimentada pela AI

* **Guias e artigos** - conteúdo abrangente na Web

## <a name="integrated-help"></a>Ajuda integrada

A ajuda é integrada em todo o centro de administração, portanto, ela está ali quando você precisa. Na parte superior de muitas páginas, você encontrará um texto de ajuda em linha que fornece uma visão geral informacional da tarefa em mãos, bem como links para artigos que permitem que você encontre rapidamente a documentação oficial para um aprendizado mais aprofundado.
...
É claro que, às vezes, as perguntas são melhor respondidas por humanos. Se nossa auto-ajuda moderna não tiver a resposta, você sempre terá a opção de entrar em contato com nossos agentes de suporte.
