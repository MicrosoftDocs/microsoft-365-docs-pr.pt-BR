...
- **Gerenciamento e cobrança de licenças** Exibir uma lista de licenças compradas e atribuídas, atribuir licenças aos usuários, comprar ou remover licenças e exibir e baixar faturas.
- **Suporte** Crie uma nova solicitação de serviço e acompanhe todas as atualizações relacionadas às solicitações de serviço enquanto você estiver em uso.
- **Central de Mensagens** Fique por dentro de todas as alterações futuras, manutenção planejada ou outros comunicados importantes relacionados ao Microsoft 365
...
## <a name="watch-install-the-admin-mobile-app"></a>Assista: Instalar o aplicativo móvel do administrador

> [!VIDEO https://www.microsoft.com/videoplayer/embed/05c1d439-9ec2-415f-9178-250f64dec64c]

## <a name="frequently-asked-questions"></a>Perguntas frequentes

A seguir, é possível encontrar respostas para perguntas frequentes.
...
Sim, mas com funcionalidade reduzida. Você poderá entrar e exibir informações de serviço, mas a maioria das funções de gerenciamento do usuário será somente leitura. Você não poderá adicionar, editar ou excluir usuários. No entanto, você poderá atribuir licenças aos usuários em sua organização e receber notificações.
...
Se você selecionar um incidente de serviço específico ou uma mensagem, a opção de compartilhamento estará no canto superior direito.
  
### <a name="can-i-use-this-app-with-multiple-accounts-or-tenants"></a>Posso usar esse aplicativo com várias contas ou locatários?

Sim, você pode configurar várias contas ou organizações.

### <a name="im-unable-to-login-or-my-app-is-acting-funny-what-can-i-do-to-troubleshoot-or-fix-the-issue"></a>Não consigo fazer logon ou meu aplicativo está agindo de forma engraçada. O que posso fazer para solucionar ou corrigir o problema?
