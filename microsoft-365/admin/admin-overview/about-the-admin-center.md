...
**Se você comprou um Microsoft 365 para plano de negócios E você tem permissões administrativas, você tem acesso ao centro administrativo**. Este artigo é para você!

**Se você é um usuário ou tem um plano Microsoft 365 Family, você não tem um centro administrativo.** Para configurar Microsoft 365, vá [para Baixar e instalar ou reinstalar Microsoft 365 ou Office 2019 em um PC ou Mac](https://support.microsoft.com/office/4414eaaf-0478-48be-9c42-23adc4716658).
...
2. Selecione o ícone do inicializador de aplicativos no canto superior esquerdo e escolha **Administrador**.
    ...
    A **telha administradora** aparece apenas para pessoas que têm [permissões](../add-users/about-admin-roles.md)de administração Microsoft 365 . Se o bloco não está lá, você não tem permissões para acessar o centro de administração para a organização.
...
|**Menu**|**Para que serve**|
|-----|-----|
|**Página Inicial** <br/> |Esta é a página de aterrissagem no centro administrativo. Você verá onde gerenciar usuários, cobrança, integridade do serviço e relatórios.  <br/> |
...
|**Relatórios** <br/> |Veja rapidamente como sua organização está usando Microsoft 365 com relatórios detalhados sobre uso de e-mail, ativações de Office e muito mais. Saiba como usar os novos [relatórios de atividades](../activity-reports/activity-reports.md).  <br/> |
|**Integridade** <br/> |Veja a saúde de relance. Você também pode conferir mais detalhes e o histórico de saúde. Veja [Como verificar o serviço de saúde](../../enterprise/view-service-health.md) e como verificar Windows liberar [saúde](/windows/deployment/update/check-release-health) para obter mais informações.  <br/><br/>Use o Centro de mensagens para controlar as alterações futuras nos recursos e serviços. Nele, postamos anúncios com informações que ajudam você a se planejar para mudanças e a entender como elas podem afetar os usuários. Obtenha mais detalhes no [centro de mensagens](../manage/message-center.md). <br/> |
...
- [Crie um grupo Microsoft 365](../create-groups/create-groups.md)

- [Gerencie um grupo Microsoft 365](../create-groups/manage-groups.md)
