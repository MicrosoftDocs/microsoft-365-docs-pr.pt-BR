...
2. No **drop-down Selecionar** um relatório, selecione Uso do **dispositivo do Yammer.** \> 
...
- Você pode visualizar o gráfico **Usuários** para ver o número de usuários por dia por tipo de dispositivo.<br/>![Exibição dos usuários no gráfico de uso de dispositivos do Yammer](../../media/ecfba1ec-fbea-4491-88da-1fb19b4d5629.png)<br/>![Relatório de uso de dispositivos do Yammer mostrando a exibição Usuários](../../media/f396865a-ad6e-4f8b-a145-cc3865b352f4.png)
  
- Você pode visualizar o gráfico **Distribuição** para ver o número de usuários por tipo de dispositivo.<br/>![Exibição de distribuição no relatório de uso de dispositivos do Yammer](../../media/7a0b152e-2d2b-4d23-8dc2-046be53b724f.png)<br/>![Relatório de uso de dispositivos do Yammer](../../media/780c351d-7a1d-451d-8c16-4c454ef58aa8.png)
