...
3. Na lista **drop-down atividade** de email, selecione o uso de  \> **aplicativos de email do** Exchange.
...
|7.  <br/> |Você pode filtrar a série que vê no gráfico selecionando um item na legenda.  <br/> |
...
|9.  <br/> |Selecione **Escolher colunas** para adicionar ou remover colunas do relatório.  <br/> ![Relatório de uso de aplicativos de email - escolher colunas](../../media/041bd6ff-27e8-409d-9608-282edcfa2316.png)|
