...
Selecione **Escolher colunas** para adicionar ou remover colunas do relatório.  <br/> ![Relatório de atividades do SharePoint - escolha colunas](../../media/3c396cd1-9701-4712-8eaa-eb7bba702aa8.png)
...
|Arquivos sincronizados  <br/> |O número de arquivos que foram sincronizados do dispositivo local de um usuário para o site do SharePoint. <br/> |
