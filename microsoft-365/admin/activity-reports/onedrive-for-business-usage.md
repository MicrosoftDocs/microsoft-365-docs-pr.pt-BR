...
2. No **drop-down Selecionar** um relatório, selecione **Uso do OneDrive** \> . 
...
|Item|Descrição|
|:-----|:-----|
|1.  <br/> |O relatório de **Uso do OneDrive** mostra as tendências nos últimos 7, 30, 90 ou 180 dias. No entanto, se você selecionar um dia específico no relatório, a tabela (7) mostrará dados por até 28 dias a partir da data atual (e não a data em que o relatório foi gerado).  <br/> |
