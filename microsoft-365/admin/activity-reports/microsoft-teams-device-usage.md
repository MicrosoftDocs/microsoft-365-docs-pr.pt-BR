...
description: Obtenha informações sobre os aplicativos Microsoft Teams usados em sua organização ao obter o relatório Microsoft Teams de uso do aplicativo Microsoft 365 Reports.
...
---
# <a name="microsoft-365-reports-in-the-admin-center---microsoft-teams-device-usage"></a>Microsoft 365 Relatórios no centro de administração - Microsoft Teams uso do dispositivo
...
2. No drop-down **Selecionar um** relatório, **selecione** Microsoft Teams \> **Uso do dispositivo**.
...
![Microsoft 365 relatórios - Microsoft Teams uso do aplicativo](../../media/de35c4de-76b4-4109-a806-66774665499b.png)
...
|6.  <br/> |Você pode filtrar a série que você vê no gráfico selecionando um item na legenda. Por exemplo, no gráfico **Usuários,** selecione **Windows**, **Mac,** **Chamadas,** **Web,** **Telefone Android** ou telefone **Windows** para ver apenas as informações relacionadas a cada um. Ao alterar essa seleção, as informações da tabela não mudam.  <br/> ![Você pode filtrar Microsoft Teams gráficos de uso do aplicativo selecionando o tipo de aplicativo.](../../media/64ee1cb1-ca80-4964-8234-7fc671135c3d.png)|
