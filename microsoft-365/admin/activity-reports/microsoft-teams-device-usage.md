...
2. No **drop-down Selecionar** um relatório, selecione **o uso de dispositivos do Microsoft Teams.** \> 
...
![Relatórios do Microsoft 365 - uso do aplicativo Microsoft Teams](../../media/de35c4de-76b4-4109-a806-66774665499b.png)
...
|6.  <br/> |Você pode filtrar a série que vê no gráfico selecionando um item na legenda. Por exemplo, no gráfico **Usuários,** selecione **Windows**, **Mac**, **Chamadas**, **Web,** **telefone Android** ou **telefone Windows** para ver apenas as informações relacionadas a cada um deles. Ao alterar essa seleção, as informações da tabela não mudam.  <br/> ![Você pode filtrar gráficos de uso de aplicativos do Microsoft Teams selecionando o tipo de aplicativo.](../../media/64ee1cb1-ca80-4964-8234-7fc671135c3d.png)|
