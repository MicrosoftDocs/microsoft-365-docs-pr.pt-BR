...
2. Na página inicial do painel, clique no botão Exibir mais nos usuários ativos - Aplicativos do Microsoft 365 ou usuários ativos - cartão microsoft 365 Services para acessar a página de relatório do Office 365. 
  
## <a name="interpret-the-groups-report"></a>Interpretar o relatório de grupos

Você pode exibir as ativações no relatório do Office 365 escolhendo a **guia Atividades grupos.**<br/>![Relatórios do Microsoft 365 - Microsoft Office atividade de grupos 365.](../../media/ab90e30b-8938-4110-ab3d-ee472a4cfe21.png)

Selecione **Escolher colunas** para adicionar ou remover colunas do relatório.  <br/> ![Relatório de atividades de grupos do Office 365 - escolha colunas](../../media/1600556a-f5f1-47d9-b325-cd77c78f4004.png)
...
|Data da última atividade (UTC)  <br/> |A data mais recente em que uma mensagem foi recebida pelo grupo. Esta é a última data em que uma atividade aconteceu em uma conversa por email, Yammer ou Site.  <br/> |
...
|Armazenamento de caixa de correio usado para Exchange (MB)  <br/> |O armazenamento usado pela caixa de correio do grupo. <br/>|
|Arquivos do SharePoint (total)  <br/> |O número de arquivos armazenados em sites de grupo do SharePoint.  <br/> |
|Arquivos do SharePoint (ativos)  <br/> |O número de arquivos no site do grupo do SharePoint que foram agidos (exibidos ou modificados, sincronizados , compartilhados interna ou externamente) durante o período de relatório.  <br/> |
|Total de armazenamento de site usado para o SharePoint (MB)  <br/> |A quantidade de armazenamento em MB usada durante o período de relatório.  <br/> |
|Mensagens no Yammer (postadas)  <br/> |O número de mensagens postadas no grupo do Yammer durante o período de relatório.  <br/> |
|Mensagens no Yammer (leitura)  <br/> |O número de conversas lidas no grupo do Yammer durante o período de relatórios.  <br/> |
|Mensagens no Yammer (curtidas)  <br/> |O número de mensagens curtidas no grupo do Yammer durante o período de relatório.  <br/> |
