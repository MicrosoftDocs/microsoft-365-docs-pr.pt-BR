...
|Celular Android  <br/> | Selecionado se o usuário estava ativo no cliente móvel do Microsoft Teams para Android.  <br/> |
|Sistema operacional Chrome  <br/> |Selecionado se o usuário estava ativo no cliente da área de trabalho do Microsoft Teams em um computador do ChromeOS.|
|Linux  <br/> | Selecionado se o usuário estava ativo no cliente da área de trabalho do Microsoft Teams em um computador Linux.  <br/> |
