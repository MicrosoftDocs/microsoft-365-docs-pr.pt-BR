...
|:-----|:-----|
|**Indicador**|**Definição**|
|URL  <br/> |O endereço da Web para o OneDrive do usuário. <br/> |
...
|Data da última atividade (UTC)  <br/> | A última data em que uma atividade de arquivo foi executada no OneDrive. Se o OneDrive não teve atividade de arquivo, o valor ficará em branco.  <br/> |
