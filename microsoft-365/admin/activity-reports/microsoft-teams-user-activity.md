...
2. No menu suspenso **selecionar um relatório** , selecione atividade de **usuário do Microsoft Teams** \> .
...
|3.  <br/> |Para garantir a qualidade dos dados, realizamos verificações diárias de validação de dados nos últimos cinco dias e preenchendo qualquer lacuna detectada. Você pode notar diferenças em dados históricos durante o processo.  <br/> |
...
|6.  <br/> | No gráfico **atividade** , o eixo Y é a contagem da atividade especificada.  <br/>  No gráfico **arquivos** , o eixo Y é o número de usuários que participam de chats de equipes, bate-papos privados, chamadas ou reuniões.  <br/>  O eixo X nos gráficos é o intervalo de datas selecionado para o relatório específico.  <br/> |
