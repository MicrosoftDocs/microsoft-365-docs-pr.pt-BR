...
2. No **drop-down Selecionar** um relatório, selecione a **atividade do Usuário do Microsoft Teams.** \> 
...
Você pode observar a atividade de usuários do Microsoft Teams examinando os gráficos **Atividade** e **Usuários**.<br/>![Relatórios do Microsoft 365 - Atividade do usuário do Microsoft Teams.](../../media/40359f81-25f7-416d-bb1e-37289133ef6b.png)
...
|3.  <br/> |Para garantir a qualidade dos dados, realizamos verificações diárias de validação de dados nos últimos cinco dias e preencheremos as lacunas detectadas. Você pode notar diferenças nos dados históricos durante o processo.  <br/> |
