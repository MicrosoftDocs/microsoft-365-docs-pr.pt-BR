...
Somente administradores globais, administradores de usuários e grupos podem criar e gerenciar grupos no centro de administração do Microsoft 365. Não é possível ser um administrador delegado (por exemplo, um consultor que é administrador em nome de outra pessoa).
...
|Number of members |Mais de 1.000, embora apenas 1.000 possam acessar as conversas de Grupo simultaneamente. <br>Os usuários podem notar atrasos ao acessar o calendário e as conversas em grupos grandes no Outlook.|
...
Você pode criar rótulos de sensibilidade que os usuários em sua organização podem definir quando eles criam um grupo do Microsoft 365. Com rótulos de sensibilidade, você pode configurar: 
...
Os grupos do Microsoft 365 trabalham com o Azure Active Directory. Os recursos de grupos que você recebe dependem de qual assinatura do Azure Active Directory você tem e quais licenças são atribuídas ao organizador do grupo.

> [!IMPORTANT]
> Para todos os recursos de grupos, se você tiver uma assinatura do Azure AD Premium, os usuários poderão ingressar no grupo se eles têm ou não uma licença do AAD P1 atribuída a eles. O licenciamento não é imposto.
