...
Se você tiver excluído um grupo, ele será mantido por 30 dias por padrão. Esse período de 30 dias é considerado uma "exclusão suave" porque você ainda pode restaurar o grupo. Após 30 dias, o grupo e seu conteúdo associado serão excluídos permanentemente e não poderão ser restaurados.

Quando um grupo de é restaurado, o seguinte conteúdo é restaurado:
  
- Objeto, propriedades e membros dos Grupos do Microsoft 365 do Azure Active Directory (AD).
...
> [!NOTE]
> Este artigo descreve a restauração apenas de grupos do Microsoft 365. Todos os outros grupos não podem ser restaurados depois de excluídos.
...
## <a name="got-questions-about-microsoft-365-groups"></a>Tem dúvidas sobre os Grupos do Microsoft 365?

Visite a [Microsoft Tech Community](https://techcommunity.microsoft.com/t5/Office-365-Groups/ct-p/Office365Groups) para postar perguntas e participar de conversas sobre grupos do Microsoft 365. 
