...
---
# <a name="create-dns-records-at-dreamhost-for-microsoft"></a>Criar registros DNS noHost da Microsoft

 Caso não encontre o conteúdo que está procurando, **[verifique as perguntas frequentes sobre domínios](../setup/domains-faq.yml)**. 
  
Se oHosthost for seu provedor de hospedagem DNS, siga as etapas neste artigo para verificar seu domínio e configurar registros DNS para email, Lync e assim por diante.
 
Depois que você adicionar esses registros noHosthost, seu domínio será definido para funcionar com os serviços Microsoft.
...
1. To get started, go to your domains page atHost by using [this link](https://panel.dreamhost.com/). Você será solicitado a entrar.
    
    ![Host-BP-Configure-1-1](../../media/1919b810-b6ba-4e29-a774-de1e7c67d078.png)
  
2. Na página **Painel,** selecione **Domínios** e **Gerencie Domínios.**
...
4. In the **Add a custom DNS record** section, in the boxes for the new record, type or copy and paste the values from the following table. 
    ...
    |**Name**|**Tipo**|**Valor**|**Comentário**|
    |:-----|:-----|:-----|:-----|
    |(Leave this field empty.)  <br/> |TXT  <br/> |MS = ms *XXXXXXXX*  <br/> **Observação**: esse é um exemplo. Use aqui seu valor específico de **Destino ou Pontos de Endereçamento**, retirado da tabela.           [Como localizo isto?](../get-help-with-domains/information-for-dns-records.md)          |(Este campo é opcional.)  <br/> |
...
2. Na página **Painel,** selecione **Email** e, em **seguida, MX Personalizado.**
...
4. Na seção **Registro MX Personalizado,** nas caixas do novo registro, digite ou copie e copie e copie os seguintes valores da tabela a seguir. 
    
    (Pode ser necessário rolar para baixo.)
    
    (Se houver outros registros MX existentes, marque esses registros a serem excluídos.)
...
6. Se houver outros registros MX, exclua cada registro selecionando a entrada e pressionando a tecla **Delete** no teclado. 
    
    ![Host-BP-Configure-2-5](../../media/1827733c-3609-4b0f-bba1-531ab090da91.png)
  
7. Se você excluiu algum registro, selecione **Atualizar seus registros MX personalizados agora!**
...
4. In the **Add a custom DNS record** section, in the boxes for the new record, type or copy and paste the values from the first row in the following table. 
    ...
    |**Name**|**Tipo**|**Valor**|**Comentário**|
    |:-----|:-----|:-----|:-----|
    |autodiscover  <br/> |CNAME  <br/> |autodiscover.outlook.com.  <br/> **Este valor deve OBRIGATORIAMENTE terminar com um ponto (.)** <br/> |(Este campo é opcional.)  <br/> |
    |sip  <br/> |CNAME  <br/> |sipdir.online.lync.com.  <br/> **Este valor deve OBRIGATORIAMENTE terminar com um ponto (.)** <br/> |(Este campo é opcional.)  <br/> |
    |lyncdiscover  <br/> |CNAME  <br/> |webdir.online.lync.com.  <br/> **Este valor deve OBRIGATORIAMENTE terminar com um ponto (.)** <br/> |(Este campo é opcional.)  <br/> |
    |enterpriseregistration  <br/> |CNAME  <br/> |enterpriseregistration.windows.net.  <br/> **Este valor deve OBRIGATORIAMENTE terminar com um ponto (.)** <br/> |(Este campo é opcional.)  <br/> |
    |enterpriseenrollment  <br/> |CNAME  <br/> |enterpriseenrollment-s.manage.microsoft.com.  <br/> **Este valor deve OBRIGATORIAMENTE terminar com um ponto (.)** <br/> |(Este campo é opcional.)  <br/> |
...
4. In the **Add a custom DNS record** section, in the boxes for the new record, type or copy and paste the values from the first row in the following table. 
    ...
    |**Name**|**Tipo**|**Valor**|**Comentário**|
    |:-----|:-----|:-----|:-----|
    |(Leave this field empty.)  <br/> |TXT  <br/> |v=spf1 include:spf.protection.outlook.com -all  <br/> **Observação:** é recomendável copiar e colar essa entrada para que o espaçamento permaneça correto.           |(Este campo é opcional.)  <br/> |
...
6. Usando as duas etapas anteriores e os valores da segunda linha na tabela, adicione o outro registro SRV.
...
4. In the **Add a custom DNS record** section, in the boxes for the new record, type or copy and paste the values from the first row in the following table. 
    ...
    |**Name**|**Tipo**|**Valor**|**Comentário**|
    |:-----|:-----|:-----|:-----|
    |_sip._tls  <br/> |SRV  <br/> |100 1 443  <br/> sipdir.online.lync.com.  <br/> **Este valor deve OBRIGATORIAMENTE terminar com um ponto (.)** <br/> |(Este campo é opcional.)  <br/> |
    |_sipfederationtls._tcp  <br/> |SRV  <br/> |100 1 5061  <br/> sipfed.online.lync.com.  <br/> **Este valor deve OBRIGATORIAMENTE terminar com um ponto (.)** <br/> |(Este campo é opcional.)  <br/> |
