...
6. <span data-ttu-id="d6c6e-183">Selecione **definir manualmente os meus servidores de nomes**.</span><span class="sxs-lookup"><span data-stu-id="d6c6e-183">Select **Manually set my name servers**.</span></span>
