...
---
# <a name="change-nameservers-to-set-up-microsoft-with-google-domains"></a>Alterar os nameservers para configurar a Microsoft com o Google Domains
...
> [!IMPORTANT]
> The following procedure will show you how to delete any other, unwanted nameservers from the list, and also how to add the correct nameservers if they are not already in the list. > Quando você concluir as etapas desta seção, os únicos nameservers que devem estar listados são estes quatro: 
...
3. Adicione os outros três registros Nameserver.
    ...
    Na seção **Usar servidores** de nomes personalizados, crie um registro usando os valores da próxima linha na tabela e selecione o controle **+ (adicionar)** para adicionar outra linha. 
