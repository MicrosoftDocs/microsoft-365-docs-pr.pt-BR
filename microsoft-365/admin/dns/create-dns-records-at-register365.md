...
---
# <a name="create-dns-records-at-register365-for-office-365"></a>Criar registros DNS no site Register365 para o Office 365
...
- [Adicionar os seis registros CNAME necessários para o Office 365](#add-the-six-cname-records-that-are-required-for-office-365)
...
Depois que você adicionar esses registros no Office 365, o domínio é configurado para funcionar com os serviços do Office 365.
...
3. On the **Add/Modify DNS Zone** page, in the **A, CNAME, AAAA, TXT and NS records** section, in the boxes for the new record, type or copy and paste the values from the following table. 
    ...
    |:-----|:-----|:-----|
    |(Leave this field empty.)  <br/> |TXT  <br/> |MS = ms *XXXXXXXX*  <br/> **Observação**: esse é um exemplo. Use seu valor específico de **Destinos ou Pontos de Endereçamento** aqui, da tabela no Office 365.           [Como localizo isto?](../get-help-with-domains/information-for-dns-records.md)          |
