...
> [!IMPORTANT]
> Você deve executar o primeiro procedimento, apontar seu domínio para sua conta de hospedagem [antes](#point-your-domain-to-your-hosting-account)de adicionar registros DNS usando qualquer um dos outros procedimentos neste artigo. 

Depois de fazer todas essas alterações no Hostgator, seu domínio será definido para funcionar com os serviços Microsoft.
...
5. Na página **Servidores** de Nomes do  seu domínio, aponte automaticamente esse domínio para minha lista de lista de espera da conta de hospedagem, escolha a conta de hospedagem associada ao seu domínio. 
...
1. Para começar, vá para a página do cPanel no Hostgator. Será solicitado que você faça logon primeiro.
    ...
    > [!IMPORTANT]
    > To have a cPanel associated with your domain, you need a hosting account with Hostgator. Para começar a usar a Microsoft, você pode adquirir uma conta de hospedagem do Hostgator ou delegar seus [nameservers](change-nameservers-at-hostgator.md)para apontar para a Microsoft. 
...
5. Adicione cada um dos outros cinco registros CNAME.
    ...
    Na seção **Adicionar um Registro,** crie um registro usando os valores da próxima  linha na tabela e selecione Adicionar Registro novamente para concluir esse registro. 
