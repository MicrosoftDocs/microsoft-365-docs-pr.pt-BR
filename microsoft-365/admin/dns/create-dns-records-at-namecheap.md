...
Se o Namecheap for seu provedor de hospedagem DNS, siga as etapas deste artigo para verificar seu domínio e configurar registros DNS para o Skype for Business Online, email e outros serviços.
  
Depois que você adicionar esses registros no Namecheap, o domínio será definido para funcionar com os serviços Microsoft.
...
1. To get started, go to your domains page at Namecheap by using [this link](https://www.namecheap.com/myaccount/login.aspx?ReturnUrl=%2f). Você será solicitado a entrar e continuar.
    
    ![Namecheap-BP-Configure-1-1](../../media/1827f9fc-4dc9-4f9d-a392-7817c47b00b3.png)
  
2. Na página **Inicial,** em **Conta,** escolha **Lista** de Domínios na lista drop-down. 
...
5. Na seção **CONFIGURAÇÕES DE EMAIL,** selecione **MX Personalizado** na lista **drop-down** de Encaminhamento de Email. 
...
7. Nas caixas do novo registro, digite ou copie e copie e copie os valores da tabela a seguir.
    
    (A **caixa Prioridade** é a caixa sem nome à direita da **caixa** Valor. Escolha o **valor de TTL** na lista drop-down.) 
...
9. Se houver outros registros MX, use o processo de duas etapas a seguir para remover cada um deles:
    ...
    Segundo, selecione **Sim** para confirmar a exclusão. 
...
6. Na lista **drop-down** Tipo, selecione **Registro CNAME**.
...
7. Nas caixas do novo registro, digite ou copie e copie e copie os seguintes valores da tabela a seguir.
...
7. Nas caixas vazias dos novos registros, digite ou copie e copie e copie os valores da primeira linha da tabela a seguir.
...
9. Usando as quatro etapas anteriores e os valores da segunda linha na tabela, adicione o outro registro SRV.
