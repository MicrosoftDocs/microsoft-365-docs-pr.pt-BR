...
---
# <a name="create-dns-records-at-namecheap-for-microsoft"></a>Criar registros DNS no Namecheap para a Microsoft

 Caso não encontre o conteúdo que está procurando, **[verifique as perguntas frequentes sobre domínios](../setup/domains-faq.yml)**. 
  
Se Namecheap for seu provedor de hospedagem DNS, siga as etapas deste artigo para verificar seu domínio e configurar registros DNS para email, Skype for Business Online e assim por diante.
  
Depois de adicionar esses registros em Namecheap, seu domínio será definido para funcionar com os serviços da Microsoft.
...
1. Para começar, vá para sua página de domínios em Namecheap usando [este link](https://www.namecheap.com/myaccount/login.aspx?ReturnUrl=%2f). Você será solicitado a entrar e continuar.
    
    ![Namecheap-BP-Configure-1-1](../../media/1827f9fc-4dc9-4f9d-a392-7817c47b00b3.png)
  
2. Na página **Aterrissagem,** em **Conta**, escolha **Lista** de Domínios na listada. 
    
    ![Namecheap-BP-Configure-1-2](../../media/3f457d64-4589-422c-ae34-fc24b0e819eb.png)
  
3. Na página **Lista de** Domínios, encontre o nome do domínio que você deseja editar e selecione **Gerenciar**.
...
5. Na seção **REGISTROS HOST,** selecione **ADICIONAR NOVO REGISTRO**.
    
    ![Namecheap-BP-Configure-1-5](../../media/8849abfe-deb6-4f6a-b56d-e69be9a28b0f.png)
  
6. No **drop-down Tipo,** selecione **Registro TXT**.
    
    > [!NOTE]
    > O **drop-down** Tipo aparece automaticamente quando você seleciona **ADICIONAR NOVO REGISTRO**. 
...
8. Selecione o **controle Salvar Alterações** (marca de verificação). 
...
5. Na seção **CONFIGURAÇÕES DE** EMAIL, selecione **MX personalizado** na listada de encaminhamento **de** email. 
...
7. Nas caixas do novo registro, digite ou copie e copie os valores, da tabela a seguir.
    
    (A **caixa Prioridade** é a caixa sem nome à direita da caixa **Valor.** Escolha o **valor TTL** na listada.) 
    
    |**Tipo**|**Host**|**Valor**|**Prioridade**|**TTL**|
    |:-----|:-----|:-----|:-----|:-----|
    |Registro MX  <br/> |@  <br/> |\<*domain-key*\>.mail.protection.outlook.com.  <br/> **Este valor deve OBRIGATORIAMENTE terminar com um ponto (.)** <br/> **Observação:** Obter o  *\<domain-key\>*  seu de sua conta da Microsoft.  [Como faço para encontrar isso?](../get-help-with-domains/information-for-dns-records.md)          |0  <br/> Para saber mais sobre prioridade, confira [O que é prioridade MX?](../setup/domains-faq.yml) <br/> |30 min  <br/> |
...
9. Se houver outros registros MX, use o processo de duas etapas a seguir para remover cada um deles:
    ...
    Primeiro, selecione o **ícone Excluir** (lixeira) do registro que você deseja remover. 
...
6. No **drop-down Tipo,** selecione **Registro CNAME**.
...
9. Usando as quatro etapas anteriores e os valores das outras cinco linhas da tabela, adicione cada um dos outros cinco registros CNAME.
...
7. Nas caixas do novo registro, digite ou copie e copie os seguintes valores da tabela a seguir.
...
1. Para começar, vá para sua página de domínios em Namecheap usando [este link](https://www.namecheap.com/myaccount/login.aspx?ReturnUrl=%2f). You'll be prompted to sign in.
...
6. No **drop-down Tipo,** selecione **Registro SRV**.
...
7. Nas caixas vazias dos novos registros, digite ou copie e colar os valores da primeira linha da tabela a seguir.
