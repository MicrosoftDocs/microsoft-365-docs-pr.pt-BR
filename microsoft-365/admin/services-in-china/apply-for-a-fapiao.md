...
Você pode enviar sua solicitação fapiao para o sistema de gerenciamento da 21Vianet Fapiao cerca de três dias após o pagamento. Depois de enviar sua solicitação fapiao, ela será processada em dois dias.
  
![Fluxograma mostrando o processo do aplicativo Fapiao.](../../media/bf14884a-53f9-4c53-971c-b9b8ad6ec8d3.png)
  
## <a name="step-1-apply-for-a-fapiao"></a>Etapa 1: Aplicar a um Fapiao

Há duas maneiras de se aplicar a um Fapiao:
  
1. Depois de fazer um pagamento no site do Office 365 operado pela 21Vianet, você receberá um email de confirmação de pedido que contém o número do pedido e um link para o sistema de gerenciamento da Fapiao. Você pode usar o link no email para criar uma conta no sistema de gerenciamento de informações da <a href="https://go.microsoft.com/fwlink/p/?linkid=837466" target="_blank">21Vianet Fapiao.</a>

    Ou

2. Você pode solicitar um Fapiao no centro <a href="https://go.microsoft.com/fwlink/p/?linkid=850627" target="_blank">de administração.</a>

    ![A página Faturas no centro de administração do Microsoft 365.](../../media/a6e3b953-abd4-46aa-a910-08c517915a21.png)
  
## <a name="step-2-register-with-the-21vianet-fapiao-management-system"></a>Etapa 2: Registrar-se no sistema de gerenciamento 21Vianet Fapiao

> [!NOTE]
> Você pode usar o mesmo nome de email e senha da sua conta do Office 365 ou pode usar algo diferente.
  
1. Vá para o sistema de gerenciamento de informações da <a href="https://go.microsoft.com/fwlink/p/?linkid=837466" target="_blank">21Vianet Fapiao.</a>
...
## <a name="step-3-submit-your-bill-for-a-fapiao"></a>Etapa 3: Enviar sua fatura para um Fapiao

1. Faça logoff no sistema <a href="https://go.microsoft.com/fwlink/p/?linkid=837465" target="_blank">de gerenciamento Fapiao.</a>

2. Selecione o registro de cobrança e, em seguida, **aplique a cobrança.**
...
3. Selecione o tipo fapiao, insira as informações necessárias e selecione **Next**.
    ...
    > - Se necessário, você pode solicitar um Fapiao com um título diferente. No entanto, você só pode aplicar um título Fapiao para uma fatura no sistema. Se você quiser dividir o Fapiao em valores ou títulos diferentes, envie sua solicitação <a href="https://portal.partner.microsoftonline.cn/Support/SupportOverview.aspx" target="_blank">no centro de administração.</a>
    > - Na próxima vez que você aplicar um Fapiao, o sistema apresentará automaticamente as informações de Fapiao anteriores.
    > - Se você precisar de um certificado de compra ou um reembolso, o nome do pagador e o título fapiao devem corresponder.
...
4. Selecione um método de envio e insira as informações de envio. Você pode escolher Yunda ou SF (coleta de frete). Você também pode ir para a ramificação de Xangai da 21Vianet para obter o Fapiao. selecione **Next**.
    ...
    **Endereço da empresa de filial de Xangai da 21Vianet:**
    ...
    Xangai, Pudong New Area Keyuan Road No. 88, Centro Alemão, edifício 3, 657

    **Informações de contato:**

    Mila med 021-28986102
...
Quando Fapiao estiver fora de uso, o sistema exibirá um aviso e indicará a hora esperada para emitir o Fapiao.
...
### <a name="what-services-can-i-get-from-online-support"></a>Quais serviços posso obter do suporte online?
...
### <a name="how-do-i-change-my-login-email-address-and-password"></a>Como faço para alterar meu endereço de email de logon e senha?
...
3. Se você esqueceu seu endereço de email de logon, entre em contato com o serviço de atendimento ao cliente 21Vianet pelo telefone (86) 400-089-0365.
...
### <a name="what-if-i-enter-the-wrong-email-address-when-i-register"></a>E se eu inserir o endereço de email errado ao me registrar?
