...
ms.custom:
- seo-marvel-apr2020
description: Saiba como configurar o IRM do Exchange Online para usar o Active Directory Rights Management Service (AD RMS) local para atender aos requisitos da sua organização.
ms.openlocfilehash: be53b54328c2c1e08e51a84b7251e23c3e7468c3
ms.sourcegitcommit: 973f5449784cb70ce5545bc3cf57bf1ce5209218
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 06/19/2020
ms.locfileid: "44815438"
---
# <a name="exchange-online-mail-encryption-with-ad-rms"></a>Criptografia de email do Exchange Online com AD RMS

Para evitar o vazamento de informações, o Exchange Online inclui a funcionalidade IRM (Gerenciamento de Direitos de Informação) que oferece proteção online e offline de mensagens e anexos de email. Você pode configurar o IRM do Exchange Online para usar o Active Directory Rights Management Service (AD RMS) local, se necessário, para atender aos requisitos da sua organização. Isso não é comum. Se você não tiver um requisito para usar o AD RMS, use a Criptografia de Mensagem do [Office 365.](ome.md) 

A proteção de IRM pode ser aplicada por usuários no Microsoft Outlook ou no Outlook na Web e pode ser aplicada por administradores usando regras de proteção de transporte ou regras de proteção do Outlook. O IRM ajuda você e seus usuários a controlar quem pode acessar, encaminhar, imprimir ou copiar dados confidenciais em um email.
  
## <a name="changes-to-how-irm-works-with-office-365-message-encryption-ome-and-azure-active-directory"></a>Alterações na forma como o IRM funciona com a Criptografia de Mensagens do Office 365 (OME) e o Azure Active Directory

A partir de setembro de 2017, quando você configura os novos recursos de Criptografia de Mensagem do Office 365 para sua organização, também configura o IRM para uso com o Azure Rights Management (Azure RMS). Você não configura mais o IRM com o Azure RMS separadamente. Em vez disso, o OME e o gerenciamento de direitos funcionam perfeitamente juntos. Para obter mais detalhes sobre os novos recursos, consulte Perguntas frequentes sobre a Criptografia de Mensagens do [Office 365.](https://docs.microsoft.com/microsoft-365/compliance/ome-faq) Se você estiver pronto para começar a usar os novos recursos do OME em sua organização, confira Configurar novos recursos de Criptografia de Mensagens do [Office 365](https://docs.microsoft.com/microsoft-365/compliance/set-up-new-message-encryption-capabilities)com base na Proteção de Informações do Azure.
