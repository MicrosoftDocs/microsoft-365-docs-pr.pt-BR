...
4. No campo resultados, localize os dados que foram exportados e exiba os erros encontrados.

5. Verifique o arquivo Trace. log localizado no diretório em que você exportou o conteúdo para qualquer erro.
