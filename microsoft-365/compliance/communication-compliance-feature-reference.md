...
>[!NOTE]
>As políticas que usam classificadores inspecionarão e avaliarão mensagens com uma contagem de palavras de seis ou mais. Mensagens contendo menos de seis palavras não são avaliadas em políticas usando classificadores. Para identificar e realizar ações em mensagens menores que contenham conteúdo inadequado, recomendamos incluir um dicionário de palavras-chave personalizado para o monitoramento de políticas de conformidade de comunicação para esse tipo de conteúdo.
