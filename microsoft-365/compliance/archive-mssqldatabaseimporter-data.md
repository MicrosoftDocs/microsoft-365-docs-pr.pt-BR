...
Use um conector Globalnet no centro de conformidade do Microsoft 365 para importar e arquivar dados do MS SQL Database para caixas de correio de usuário em sua organização do Microsoft 365. A Globalnet fornece um conector MS SQL Importador de Banco de Dados configurado para capturar itens de um banco de dados usando um arquivo de configuração XML e importar esses itens para o Microsoft 365. O conector converte conteúdo do MS SQL Banco de Dados em um formato de mensagem de email e importa esses itens para caixas de correio de usuário no Microsoft 365.
...
2. Uma vez a cada 24 horas, os itens MS SQL Database são copiados para o site Globalnet Merge1. O conector também converte esse conteúdo em um formato de mensagem de email.

3. O conector do MS SQL Importador de Banco de Dados criado no centro de conformidade do Microsoft 365, conecta-se ao site Globalnet Merge1 todos os dias e transfere as mensagens para um local seguro de Armazenamento do Azure na nuvem da Microsoft.
...
## <a name="step-2-configure-the-ms-sql-database-importer-connector-on-the-globanet-merge1-site"></a>Etapa 2: Configurar o conector do Importador de Banco de Dados do MS SQL globalnet Merge1
