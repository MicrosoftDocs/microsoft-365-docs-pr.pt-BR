...
---
# <a name="compliance-offering-service-organization-controls-soc"></a>Oferta de conformidade: Service Organization Controls (SOC)
...
Os relatórios do SOC para o Azure, Cloud App Security, Flow, Graph, Intune, Power BI, PowerApps, Stream e Microsoft Datacenters se baseiam em uma janela de execução de 12 meses (período de auditoria) com novos relatórios lançados por trimestre. Uma frequência de auditoria maior fornece uma cobertura de período de auditoria mais oportuna por meio de um relatório do SOC, que fornece uma garantia maior de um auditor externo quando comparado a uma carta de pontes. Os clientes podem [baixar](https://aka.ms/stp) os relatórios mais recentes no Portal de Confiança do Serviço.
