...
|Os arquivos são compartilhados em reuniões online e conversas de IM (Microsoft Teams)  <br/> |Quando as pessoas estão trabalhando com arquivos usando o Microsoft Teams, o TLS é usado para a conexão. Isso é feito automaticamente no Office 365. O Microsoft Teams não suporta atualmente a renderização embutida de emails criptografados. Para impedir que os emails criptografados do pouso no Microsoft Teams sejam criptografados, consulte [Message Encryption FAQ](https://docs.microsoft.com/microsoft-365/compliance/ome-faq?view=o365-worldwide#can-i-automatically-remove-encryption-on-incoming-and-outgoing-mail).  <br/> 
