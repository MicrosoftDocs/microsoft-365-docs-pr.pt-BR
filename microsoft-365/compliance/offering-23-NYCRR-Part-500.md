...
- **Designe um diretor de segurança da informação** (CISO) para gerenciar o programa de segurança cibernética e aplicar a política. Para ajudar seu CISO, a Microsoft fornece informações detalhadas de cibersegurança sobre implantações de nuvem da Microsoft por meio do [Azure Defender*](https://azure.microsoft.com/services/security-center/?v=17.23h), da [Análise Avançada de Ameaças do Office 365](https://docs.microsoft.com/advanced-threat-analytics/) e [Segurança do Power BI](https://go.microsoft.com/fwlink/?LinkId=829185).
- **Monitore e teste a eficácia de seu programa de segurança cibernética** : a Microsoft fornece informações de auditorias de suas práticas de segurança cibernética que inclui monitoramento contínuo, testes periódicos de penetração e avaliações de vulnerabilidades. Os clientes podem realizar seus próprios testes sem permissão prévia da Microsoft.
