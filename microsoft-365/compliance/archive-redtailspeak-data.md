...
Use um conector Veritas no centro de conformidade do Microsoft 365 para importar e arquivar dados do Redtail Fale com caixas de correio de usuário em sua organização do Microsoft 365. A Veritas fornece um conector [de](https://globanet.com/redtail/) Fala de Cauda Vermelha configurado para capturar itens do servidor SFTP da sua organização onde os itens são recebidos do Redtail. O conector converte o conteúdo do Redtail Speak em um formato de mensagem de email e importa esses itens para a caixa de correio do usuário no Microsoft 365.
...
3. O conector de Redtail Speak que você cria no centro de conformidade do Microsoft 365 conecta-se ao site veritas Merge1 todos os dias e transfere as mensagens para um local seguro de Armazenamento do Azure na nuvem da Microsoft.
