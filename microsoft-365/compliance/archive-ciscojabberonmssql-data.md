...
Use um conector Veritas no centro de conformidade do Microsoft 365 para importar e arquivar dados da plataforma Cisco Jabber para caixas de correio de usuário em sua organização do Microsoft 365. A Veritas fornece um conector [Cisco Jabber](https://globanet.com/jabber/) configurado para capturar itens do banco de dados MS SQL do Jabber, como mensagens de chat 1:1 e chats de grupo e, em seguida, importar esses itens para o Microsoft 365. O conector recupera dados do banco de dados MS SQL MS do Cisco Jabber, processa-o e converte o conteúdo da conta Cisco Jabber de um usuário em um formato de mensagem de email e importa esses itens para a caixa de correio do usuário no Microsoft 365.
...
2. Uma vez a cada 24 horas, os itens do Cisco Jabber são copiados do banco de dados de SQL MS para o site Veritas Merge1. O conector também converte o conteúdo das mensagens de chat em um formato de mensagem de email.

3. O conector Cisco Jabber que você cria no centro de conformidade do Microsoft 365 conecta-se ao site Veritas Merge1 todos os dias e transfere os itens para um local seguro de Armazenamento do Azure na nuvem da Microsoft.
...
## <a name="step-2-configure-the-cisco-jabber-connector-on-the-veritas-merge1-site"></a>Etapa 2: Configurar o conector cisco jabber no site Mesclagem de Veritas1

A segunda etapa é configurar o Cisco Jabber em MS SQL conector no site Veritas Merge1. Para obter informações sobre como configurar o Cisco Jabber no conector SQL MS, consulte [Merge1 Third-Party Connectors User Guide](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Cisco%20Jabber%20on%20MS%20SQL%20User%20Guide%20.pdf).
