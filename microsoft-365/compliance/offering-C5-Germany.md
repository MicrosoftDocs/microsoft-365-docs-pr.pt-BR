...
ms.locfileid: "39625181"
---
# <a name="compliance-offering-cloud-computing-compliance-controls-catalog-c5"></a>Oferta de conformidade: Cloud Computing Compliance Controls Catalog (C5)
...
- Cloud Computing Compliance Controls Catalogue (C5) ([inglês](https://www.bsi.bund.de/EN/Topics/CloudComputing/Compliance_Controls_Catalogue/Compliance_Controls_Catalogue_node.html)) ([alemão](https://www.bsi.bund.de/DE/Themen/DigitaleGesellschaft/CloudComputing/Anforderungskatalog/Anforderungskatalog_node.html))
- [Referenciando o Cloud Computing Compliance Controls Catalogue (C5) para Normas Internacionais](https://www.bsi.bund.de/SharedDocs/Downloads/EN/BSI/CloudComputing/ComplianceControlsCatalogue/Referencing_Cloud_Computing_Compliance_Controls_Catalogue.pdf;jsessionid=E5F009E49EB2689FAC3705578821BCB6.2_cid286?__blob=publicationFile&v=2)
- [Recomendações de Segurança para Provedores de Computação em Nuvem](https://www.bsi.bund.de/SharedDocs/Downloads/EN/BSI/Publications/CloudComputing/SecurityRecommendationsCloudComputingProviders.pdf?__blob=publicationFile&v=2)
