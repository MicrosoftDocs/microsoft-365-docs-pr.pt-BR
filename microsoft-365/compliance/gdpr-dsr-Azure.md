...
>[Importante] Você deve ser um administrador de locatários para excluir um usuário do locatário.
...
-   **Conta de armazenamento.** Selecione o local do Armazenamento do Azure (Blob). Para saber mais, consulte o artigo [Introdução ao Armazenamento do Microsoft Azure: armazenamento de blob](https://docs.microsoft.com/azure/storage/common/storage-introduction#blob-storage).
