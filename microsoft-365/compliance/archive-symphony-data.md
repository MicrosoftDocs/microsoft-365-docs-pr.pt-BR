...
description: Os administradores podem configurar um conector para importar e arquivar dados da Globalnet Symphony para o Microsoft 365. Esse conector permite arquivar dados de fontes de dados de terceiros no Microsoft 365. Depois de arquivar esses dados, você pode usar recursos de conformidade, como retenção legal, pesquisa de conteúdo e políticas de retenção para gerenciar dados de terceiros.
ms.openlocfilehash: 5a23e88b0240bd47b552aa62cd704a0560b01206
ms.sourcegitcommit: 27b2b2e5c41934b918cac2c171556c45e36661bf
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 03/19/2021
ms.locfileid: "50925025"
---
# <a name="set-up-a-connector-to-archive-symphony-data"></a>Configurar um conector para arquivar dados de orquestra

Use um conector Globalnet no centro de conformidade do Microsoft 365 para importar e arquivar dados de orquestra para caixas de correio de usuário em sua organização do Microsoft 365. A Orquestra é uma plataforma de mensagens e colaboração usada no setor de serviços financeiros. A Globalnet [](https://globanet.com/symphony) fornece um conector de dados Desarmado no centro de conformidade do Microsoft 365 que você pode configurar para capturar itens da fonte de dados de terceiros (regularmente) e importar esses itens para caixas de correio de usuário. O conector converte o conteúdo de um item da conta Da Orquestra Em um formato de mensagem de email e importa o item para uma caixa de correio no Microsoft 365.
...
2. Uma vez a cada 24 horas, as mensagens de chat da Orquestra Sinfônica são copiadas para o site Globalnet Merge1. O conector também converte o conteúdo de uma mensagem de chat em um formato de mensagem de email.

3. O conector de orquestração que você cria no centro de conformidade do Microsoft 365, conecta-se ao site Globalnet Merge1 todos os dias e transfere as mensagens para um local de Armazenamento seguro do Azure na nuvem da Microsoft.
...
## <a name="configure-the-symphony-connector-on-the-globanet-merge1-site"></a>Configurar o conector Defônico no site Globalnet Merge1

A segunda etapa é configurar o conector Defônico no site Merge1. Para obter informações sobre como configurar o conector Defônico no site Globalnet Merge1, consulte [Merge1 Third-Party Connectors User Guide](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Symphony%20User%20Guide%20.pdf).
