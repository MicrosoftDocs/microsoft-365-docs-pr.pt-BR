...
ms.locfileid: "48409086"
---
# <a name="set-up-a-connector-to-archive-xsltxml-data-preview"></a>Configurar um conector para arquivar dados XSLT/XML (visualização)
...
- Crie uma conta do Merge1 do Globanet para conectores da Microsoft. Para fazer isso, entre em contato com o [suporte ao cliente Globanet](https://globanet.com/contact-us/). Você precisa entrar nessa conta ao criar o conector na etapa 1.
...
3. Na página **consentimento do administrador** , clique em **fornecer consentimento**. Você será redirecionado para o site da Microsoft. Clique em **aceitar** para fornecer o consentimento.
...
4. Clique em **Avançar**, revise suas configurações e vá para a página **conectores de dados** para ver o andamento do processo de importação para o novo conector.
...
2. Clique na guia **conectores** e selecione o **XSLT/XML** Connector para exibir a página de menu suspenso, que contém as propriedades e informações sobre o conector.
