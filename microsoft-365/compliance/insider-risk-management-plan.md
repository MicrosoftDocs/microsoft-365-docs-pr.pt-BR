...
- Ao usar **modelos de violação** de política de segurança, você deve habilitar o Microsoft Defender for Endpoint para integração de gerenciamento de riscos insider na Central de Segurança do Defender para importar alertas de violação de segurança. Consulte o [artigo Configurar recursos avançados](/windows/security/threat-protection/microsoft-defender-atp/advanced-features) do Microsoft Defender para obter orientação passo a passo para habilitar a integração do Defender para Ponto de Extremidade com o gerenciamento de riscos insider.
...
Compartilhe a documentação de gerenciamento de riscos interno com as partes interessadas em sua organização incluídas no seu fluxo de trabalho de gerenciamento e correção:
