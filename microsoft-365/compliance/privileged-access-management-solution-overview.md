...
5. Enviar/aprovar [solicitações de acesso privilegiado](privileged-access-management-configuration.md#step-4-submitapprove-privileged-access-requests)

## <a name="more-information-about-privileged-access-management"></a>Mais informações sobre o gerenciamento de acesso privilegiado

- [Perguntas frequentes sobre o gerenciamento de acesso privilegiado](privileged-access-management-overview.md#frequently-asked-questions)