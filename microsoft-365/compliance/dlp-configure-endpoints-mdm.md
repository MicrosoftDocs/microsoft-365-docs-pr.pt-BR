...
Você pode usar soluções de gerenciamento de dispositivo móvel (MDM) para configurar dispositivos. Microsoft 365 A prevenção contra perda de dados do ponto de extremidade dá suporte a MDMs fornecendo OMA-URIs para criar políticas para gerenciar dispositivos.
...
6. Use a Microsoft Intune de configuração personalizada para implantar as seguintes configurações OMA-URI com suporte.
