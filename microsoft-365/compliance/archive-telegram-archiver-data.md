...
---
# <a name="set-up-a-connector-to-archive-telegram-communications-data-preview"></a>Configurar um conector para arquivar dados de comunicações do Telegram (visualização)
