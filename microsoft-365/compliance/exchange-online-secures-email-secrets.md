...
Além da Central de Confiações do Office 365 que fornece Informações de Segurança, Privacidade e Conformidade para [o Office 365,](./get-started-with-service-trust-portal.md)talvez você queira saber como a Microsoft ajuda a proteger segredos que você fornece em seus datacenters. Usamos uma tecnologia chamada Distributed Key Manager (DKM).
