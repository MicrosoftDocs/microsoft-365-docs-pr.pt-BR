---
title: Saiba mais sobre as barreiras de informação no Microsoft 365
f1.keywords:
- NOCSH
ms.author: chrfox
author: chrfox
...
ms.locfileid: "49701000"
---
# <a name="learn-about-information-barriers-in-microsoft-365"></a>Saiba mais sobre as barreiras de informação no Microsoft 365

Os serviços de nuvem da Microsoft incluem recursos avançados de comunicação e colaboração. Mas suponha que você deseja restringir a comunicação e a colaboração entre dois grupos para evitar um conflito de interesse de ocorrer em sua organização. Ou, talvez você queira restringir a comunicação e a colaboração entre determinadas pessoas dentro da sua organização para proteger informações internas. A Microsoft 365 permite a comunicação e a colaboração entre grupos e organizações, portanto, existe uma maneira de restringir a comunicação e a colaboração entre grupos específicos de usuários quando necessário? Com as barreiras de informação, você pode! 

As barreiras de informação agora têm suporte no Microsoft Teams, no SharePoint Online e no OneDrive for Business. Supondo que sua [assinatura](#required-licenses-and-permissions) inclua barreiras de informação, um administrador de conformidade ou barreiras de informações pode definir políticas para permitir ou impedir a comunicação entre grupos de usuários no Microsoft Teams. As políticas de barreira de informações podem ser usadas para situações como estas:
...
- Conformidade da Microsoft 365 E5/a5
- Gerenciamento de risco do Microsoft 365 Insider

Para obter mais detalhes, consulte [o guia de licenciamento do Microsoft 365 para segurança & conformidade](https://docs.microsoft.com/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance#information-protection).
...
(Para saber mais sobre funções e permissões, confira [permissões no centro de conformidade & segurança do Office 365](../security/office-365-security/permissions-in-the-security-and-compliance-center.md).)
...
- [Saiba mais sobre as barreiras de informação no SharePoint Online](https://docs.microsoft.com/sharepoint/information-barriers)
- [Saiba mais sobre as barreiras de informação no OneDrive for Business](https://docs.microsoft.com/onedrive/information-barriers)