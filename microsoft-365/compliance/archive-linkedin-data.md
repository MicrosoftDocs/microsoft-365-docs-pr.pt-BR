...
4. Na página **entrar com o LinkedIn** , selecione **entrar com LinkedIn**.

   A página de entrada do LinkedIn é exibida.

   ![Página de entrada do LinkedIn](media/LinkedInSigninPage.png)

5. Na página de entrada do LinkedIn, insira o endereço de email (ou número de telefone) e a senha da conta do LinkedIn associada à página da empresa que você deseja arquivar e selecione **entrar**.
...
6. Selecione a página da empresa da qual você deseja arquivar itens e, em seguida, selecione **Avançar**.

7. Na página **definir filtros** , você pode aplicar um filtro para importar inicialmente os itens que tenham uma determinada idade. Selecione uma idade e, em seguida, selecione **Avançar**.

8. Na página **definir conta de armazenamento** , digite o endereço de email de uma caixa de correio do Office 365 à qual os itens do LinkedIn serão importados e, em seguida, selecione **Avançar**. Os itens são importados para a pasta caixa de entrada nesta caixa de correio.

9. Revise as configurações do conector e selecione **salvar** para concluir a configuração do conector.

Depois de criar o conector, você pode voltar para a página **arquivar dados** de terceiros (selecione **Atualizar** se necessário para atualizar a lista de conectores) um modo de exibição do novo conector. O valor na coluna **status** está **aguardando para iniciar**. É necessário ter até 24 horas para que o processo inicial de importação seja iniciado. Após a primeira vez que o conector é executado e importa os itens do LinkedIn, o conector é executado uma vez a cada 24 horas e importa os novos itens que são criados na página da empresa do LinkedIn nas últimas 24 horas.

Para exibir mais detalhes, selecione o conector na lista na página de dados de terceiros de **arquivamento** para exibir a página de menu. Em **status**, o intervalo de datas exibido indica o filtro de idade que foi selecionado quando o conector foi criado. 
