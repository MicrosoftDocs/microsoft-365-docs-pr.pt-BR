...
O guia aborda como usar os produtos, os serviços e as ferramentas administrativas do Office 365, de modo que ajudem você a encontrar dados pessoais e agir em relação aos dados pessoais que residem na nuvem da Microsoft. Veja aqui uma breve visão geral dos processos descritos neste guia:
...
Para ajudá-lo a determinar onde procurar dados pessoais ou o que pesquisar, ele ajuda a identificar os aplicativos do Office 365 que as pessoas em sua organização podem usar para criar e armazenar dados no Office 365. Sabendo que isso limita os aplicativos do Office 365 que estão dentro do escopo para uma DSR e ajuda você a determinar como pesquisar e acessar dados pessoais relacionados a uma DSR. Especificamente, isso significa que você pode usar a ferramenta de Pesquisa de Conteúdo ou se você precisar usar a funcionalidade no aplicativo do aplicativo em que os dados foram criados.
...
A primeira etapa ao responder a uma DSR é localizar os dados pessoais do titular da DSR. Isso consiste em usar as ferramentas de Descoberta Eletrônica do Office 365 para pesquisar dados pessoais (entre todos os dados da sua organização no Office 365) ou ir diretamente para o aplicativo nativo em que os dados foram criados. Esta primeira etapa, localizar e revisar os dados pessoais em questão, ajuda a determinar se uma DSR atende aos requisitos de sua organização para aceitar ou recusar uma solicitação de entidade de dados. Por exemplo, depois de localizar e analisar os dados pessoais em questão, pode ser que você determine que a solicitação não atende aos requisitos da sua organização porque afetaria negativamente os direitos e liberdade de terceiros, ou porque os dados pessoais estão contidos em um registro comercial que a organização tem um interesse comercial em manter.
...
- Pesquise no log de auditoria do Office 365 atividades de arquivos e pastas recentes executadas pelo usuário que é o titular da DSR. Pesquisar o log de auditoria traz uma lista de registros de auditoria que contêm o nome e o local de recursos que o usuário interagiu recentemente.  Você pode usar essas informações para criar uma consulta de pesquisa de conteúdo. Confira [Pesquisar o log de auditoria no Centro de Conformidade e Segurança do Office 365](https://support.office.com/article/Search-the-audit-log-in-the-Office-365-Security-Compliance-Center-0d4d0f35-390b-4518-800e-0c7ec95e946c).

#### <a name="building-search-queries-to-find-personal-data"></a>Criar consultas de pesquisa para encontrar dados pessoais

A DSR que você está investigando provavelmente contém identificadores que você pode usar na consulta de pesquisa de palavra-chave para procurar dados pessoais. Aqui estão alguns identificadores comuns que podem ser usados em uma consulta de pesquisa para localizar dados pessoais:
...
Você exporta os resultados de uma pesquisa de conteúdo e os itens parcialmente indexados do local de conteúdo que foi pesquisado. Você também pode exportar somente os itens parcialmente indexados. Em seguida, você pode abri-los em seus aplicativos nativos e analisar o conteúdo. Você deve usar essa opção para exportar itens do SharePoint Online e do OneDrive for Business. Confira [Exportar os resultados da Pesquisa de Conteúdo do Centro de Conformidade e Segurança do Office 365](https://support.office.com/article/Export-Content-Search-results-from-the-Office-365-Security-Compliance-Center-ed48d448-3714-4c42-85f5-10f75f6a4278).
...
1. Abra a Pesquisa de Conteúdo no Centro de Conformidade e Segurança.
2. Na página do submenu de pesquisa, clique em ![](media/o365-dsr_image21.png) **Mais** e em **Exportar resultados**.  Também é possível exportar um relatório.
...
Não é possível excluir um site que está localizado em uma retenção de Descoberta Eletrônica ou que está atribuído a uma política de retenção. Os sites devem ser removidos de uma retenção de Descoberta Eletrônica ou de uma política de retenção antes que você possa excluí-los.
...
|![Ícone do Project](media/o365-project-64x64.png) <br> [Project](#project-online) |![Ícone do Publisher](media/o365-publisher-64x64.png) <br> [Publisher](#publisher) |![Ícone do StaffHub](media/o365-staffhub-64x64.png) <br> [StaffHub](#staffhub) |
|![Ícone do Stream](media/o365-stream-64x64.png) <br> [Stream](#stream) |![Ícone do Sway](media/o365-sway-64x64.png) <br> [Sway](#sway) | ![Ícone do quadro de comunicações](media/O365-DSR-Doc_image36.png) <br> [Quadro de comunicações](#whiteboard) |
...
Um administrador pode usar a ferramenta Pesquisa de Conteúdo no Centro de Conformidade e Segurança do Office 365 para procurar arquivos de alunos (nas bibliotecas de Trabalho do Aluno e Arquivos da Classe) relacionados a envios em tarefas e arquivos relacionados a tarefas. Por exemplo, um administrador pode pesquisar todos os sites do SharePoint na organização e usar o nome do aluno e o nome da classe ou tarefa na consulta de pesquisa para localizar dados relevantes para uma solicitação de DSR.
...
Você pode exportar dados de tarefas para um aluno específico para todas as classes em que o aluno está matriculado atualmente usando um script do PowerShell. Confira:
...
Você pode excluir dados do Assignments de um aluno específico para todas as classes em que o aluno está matriculado atualmente usando um script do PowerShell. Faça isso antes de remover o aluno da classe. Confira:
...
3. Na página **Ambientes**, clique no ambiente dos fluxos que deseja acessar. As organizações do Office 365 têm um ambiente padrão. 
...
- Uma licença paga de Plano 2 do PowerApps ou uma licença de avaliação de Plano 2 do PowerApps. Você pode assinar uma licença de avaliação de avaliação de 30 dias [aqui](http://web.powerapps.com/trial). 
...
As seções a seguir explicam como usar a funcionalidade no aplicativo do Microsoft StaffHub para localizar, acessar, exportar e excluir dados pessoais.
...
No centro de administração do Yammer, um administrador verificado pelo Yammer (administrador global do Office 365 ou administrador verificado configurado no Yammer) pode exportar dados pertencentes a um determinado usuário. A exportação inclui as mensagens e os arquivos postados e modificados pelo usuário e as informações sobre tópicos e grupos criados pelo usuário. Quando uma exportação de dados específica de usuário é executada, o administrador também recebe uma mensagem na caixa de entrada com os dados de atividade da conta do usuário se for de sua escolha. Para obter instruções detalhadas, confira [Yammer Enterprise: privacidade](https://support.office.com/article/enterprise-privacy-yammer-eae49f12-4661-4ba5-aa72-01248f0709bf).
...
Para acessar dados não incluídos na exportação de dados, capturas de tela pode ser feitas para perfil do usuário, configurações, associações de grupos, mensagens marcadas com indicador, usuário seguidos e tópicos seguidos. Os usuários ou administradores podem coletar essas informações. Para saber mais, confira [Yammer Enterprise: privacidade](https://support.office.com/article/enterprise-privacy-yammer-eae49f12-4661-4ba5-aa72-01248f0709bf). 
...
Um administrador global do Office 365 pode acessar a conta do OneDrive for Business de um usuário usando o .
...
- A atualização de um documento salvará uma nova versão do documento, que conterá a revisão. As versões anteriores do documento não serão atualizadas. Isso significa que é possível que os dados que são o objeto de uma solicitação de retificação de DSR podem persistir em versões antigas do tópico. As versões antigas de um tópico podem ser excluídas e depois permanentemente removidas do Office 365. Confira a seção [Excluir documentos no SharePoint Online e OneDrive for Business](#deleting-documents-in-sharepoint-online-and-onedrive-for-business) neste guia.
...
|11/7/2019| [MyAnalytics](#myanalytics)|A capacidade de um administrador de usar a ferramenta de ocorrência de DSR no Centro de Conformidade e Segurança do Office 365 de exportar dados do MyAnalytics foi removida porque todos os usuários podem ver seus dados no aplicativo MyAnalytics. |
||||
