...
Se ele está adicionando novas soluções ao Centro de conformidade do Microsoft 365 , atualizando recursos existentes com base em seus comentários ou implantando documentação atualizada e atualizada, o Microsoft 365 ajuda você [a](microsoft-365-compliance-center.md)se manter no topo do cenário de conformidade em constante mudança. Confira abaixo o que há de novo na conformidade Microsoft 365 hoje.
...
>
> - [Novidades na Centro de administração do Microsoft 365](/office365/admin/whats-new-in-preview)
...
- Se você liberar uma política de retenção de um site SharePoint ou OneDrive conta, não será mais necessário aguardar o período de carência de 30 dias antes de poder excluir o site ou a conta. Uma solicitação popular dos clientes, essa alteração agora está concluída para todos os locatários.
...
- Na visualização, uma nova configuração **para** o contexto de autenticação agora está disponível quando você configura um rótulo de sensibilidade para grupos [e sites.](sensitivity-labels-teams-groups-sites.md) Essa opção funciona em conjunto com as políticas de Acesso Condicional do Azure AD para impor condições mais rigorosas quando os usuários acessam SharePoint sites que tenham o rótulo aplicado. Leia as [dependências e limitações antes](sensitivity-labels-teams-groups-sites.md#more-information-about-the-dependencies-for-the-authentication-context-option) de configurar essa configuração.
- [As políticas de rotulagem](apply-sensitivity-label-automatically.md#how-to-configure-auto-labeling-policies-for-sharepoint-onedrive-and-exchange) automática configuradas apenas para Exchange agora suportam **rótulos** de sensibilidade que aplicam criptografia com Permitir que os usuários atribuam permissões para as opções Não Encaminhar ou Encrypt-Only.
- [A rotulagem obrigatória](sensitivity-labels-office-apps.md#require-users-to-apply-a-label-to-their-email-and-documents) agora está geralmente disponível para todos os Office aplicativos, em todas as plataformas.
...
- [Criar notificações para atividades de correspondência exata de dados](/microsoft-365/compliance/sit-edm-notifications-activities)
