...
# [Gerenciar a proteção de informações](protect-information.md)
...
## [Criptografia de Email](email-encryption.md)
...
### [Perguntas frequentes sobre a Criptografia de Mensagens do Office 365](ome-faq.md)
...
### [Criar e publicar rótulos de retenção usando o PowerShell](bulk-create-publish-labels-using-powershell.md)
...
### [Gerenciar o ciclo de vida dos documentos do SharePoint](auto-apply-retention-labels-scenario.md)
...
#### [Assistir a vídeos sobre gerenciamento de registros](https://go.microsoft.com/fwlink/?linkid=867039)
...
## [Solução da Descoberta Eletrônica Avançada no Microsoft 365](overview-ediscovery-20.md)
### [Criar uma nova ocorrência](create-new-ediscovery-case.md)

### [Trabalhar com custodiantes](managing-custodians.md)
#### [Adicionar custodiantes a uma ocorrência](add-custodians-to-case.md)
#### [Gerenciar custodiantes](manage-new-custodians.md)
#### [Exibir a atividade custodiante](view-custodian-activity.md)

### [Trabalhar com comunicações](managing-custodian-communications.md)
#### [Criar uma notificação de retenção](create-hold-notification.md)
...
### [Gerenciar retenções](managing-holds.md)
...
### [Coleta de dados para uma ocorrência](collecting-data-for-ediscovery.md)
#### [Criar uma pesquisa](create-search-to-collect-data.md)
#### [Criar consultas de pesquisa](building-search-queries.md)
#### [Estatísticas de pesquisa](search-statistics.md)
#### [Adicionar os resultados da pesquisa a um conjunto de revisão](add-data-to-review-set.md)

### [Gerenciar conjuntos de revisão](managing-review-sets.md)
#### [Carregar dados que não são do Office 365 em um conjunto de revisão](load-non-Office-365-data-into-a-review-set.md)
#### [Adicionar dados a outro conjunto de revisão](add-data-to-review-set-from-another-review-set.md)
#### [Gerenciar conjuntos de carga](manage-load-sets-in-advanced-ediscovery.md)
...
#### [Configurar detecção de privilégio advogado-cliente](attorney-privilege-detection.md)
...
#### [Adicionar ou remover membros de uma ocorrência](add-or-remove-members-from-a-case-in-advanced-ediscovery.md)
...
#### [Notas de versão](release-notes-ediscovery20.md)
#### [Limites da Descoberta Eletrônica Avançada](limits-ediscovery20.md)
#### [Tipos de arquivos compatíveis](supported-filetypes-ediscovery20.md)
#### [Campos de metadados do documento](document-metadata-fields-in-advanced-ediscovery.md)
#### [Conjuntos de revisão de conversas](conversation-review-sets.md)
#### [Solução de problemas do AzCopy](troubleshooting-azcopy.md)
...
## [Série de solução de Descoberta Eletrônica – Cenário de derramamento de dados – Pesquisar e limpar](data-spillage-scenariosearch-and-purge.md)
...
# [Gerenciar investigações de dados](overview-data-investigations.md)
## [Gerenciar um incidente de derramamento de dados](manage-data-spillage-incidents.md)
## [Criar uma nova investigação](create-new-investigation.md)
## [Atribuir permissões para investigações de dados](permissions.md)
 
## [Pesquisar dados em uma investigação](search-for-data.md)
### [Criar consultas de pesquisa](build-search-queries.md)
### [Estatísticas de pesquisa](search-statistics.md)

## [Revisar dados em evidência](review-data-in-evidence.md)
### [Consultar os dados](evidence-query.md)
### [Marcar documentos](tag-documents.md)
### [Anotar e redigir documentos](annotate-and-redact-documents.md)
### [Carregar dados que não são do Office 365](load-non-office365-data.md)
...
### [Indexar dados das pessoas em uma investigação](index-data-people-of-interest.md)
### [Exibir a atividade de auditoria das pessoas em uma investigação](view-people-of-interest-activity.md)
...
### [Notas de versão](data-investigations-release-notes.md)
### [Limites nas investigações de dados](limits-datainvestigations.md)
### [Tipos de arquivos compatíveis](supported-filetypes-datainvestigations.md)
...
## [Gerenciar políticas de alerta](alert-policies.md)
...
## [Use o log de auditoria para investigar problemas comuns](auditing-troubleshooting-scenarios.md)
...
#### [Listas de verificação de preparação de responsabilidade](gdpr-arc.md)
#### [Azure](gdpr-arc-azure.md)
#### [Dynamics 365](gdpr-arc-dynamics365.md)
#### [Suporte da Microsoft e Serviços Profissionais](gdpr-arc-prof-services.md)
#### [Office 365](gdpr-arc-office365.md)

### [Proteção de informações](gdpr-information-protection.md)

### Solicitações de titular dos dados
#### [Solicitações de entidades de dados](gdpr-data-subject-requests.md)
#### [Azure](gdpr-dsr-azure.md)
#### [Azure DevOps Services](gdpr-dsr-vsts.md)
#### [Dynamics 365](gdpr-dsr-dynamics365.md)
#### [Intune](gdpr-dsr-intune.md)
#### [Suporte da Microsoft e Serviços Profissionais](gdpr-dsr-prof-services.md)
#### [Office 365](gdpr-dsr-office365.md)
#### [Família do Visual Studio](gdpr-dsr-visual-studio-family.md)

### Notificação de violação
#### [Notificação de violação](gdpr-breach-notification.md)
#### [Azure](gdpr-breach-azure.md)
#### [Dynamics 365](gdpr-breach-dynamics365.md)
#### [Suporte da Microsoft e Serviços Profissionais](gdpr-breach-microsoft-support-professional-services.md)
#### [Office 365](gdpr-breach-office365.md)

### Avaliações do impacto sobre a proteção dos dados
#### [Avaliações do impacto sobre a proteção dos dados](gdpr-data-protection-impact-assessments.md)
#### [Azure](gdpr-dpia-azure.md)
#### [Dynamics 365](gdpr-dpia-dynamics.md)
#### [Suporte da Microsoft e Serviços Profissionais](gdpr-dpia-prof-services.md)
#### [Office 365](gdpr-dpia-office365.md)

### [Responsável pela proteção de dados da Microsoft](gdpr-data-protection-officer.md)
...
## [Ofertas de conformidade da Microsoft](offering-home.md)

## Global
### [Parâmetros de comparação da CIS](offering-cis-benchmark.md)
### [Atestado CSA-STAR](offering-csa-star-attestation.md)
### [Certificação CSA-STAR](offering-csa-star-certification.md)
### [Autoavaliação CSA-STAR](offering-csa-star-self-assessment.md)
...
### [EAR (Reg. Admin. Exportação dos EUA)](offering-ear.md)
...
### [VPATS Seção 508](offering-section-508-vpats.md)
...
#### [AFM + DNB (Países Baixos)](offering-afm-dnb-netherlands.md)
#### [APRA (Austrália)](offering-apra-australia.md)
#### [AMF e ACPR (França)](offering-amf-acpr-france.md)
#### [EBA (UE)](offering-eba-eu.md)
#### [FCA (Reino Unido)](offering-fca-uk.md)
#### [FFIEC (EUA)](offering-ffiec-us.md)
#### [FINMA (Suíça)](offering-finma-switzerland.md)
#### [FINRA 4511](offering-finra-4511.md)
#### [FISC (Japão)](offering-fisc-japan.md)
#### [FSA (Dinamarca)](offering-fsa-denmark.md)
#### [GLBA](offering-glba.md)
#### [KNF (Polônia)](offering-knf-poland.md)
#### [MAS + ABS (Cingapura)](offering-mas-abs-singapore.md)
#### [NBB + FSMA (Bélgica)](offering-nbb-fsma-belgium.md)
#### [OSFI (Canadá)](offering-osfi-canada.md)
#### [PCI DSS](offering-pci-dss.md)
#### [RBI + IRDAI (Índia)](offering-rbi-irdai-india.md)
...
### Integridade
#### [HDS (França)](offering-hds-france.md)
#### [HIPAA/HITECH](offering-hipaa-hitech.md)
#### [HITRUST](offering-hitrust.md)
#### [MARS-E](offering-mars-e.md)
#### [NEN-7510 (Países Baixos)](offering-nen-7510-netherlands.md)
#### [NHS IG Toolkit (Reino Unido)](offering-nhs-ig-toolkit-uk.md)

### Fabricação
#### [FDA CFR Título 21 Parte 11](offering-fda-cfr-title-21-part-11.md)
#### [GxP](offering-gxp.md)
#### [TISAX (Alemanha)](offering-tisax-germany.md)

### Mídia
#### [CDSA](offering-cdsa.md)
#### [DPP (Reino Unido)](offering-dpp-uk.md)
#### [FACT (Reino Unido)](offering-fact-uk.md)
...
#### [Cláusulas-modelo da UE](offering-eu-model-clauses.md)
#### [EBA (UE)](offering-eba-eu.md)
#### [Defesa de Privacidade UE-EUA](offering-eu-us-privacy-shield.md)
#### [FACT (Reino Unido)](offering-fact-uk.md)
#### [FCA (Reino Unido)](offering-fca-uk.md)
#### [FFIEC (EUA)](offering-ffiec-us.md)
#### [FINMA (Suíça)](offering-finma-switzerland.md)
#### [RGPD (UE)](offering-gdpr-eu.md)
#### [GLBA](offering-glba.md)
#### [HITRUST](offering-hitrust.md)
#### [IRS 1075](offering-irs-1075.md)
#### [ISO 27018](offering-iso-27018.md)
...
#### [PCI DSS](offering-pci-dss.md)
#### [VPATS Seção 508](offering-section-508-vpats.md)
#### [Avaliações compartilhadas](offering-shared-assessments.md)
#### [SOC](offering-soc.md)
#### [LOPD (Espanha)](offering-lopd-spain.md)
#### [Cyber Essentials Plus (Reino Unido)](offering-cyber-essentials-plus-uk.md)
#### [G-Cloud (Reino Unido)](offering-g-cloud-uk.md)

## Regional
### Ásia
#### [CS Mark (Gold) (Japão))](offering-cs-mark-gold-japan.md)
...
#### [ISMS (Coreia)](offering-ISMS-korea.md)
#### [MeitY (Índia)](offering-meity-india.md)
#### [MTCS (Cingapura)](offering-mtcs-singapore.md)
#### [My Number (Japão)](offering-my-number-act-japan.md)
#### [TRUCS (China)](https://aka.ms/TRUCS-Compliance)

### Austrália / Pacífico
#### [CCSL/IRAP (Austrália)](offering-CCSL-IRAP-Australia.md)
#### [NZ CC Framework (Nova Zelândia)](offering-nz-cc-framework-nz.md)

### Europa
#### [BIR 2012 (Países Baixos)](offering-bir-2012-netherlands.md)
#### [C5 (Alemanha)](offering-c5-germany.md)
#### [Cyber Essentials Plus (Reino Unido)](offering-cyber-essentials-plus-uk.md)
#### [EN 301 549 (UE)](offering-en-301-549-eu.md)
#### [ENS (Espanha)](offering-ens-spain.md)
#### [ENISA IAF (UE)](https://aka.ms/ENISA)
#### [Cláusulas-modelo da UE](offering-eu-model-clauses.md)
#### [Defesa de Privacidade UE-EUA](offering-eu-us-privacy-shield.md)
#### [RGPD (UE)](offering-gdpr-eu.md)
#### [G-Cloud (Reino Unido)](offering-g-cloud-uk.md)
#### IDW PS 951 (Alemanha)
#### [IT Grundschutz Workbook (Alemanha)](offering-it-grundschutz-workbook-germany.md)
#### [LOPD (Espanha)](offering-lopd-spain.md)
