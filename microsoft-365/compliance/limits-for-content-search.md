...
A tabela a seguir lista os limites de pesquisa ao usar a ferramenta de pesquisa de conteúdo no centro de conformidade do Microsoft 365 e para pesquisas associadas a um caso core de Descoberta eDiscovery.
...
|O número máximo de itens encontrados em sites do SharePoint e do OneDrive for Business exibidos na página de visualização ao visualizar os resultados da pesquisa. Os itens mais novos são exibidos.  <br/> |200  <br/> |
