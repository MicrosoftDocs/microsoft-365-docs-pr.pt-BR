...
Quando uma pessoa é adicionada à guia **de pessoas de interesse** , todos os itens parcialmente indexados do Microsoft 365 são processados para torná-los totalmente pesquisáveis.  Da mesma forma, quando os dados são adicionados à guia de **evidência** de fontes de dados do Microsoft 365 ou não-Microsoft 365, o conteúdo também é processado.
