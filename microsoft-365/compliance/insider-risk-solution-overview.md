...
| :---- | :-------- | :--------------------------- | :-------------------------- |:-------------------------| :--------------------------------|
| ![Ícone de derramamento de dados](../media/ir-risk-data-spillage.png)| Vazamento de dados | ![Com suporte](../media/check-mark.png) | ![Com suporte](../media/check-mark.png) |  |  |
...
| ![Ícone de fraude/fraude](../media/ir-risk-fraud.png)| Fraude | ![Com suporte](../media/check-mark.png) | ![Com suporte](../media/check-mark.png) |  |  |
...
| ![Ícone de troca/handshake do Insider](../media/ir-risk-insider-trading.png)| Troca de informações internas | ![Com suporte](../media/check-mark.png) |  |  |  |
...
| ![Ícone de pessoas/assédio no local de trabalho](../media/ir-risk-workplace-harassment.png)| Abuso no local de trabalho | ![Com suporte](../media/check-mark.png) |  |  |  |
...
|:------------------|:--------------|
| Gerenciar riscos de informações internas no Microsoft 365 |[Caminho de aprendizagem completo](/learn/paths/m365-compliance-insider) <br> Esse caminho de aprendizagem inclui todos os módulos de solução individuais para conformidade de comunicação, gerenciamento de riscos insider, barreiras de informações e gerenciamento de acesso privilegiado. Selecione este caminho de aprendizagem para concluir todos os módulos. |
