...
Após os dados de conexão FX serem armazenados nas caixas de correio do usuário, você pode aplicar recursos de conformidade da Microsoft 365, como retenção de litígio, descoberta eletrônica, políticas de retenção e rótulos de retenção e conformidade de comunicação. O uso de um conector de conexão FX para importar e arquivar dados no Microsoft 365 pode ajudar sua organização a se manter em conformidade com as políticas governamentais e regulamentares.

## <a name="overview-of-archiving-fx-connect-data"></a>Visão geral dos dados de conexão FX de arquivamento

A visão geral a seguir explica o processo de usar um conector para arquivar as informações de conexão FX no Microsoft 365.

![Fluxo de trabalho de arquivamento para dados de conexão FX](../media/FXConnectConnectorWorkflow.png)

1. Sua organização funciona com o FX Connect para configurar e configurar um site de conexão FX.

2. Uma vez a cada 24 horas, os itens das contas de conexão FX são copiados para o site do Globanet Merge1. O conector também converte os itens de conexão FX em um formato de mensagem de email.

3. O conector de conexão FX que você cria no centro de conformidade da Microsoft 365, conecta-se ao site do Globanet Merge1 todos os dias e transfere os itens de conexão FX para um local seguro de armazenamento do Azure na nuvem da Microsoft.

4. O conector importa itens para as caixas de correio de usuários específicos usando o valor da propriedade *email* do mapeamento de usuário automático, conforme descrito na [etapa 3](#step-3-map-users-and-complete-the-connector-setup). Uma subpasta na pasta caixa de entrada chamada **conexão FX** é criada nas caixas de correio do usuário e os itens são importados para essa pasta. O conector faz isso usando o valor da propriedade *email* . Cada item de conexão FX contém essa propriedade, que é preenchida com o endereço de email de cada participante do item.

## <a name="before-you-begin"></a>Antes de começar

- Crie uma conta do Globanet Merge1 aceitando os termos e condições de um conector de conexão FX. Para fazer isso, entre em contato com o [suporte ao cliente Globanet](https://globanet.com/contact-us). Você precisa entrar nessa conta ao criar o conector na etapa 1.
...
A primeira etapa é acessar a página **conectores de dados** no centro de conformidade da Microsoft 365 e criar um conector para dados de conexão FX.

1. Vá para [https://compliance.microsoft.com](https://compliance.microsoft.com/) e clique em **conectores de dados**  >  **FX Connect**.

2. Na página de descrição do produto de **conexão FX** , clique em **Adicionar conector**.
...
## <a name="step-2-configure-the-fx-connect-connector-on-the-globanet-merge1-site"></a>Etapa 2: configurar o conector de conexão FX no site do Globanet Merge1

A segunda etapa é configurar o conector de conexão FX no site do Merge1. Para obter informações sobre como configurar o conector de conexão FX, consulte [Merge1 do usuário de conectores de terceiros](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20FX%20Connect%20User%20Guide%20.pdf).
...
Depois de criar o conector de conexão FX, você pode visualizar o status do conector no centro de conformidade da Microsoft 365.

1. Vá para <https://compliance.microsoft.com/> e clique em **conectores de dados** no painel de navegação esquerdo.

2. Clique na guia **conectores** e selecione o conector de **conexão FX** para exibir a página de menu suspenso, que contém as propriedades e informações sobre o conector.
