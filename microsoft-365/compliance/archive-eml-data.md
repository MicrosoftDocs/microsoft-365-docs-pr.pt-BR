...
Após as mensagens de EML serem armazenadas nas caixas de correio do usuário, você pode aplicar recursos de conformidade do Microsoft 365, como retenção de litígio, descoberta eletrônica e políticas de retenção e rótulos de retenção. O uso de um conector EML para importar e arquivar dados no Microsoft 365 pode ajudar sua organização a se manter em conformidade com as políticas governamentais e regulamentares.
...
4. O conector importa os itens de mensagem convertidos para as caixas de correio de usuários específicos usando o valor da propriedade *email* do processo de mapeamento de usuário automático descrito na [etapa 3](#step-3-map-users-and-complete-the-connector-setup). Durante esse processo, uma subpasta na pasta caixa de entrada chamada **EML** é criada nas caixas de correio do usuário e os itens EML são importados para essa pasta. O conector determina qual caixa de correio para a qual importar itens usando o valor da propriedade *email* . Cada mensagem contém essa propriedade, que é preenchida com o endereço de email de cada participante do item de conteúdo.
...
2. Clique na guia **conectores** e selecione o conector **EML** para exibir a página de submenu. Esta página contém as propriedades e as informações sobre o conector.
