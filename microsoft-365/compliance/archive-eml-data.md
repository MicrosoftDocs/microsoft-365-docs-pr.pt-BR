...
Use um conector Globalnet no centro de conformidade do Microsoft 365 para importar e arquivar dados emL para caixas de correio de usuário em sua organização do Microsoft 365. EML é a extensão de arquivo para uma mensagem de email salva em um arquivo. O conector converte o conteúdo de um item do formato de origem para um formato de mensagem de email e importa o item para uma caixa de correio de usuário.

Depois que as mensagens EML são armazenadas em caixas de correio de usuário, você pode aplicar recursos de conformidade do Microsoft 365, como Retenção de Litígio, Descoberta Eletrônico e políticas de retenção e rótulos de retenção. Usar um conector EML para importar e arquivar dados no Microsoft 365 pode ajudar sua organização a permanecer em conformidade com políticas governamentais e regulatórias.
...
3. O conector EML que você cria no centro de conformidade do Microsoft 365, conecta-se ao site Globalnet Merge1 todos os dias e transfere as mensagens para um local seguro de Armazenamento do Azure na nuvem da Microsoft.
