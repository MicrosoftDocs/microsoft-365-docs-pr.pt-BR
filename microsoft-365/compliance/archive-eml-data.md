...
Após as mensagens de EML serem armazenadas nas caixas de correio do usuário, você pode aplicar recursos de conformidade do Microsoft 365, como retenção de litígio, descoberta eletrônica, políticas de retenção e rótulos de retenção e conformidade de comunicação. O uso de um conector EML para importar e arquivar dados no Microsoft 365 pode ajudar sua organização a se manter em conformidade com as políticas governamentais e regulamentares.

## <a name="overview-of-archiving-eml-data"></a>Visão geral dos dados de arquivamento EML

A visão geral a seguir explica o processo de usar um conector para arquivar dados EML no Microsoft 365.
...
2. Uma vez a cada 24 horas, os itens de conteúdo da fonte EML são copiados para o site do Globanet Merge1. Durante esse processo, o conteúdo de um arquivo EML é convertido em um formato de mensagem de email.

3. O conector EML que você cria no centro de conformidade da Microsoft 365, conecta-se ao site do Globanet Merge1 todos os dias e transfere as mensagens para um local seguro de armazenamento do Azure na nuvem da Microsoft.

4. O conector importa os itens de mensagem convertidos para as caixas de correio de usuários específicos usando o valor da propriedade *email* do processo de mapeamento de usuário automático descrito na [etapa 3](#step-3-map-users-and-complete-the-connector-setup). Durante esse processo, uma subpasta na pasta caixa de entrada chamada **EML**é criada nas caixas de correio do usuário e os itens EML são importados para essa pasta. O conector faz isso usando o valor da propriedade *email* . Cada mensagem contém essa propriedade, que é preenchida com o endereço de email de cada participante do item de conteúdo.

## <a name="before-you-begin"></a>Antes de começar

- Crie uma conta do Globanet Merge1 aceitando os termos e condições de um conector EML. Para fazer isso, entre em contato com o [suporte ao cliente Globanet](https://globanet.com/contact-us). Você precisa entrar nessa conta ao criar o conector na etapa 1.
...
A primeira etapa é acessar a página **conectores de dados** no centro de conformidade da Microsoft 365 e criar um conector para dados EML.

1. Vá para [https://compliance.microsoft.com](https://compliance.microsoft.com/) e clique em **conectores de dados**  >  **EML**.

2. Na página de descrição do produto **EML** , clique em **Adicionar conector**.
...
## <a name="step-2-configure-the-eml-connector-on-the-globanet-merge1-site"></a>Etapa 2: configurar o conector EML no site do Globanet Merge1

A segunda etapa é configurar o conector EML no site do Globanet Merge1. Para obter informações sobre como configurar o conector de EML, consulte [Merge1 de terceiros conectores do usuário](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20EML%20User%20Guide%20.pdf).
...
Depois de criar o conector EML, você pode visualizar o status do conector no centro de conformidade da Microsoft 365.
...
2. Clique na guia **conectores** e selecione o conector **EML** para exibir a página de submenu, que contém as propriedades e informações sobre o conector.
