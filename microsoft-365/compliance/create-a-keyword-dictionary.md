...
>
> Ao criar uma regex usando um hífen de byte duplo ou um ponto de byte duplo, certifique-se de escapar de ambos os caracteres como se escapasse de um hífen ou ponto em uma regex. Aqui está um exemplo de regex para referência:
>
>    - (?<!\d)([４][０-９]{3}[\-?\－\t]*[０-９]{4}
>
