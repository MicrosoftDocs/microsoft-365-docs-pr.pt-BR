...
---
# <a name="track-relevance-analysis-in-advanced-ediscovery"></a>Rastrear a análise de relevância na descoberta eletrônica avançada
...
4. Selecione **inconsistências de marca**. A guia **marca** é aberta exibindo uma lista de inconsistências para marcas de tabulação conforme necessário.
