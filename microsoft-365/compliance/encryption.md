...
A criptografia é uma parte importante da sua estratégia de proteção de arquivos e proteção de informações. Este artigo fornece uma visão geral da criptografia para o Office 365. Obter ajuda com tarefas de criptografia, como como configurar a criptografia para sua organização e como proteger documentos do Office com senha.
...
- Para obter informações sobre como configurar ou configurar a criptografia para sua organização, consulte Configurar criptografia [no Office 365 Enterprise](set-up-encryption.md).

## <a name="what-is-encryption-and-how-does-it-work-in-office-365"></a>O que é criptografia e como funciona no Office 365?
...
|Email em trânsito entre destinatários. Este email inclui emails hospedados pelo Exchange Online.  <br/> |Criptografia de Mensagens do Office 365 com Gerenciamento de Direitos do Azure, S/MIME e TLS para email em trânsito  <br/> |[Criptografia de Mensagens do Office 365 (OME)](ome.md) <br/> [Criptografia de email no Office 365](email-encryption.md) <br/> [Como o Exchange Online usa o TLS para proteger conexões de email no Office 365](exchange-online-uses-tls-to-secure-email-connections.md) <br/> |
|Chats, mensagens e arquivos em trânsito entre destinatários usando o Microsoft Teams. <br/> |O Teams usa TLS e MTLS para criptografar mensagens instantâneas. O tráfego de mídia é criptografado usando rtp seguro (SRTP). O Teams usa algoritmos compatíveis com FIPS (Federal Information Processing Standard) para trocas de chaves de criptografia. <br/> |[Criptografia para o Teams](/microsoftteams/teams-security-guide#encryption-for-teams) <br/> |
...
[Top 10 maneiras de proteger o Microsoft 365 para planos de negócios](/office365/admin/security-and-compliance/secure-your-business-data)
