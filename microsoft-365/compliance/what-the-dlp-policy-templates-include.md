...
A prevenção contra perda de dados (DLP) no Centro de Conformidade de Segurança inclui modelos de política prontos para uso que abordam requisitos comuns de conformidade, como ajudar você a proteger informações confidenciais sujeitas à Lei de Seguro de Saúde dos EUA &amp; (HIPAA), Ato Gramm-Leach-Bliley (GLBA) dos EUA ou Lei Patriot dos EUA. Este tópico lista todos os modelos de política, quais tipos de informações confidenciais eles procurarem e quais são as condições e ações padrão. Este tópico não inclui todos os detalhes de como cada modelo de política é configurado; em vez disso, o tópico apresenta informações suficientes para ajudá-lo a decidir qual modelo é o melhor ponto de partida para seu cenário. Lembre-se de que você pode personalizar esses modelos de política para atender aos seus requisitos específicos.
...
|**Nome da regra**|**Condições  <br/> (incluindo tipos de informações confidenciais)**|**Ações**|
|:-----|:-----|:-----|
|Conteúdo sensível à UE de baixo volume encontrado  <br/> | Conteúdo tem informações confidenciais:  <br/>  Número de Cartão de Débito da UE — Contagem Mín. 1, Contagem Máx. 9  <br/>  Número de carteira de motorista da UE — Contagem Mín. 1, Contagem Máx. 9  <br/>  Número de Identificação Nacional da UE — Contagem Mín. 1, Contagem Máx. 9  <br/>  Número de Passaporte da UE — Contagem Mín. 1, Contagem Máx. 9  <br/>  Número de Seguridade Social da UE (SSN) ou ID Equivalente — Contagem Mín. 1, Contagem Máx. 9  <br/>  TIN (Número de Identificação de Imposto da UE) — Contagem Mín. 1, Contagem Máx. 9  <br/>  O conteúdo é compartilhado com:  <br/>  Pessoas de fora da minha organização  <br/> |Enviar relatórios de incidentes ao Administrador  <br/> |
|Alto volume de conteúdo sensível à UE encontrado  <br/> | Conteúdo tem informações confidenciais:  <br/>  Número de Cartão de Débito da UE — Contagem Mín. 1, Contagem Máx. 9  <br/>  Número de carteira de motorista da UE — Contagem Mín. 1, Contagem Máx. 9  <br/>  Número de Identificação Nacional da UE — Contagem Mín. 1, Contagem Máx. 9  <br/>  Número de Passaporte da UE — Contagem Mín. 1, Contagem Máx. 9  <br/>  Número de Seguridade Social da UE (SSN) ou ID Equivalente — Contagem Mín. 1, Contagem Máx. 9  <br/>  TIN (Número de Identificação de Imposto da UE) — Contagem Mín. 1, Contagem Máx. 9  <br/>  O conteúdo é compartilhado com:  <br/>  Pessoas de fora da minha organização  <br/> | Restringir o acesso ao conteúdo para usuários externos  <br/>  Notificar os usuários com dicas de política e email  <br/>  Permitir substituição  <br/>  Exigir justificativa comercial  <br/>  Enviar relatórios de incidentes ao Administrador  <br/> |
...
|**Nome da regra**|**Condições  <br/> (incluindo tipos de informações confidenciais)**|**Ações**|
|:-----|:-----|:-----|
|O conteúdo corresponde à HIPAA dos EUA  <br/> | Contém qualquer uma das seguintes informações confidenciais:  <br/>  Número de Seguridade Social dos EUA (SSN) — Contagem Mín. 1, Contagem Máx. qualquer  <br/>  Número da AGÊNCIA DEA (Agência de Antidrobatório) — Contagem Mín. 1, Contagem Máx. qualquer  <br/> **AND** <br/>  O conteúdo contém qualquer um destes termos:  <br/>  Classificação Internacional de Pacientes (ICD-9-CM) — Contagem Mín. 1, Contagem Máx. qualquer  <br/>  Classificação Internacional de Pacientes (ICD-10-CM) — Contagem Mín. 1, Contagem Máx. qualquer  <br/>  O conteúdo é compartilhado com:  <br/>  Pessoas de fora da minha organização  <br/> |Enviar uma notificação  <br/> |
