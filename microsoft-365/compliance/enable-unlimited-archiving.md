...
- Depois que você ativar o arquivamento de expansão automática, ele não poderá ser desligado. Além disso, os administradores não podem ajustar a cota de armazenamento para arquivamento de expansão automática.
