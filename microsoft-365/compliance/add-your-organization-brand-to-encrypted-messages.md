...
---
# <a name="add-your-organizations-brand-to-your-microsoft-365-for-business-message-encryption-encrypted-messages"></a>Adicionar a marca da sua organização ao seu Microsoft 365 mensagens criptografadas de criptografia de mensagens para empresas
...
Depois de criar os modelos, você pode aplicá-los a emails criptografados usando Exchange de fluxo de emails. Se você tiver Criptografia de Mensagem Avançada do Office 365, poderá revogar qualquer email que tenha sido marcado usando esses modelos.
...
Se você tiver Criptografia de Mensagem Avançada do Office 365, poderá criar modelos de identidade visual personalizados para sua organização usando o cmdlet [New-OMEConfiguration.](/powershell/module/exchange/new-omeconfiguration) Depois de criar o modelo, modifique o modelo usando o cmdlet Set-OMEConfiguration conforme descrito em [Modify an OME branding template](#modify-an-ome-branding-template). Você pode criar vários modelos.
...
## <a name="create-an-exchange-mail-flow-rule-that-applies-your-custom-branding-to-encrypted-emails"></a>Criar uma Exchange de fluxo de emails que aplique sua identidade visual personalizada a emails criptografados

Depois de modificar o modelo padrão ou criar novos modelos de identidade visual, você poderá criar Exchange de fluxo de emails para aplicar sua identidade visual personalizada com base em determinadas condições. Essa regra aplicará a identidade visual personalizada nos seguintes cenários:

- Se o email foi criptografado manualmente pelo usuário final usando Outlook ou Outlook na Web, anteriormente Outlook Web App

- Se o email foi criptografado automaticamente por uma regra de fluxo de email Exchange ou política de Prevenção contra Perda de Dados

Para obter informações sobre como criar uma regra Exchange de fluxo de emails que aplique criptografia, consulte Definir regras de fluxo de emails para criptografar mensagens de [email em Office 365](define-mail-flow-rules-to-encrypt-email.md).
