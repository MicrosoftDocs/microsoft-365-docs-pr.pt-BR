...
Use um conector Globalnet no centro de conformidade do Microsoft 365 para importar e arquivar dados da plataforma de colaboração para as caixas de correio do usuário em sua organização do Microsoft 365. A Globalnet fornece um conector [Jive](https://globanet.com/jive/) configurado para capturar itens da fonte de dados de terceiros (regularmente) e, em seguida, importar esses itens para o Microsoft 365. O conector converte conteúdo como mensagens de email, chats e anexos da conta Jive de um usuário em um formato de mensagem de email e importa esses itens para a caixa de correio do usuário no Microsoft 365.

Depois que os dados Jive são armazenados em caixas de correio do usuário, você pode aplicar recursos de conformidade do Microsoft 365, como Retenção de Litígio, Descoberta Eletrônico, políticas de retenção e rótulos de retenção e conformidade de comunicação. Usar um conector Jive para importar e arquivar dados no Microsoft 365 pode ajudar sua organização a manter a conformidade com políticas governamentais e regulatórias.

## <a name="overview-of-archiving-jive-data"></a>Visão geral do arquivamento de dados Jive
...
1. Sua organização trabalha com o Jive para configurar um site Jive.
...
4. O conector importa os itens convertidos para as caixas de correio de usuários específicos usando o valor da propriedade *Email* do mapeamento automático de usuário, conforme descrito na [Etapa 3.](#step-3-map-users-and-complete-the-connector-setup) Uma nova subpasta na pasta Caixa de Entrada chamada **Jive** é criada nas caixas de correio do usuário e os itens são importados para essa pasta. O conector faz isso usando o valor da *propriedade Email.* Cada item Jive contém essa propriedade, que é preenchida com o endereço de email de cada participante do item.
...
2. Na página **Jive** product description, clique **em Add connector**.
...
Depois de criar o conector Jive, você pode exibir o status do conector no centro de conformidade do Microsoft 365.
...
2. Clique na **guia Conectores** e selecione o **conector Jive** para exibir a página do subnível. Esta página contém as propriedades e informações sobre o conector.
