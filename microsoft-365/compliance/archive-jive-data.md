...
Use um conector Veritas no centro de conformidade do Microsoft 365 para importar e arquivar dados da plataforma de colaboração para caixas de correio de usuário em sua organização do Microsoft 365. A Veritas fornece um conector [Jive](https://globanet.com/jive/) configurado para capturar itens da fonte de dados de terceiros (regularmente) e, em seguida, importar esses itens para o Microsoft 365. O conector converte conteúdo como mensagens de email, chats e anexos da conta Jive de um usuário para um formato de mensagem de email e importa esses itens para a caixa de correio do usuário no Microsoft 365.
...
3. O conector Jive que você cria no centro de conformidade do Microsoft 365 conecta-se ao site veritas Merge1 todos os dias e transfere o conteúdo para um local seguro de Armazenamento do Azure na nuvem da Microsoft.
