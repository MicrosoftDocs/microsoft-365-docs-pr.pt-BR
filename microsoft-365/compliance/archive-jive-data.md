...
Use um conector Veritas no centro de conformidade Microsoft 365 para importar e arquivar dados da plataforma de colaboração para caixas de correio de usuário em sua Microsoft 365 organização. A Veritas fornece um conector [Jive](https://globanet.com/jive/) configurado para capturar itens da fonte de dados de terceiros (regularmente) e importar esses itens para Microsoft 365. O conector converte conteúdo como mensagens de email, chats e anexos da conta Jive de um usuário para um formato de mensagem de email e importa esses itens para a caixa de correio do usuário no Microsoft 365.

Depois que os dados Jive são armazenados em caixas de correio de usuário, você pode aplicar Microsoft 365 de conformidade, como Retenção de Litígio, Descoberta Eletrônico, políticas de retenção e rótulos de retenção e conformidade de comunicação. Usar um conector Jive para importar e arquivar dados em Microsoft 365 pode ajudar sua organização a manter a conformidade com políticas governamentais e regulatórias.

## <a name="overview-of-archiving-jive-data"></a>Visão geral dos dados Jive de arquivamento

A visão geral a seguir explica o processo de uso de um conector para arquivar os dados Jive Microsoft 365.
...
2. Uma vez a cada 24 horas, os itens do Jive são copiados para o site Veritas Merge1. O conector também converte o conteúdo de itens Jive em um formato de mensagem de email.

3. O conector Jive criado no centro de conformidade do Microsoft 365 conecta-se ao site Veritas Merge1 todos os dias e transfere o conteúdo para um local seguro do Azure Armazenamento na nuvem da Microsoft.
...
A primeira etapa é acessar a página **Conectores** de Dados no centro de conformidade Microsoft 365 e criar um conector para dados Jive.
...
Depois de criar o conector Jive, você poderá exibir o status do conector no Microsoft 365 de conformidade.
