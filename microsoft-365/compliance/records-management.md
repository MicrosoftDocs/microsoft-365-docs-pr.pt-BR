...
- **Defina permissões** específicas para as funções do Gerenciador de registros em [sua organização para que](/security/office-365-security/protect-against-threats.md)ele tenha o acesso certo.
