...
- **Conteúdo do rótulo como um registro**. Crie e publique rótulos de retenção que declarem o conteúdo como um [registro](records.md) que possa ser aplicado por usuários finais ou [aplicados automaticamente](labels.md#applying-a-retention-label-automatically-based-on-conditions) identificando informações confidenciais, palavras-chave ou tipos de conteúdo.
