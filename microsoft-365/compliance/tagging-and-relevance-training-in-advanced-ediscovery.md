...
---
# <a name="tagging-and-relevance-training-in-advanced-ediscovery"></a>Treinamento de marcação e relevância na descoberta eletrônica avançada
  
Este artigo descreve o procedimento para trabalhar com o módulo de treinamento de relevância na descoberta eletrônica avançada.
...
2. Selecione um exemplo ou número de arquivo específico inserindo ou selecionando seu número nas caixas de **exemplo** ou de **arquivo** .
   ...
   - Navegue entre arquivos no exemplo atual usando as opções de barra de menu inferior. Além disso, os atalhos de teclado de navegação estão disponíveis:
     ...
     - Para ir para o primeiro arquivo do exemplo: `Shift + Ctrl + <`

     - Para ir para o arquivo anterior no exemplo: `Shift + <`

     - Para ir para o próximo arquivo no exemplo: `Shift + >`

     - Para ir para o último arquivo do exemplo: `Shift + Ctrl + >`
