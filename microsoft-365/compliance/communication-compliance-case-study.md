...
### <a name="enabling-auditing-in-office-365"></a>Habilitando a auditoria no Office 365
...
2. Selecione **Adicionar um grupo** e conclua o assistente para criar um novo grupo ou grupo de *distribuição* *do Office 365* .
