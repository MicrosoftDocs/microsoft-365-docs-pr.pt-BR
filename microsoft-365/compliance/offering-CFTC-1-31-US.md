...
---
# <a name="compliance-offering-commodity-futures-trading-commission-cftc-rule-131c-d-united-states"></a>Oferta de conformidade: CFTC (Comissão de negócios de futuro de mercadorias) 1.31 (c-d) Estados Unidos
...
- [Guia de conformidade de avaliação de riscos &](https://aka.ms/RiskGovernanceGuide): Crie um modelo de governança para avaliação de risco dos serviços de nuvem da Microsoft e notificação de regulador.
- [Casos de uso financeiro](https://docs.microsoft.com/azure/industry/financial/): visões gerais de caso de uso, tutoriais e outros recursos para criar soluções do Azure para serviços financeiros.
...
Você precisa do documento de plano de fundo para esta oferta? Baixe o [PDF](https://download.microsoft.com/download/9/A/9/9A9847FE-164A-4321-8112-50719D9EA877/CFTC1.31-Compliance.pdf).
