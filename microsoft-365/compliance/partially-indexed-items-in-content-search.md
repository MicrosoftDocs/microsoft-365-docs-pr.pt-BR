---
title: Itens parcialmente indexados em pesquisa de conteúdo e outras ferramentas de descoberta eletrônica
f1.keywords:
- NOCSH
ms.author: markjjo
author: markjjo
...
description: Saiba mais sobre itens não indexados no Exchange e no SharePoint que você pode incluir em uma pesquisa de descoberta eletrônica que você executa no centro de conformidade da Microsoft 365.
...
---
# <a name="partially-indexed-items-in-ediscovery"></a>Itens parcialmente indexados na descoberta eletrônica
...
- Arquivos que são criptografados com [tecnologias de criptografia da Microsoft](encryption.md) e são anexados a uma mensagem de email que corresponde aos critérios de uma pesquisa podem ser visualizados e serão descriptografados quando exportados. No momento, os arquivos criptografados com tecnologias de criptografia da Microsoft (e armazenados no SharePoint ou OneDrive for Business) são parcialmente indexados.
