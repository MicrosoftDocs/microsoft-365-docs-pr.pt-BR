...
3. Escolha **uma ação de correção**: agora que você analisou os detalhes da mensagem para o alerta, é possível escolher várias ações de correção:
    ...
    - **Remover mensagem no Teams (visualização)**: usando a **mensagem de remoção no controle do teams** , você pode bloquear mensagens inadequadas e conteúdo identificado em alertas de canais do Microsoft Teams e 1:1 e chats de grupo. As mensagens e o conteúdo removidos são substituídos por uma dica de política que explica que ele é bloqueado e a política que se aplica à sua remoção do modo de exibição. Os destinatários recebem um link na dica de política para saber mais sobre a política aplicável e o processo de revisão. O remetente recebe uma dica de política para a mensagem e o conteúdo bloqueados, mas pode revisar os detalhes da mensagem bloqueada e do conteúdo para contexto em relação à remoção.
