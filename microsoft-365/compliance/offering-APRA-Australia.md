...
Juntos, eles demonstram como as empresas financeiras podem mover dados e cargas de trabalho para o Microsoft Azure com a confiança de que estão em conformidade com as normas e orientações da Prudential regulamentação (autoridade regulamentar) australiana (APRA).

Para saber mais sobre os benefícios dos serviços financeiros compatíveis com o APRA no Azure, leia o [Regtech atende Fintech: perpétua e Microsoft transforme o artigo do setor financeiro](https://news.microsoft.com/en-au/features/regtech-meets-fintech-perpetual-microsoft-transform-finance-sector/) .
...
- [APRA de papel de informação envolvendo serviços de computação em nuvem](https://www.apra.gov.au/sites/default/files/information_paper_-_outsourcing_involving_cloud_computing_services.pdf)
