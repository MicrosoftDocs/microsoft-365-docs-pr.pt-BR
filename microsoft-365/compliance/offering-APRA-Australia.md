...
Este Microsoft paper fornece orientações detalhadas para os serviços financeiros com uma resposta detalhada a cada problema levantado no artigo de informações do APRA, [terceirização envolvendo serviços de computação compartilhados (incluindo nuvem)](https://www.apra.gov.au/sites/default/files/information-paper-outsourcing-involving-shared-computing-services.pdf). As diretrizes do APRA identificam três categorias de risco em que o uso normalmente cai: baixo risco, risco inerente mais elevado e impacto extremo se for interrompido — e destaque os principais problemas que as entidades regulamentadas devem considerar como parte de sua avaliação de riscos.

A resposta da Microsoft enfoca as duas categorias de risco mais alto. Embora os serviços de nuvem não sejam proibidos por qualquer categoria de risco, o APRA espera que você faça um nível proporcional maior de auditoria e espere um nível crescente de análise de APRA, à medida que você move as categorias de risco. APRA lista um intervalo de fatores que geralmente indicam alto risco de terceirização. A Microsoft aborda cada um desses fatores em profundidade, fornecendo informações e ferramentas para ajudá-lo a avaliar o risco de mover seus dados e cargas de trabalho para o Azure.

A Microsoft também aborda cada consideração de gerenciamento de risco do APRA: estratégia, governança, processo de seleção, abordagem de transição, segurança, gerenciamento contínuo, interrupção de negócios e garantia. Ponto a ponto, daremos orientações e oferecemos ferramentas para ajudá-lo a responder a cada problema durante a implantação do Azure.
...
- [Terceirização envolvendo serviços de computação compartilhados (incluindo nuvem)](https://www.apra.gov.au/sites/default/files/information-paper-outsourcing-involving-shared-computing-services.pdf)
...
- [Navegar pelo caminho para a nuvem: uma lista de verificação de conformidade para instituições financeiras na Austrália](https://aka.ms/microsoftaprachecklistjun17)
...
Você precisa do documento de plano de fundo para esta oferta? Baixe o [PDF](https://download.microsoft.com/download/2/6/0/26056353-2F4C-4A6A-AE5D-019E35EB8E2C/APRA-Compliance.pdf).
