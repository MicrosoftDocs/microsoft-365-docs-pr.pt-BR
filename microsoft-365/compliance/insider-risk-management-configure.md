...
1. Entre usando [https://protection.office.com/permissions](https://protection.office.com/permissions) credenciais para uma conta de administrador na sua organização do Microsoft 365.
...
3. Selecione o grupo de função de gerenciamento de risco interno que você deseja adicionar usuários e, em seguida, selecione **Editar grupo de função.**
...
8. Na página **fluxos do Power Automate,** configure um fluxo de modelos de fluxo de riscos insider ou crie um novo fluxo. Consulte o [artigo Guia de configurações de](insider-risk-management-settings.md#power-automate-flows-preview) gerenciamento de riscos interno para obter orientações passo a passo.
