...
7. Na página **locais de conteúdo** , escolha os locais de conteúdo que você deseja colocar em espera. Você pode colocar caixas de correio, sites e pastas públicas em espera.
   ...
   1. **Pastas públicas do Exchange.** Mova o controle de alternância de alternância ![ ](../media/scc-toggle-on.png) para a posição **All** para colocar todas as pastas públicas em sua organização do Exchange Online em espera. Você não pode escolher pastas públicas específicas para colocá-las em espera. Deixe a opção de alternância definida como **nenhuma** se você não quiser colocar uma retenção em pastas públicas.
