...
Quando uma regra é corresponder, você pode enviar um email de alerta para o responsável pela conformidade (ou qualquer pessoa escolhida) com detalhes do alerta. O email de alerta carregará um link do [Painel de Gerenciamento de Alertas DLP](dlp-configure-view-alerts-policies.md) que o responsável pela conformidade pode acessar para exibir os detalhes do alerta e eventos. O painel contém detalhes do evento que acionou o alerta junto com detalhes da política DLP combinada e o conteúdo confidencial detectado.
