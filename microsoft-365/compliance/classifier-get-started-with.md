...
Para entender mais sobre o fluxo de trabalho geral de criação de classificadores destreinados personalizados, confira [fluxo de processo para criação de classificadores estagiários do cliente](classifier-learn-about.md#process-flow-for-creating-custom-classifiers)
...
6. Preencha os valores apropriados para o `Name` e os `Description` campos da categoria de itens que você deseja que esse classificador seja identificado.
...
```
Por exemplo: `Add-ComplianceCaseMember -Case "Financial Contract Classifier" -Member johnevans@contoso.com`
