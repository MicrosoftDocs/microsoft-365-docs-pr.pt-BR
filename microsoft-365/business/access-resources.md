...
Nenhuma etapa adicional é necessária para obter acesso a recursos no local para dispositivos ingressados no Azure AD. Essa é uma funcionalidade interna disponível no Windows 10. 
