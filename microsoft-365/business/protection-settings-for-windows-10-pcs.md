---
title: Editar ou criar configurações de proteção de dispositivo para Windows 10 PCs
f1.keywords:
- NOCSH
ms.author: sharik
author: skjerland
...
## <a name="create-protection-settings-for-windows-10-devices"></a>Criar configurações de proteção para Windows 10 dispositivos
...
## <a name="edit-windows-10-protection-settings"></a>Editar Windows 10 de proteção
