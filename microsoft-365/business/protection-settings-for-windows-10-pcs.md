...
---
# <a name="edit-or-create-device-protection-settings-for-windows-10-pcs"></a>Editar ou criar configurações de proteção de dispositivo para computadores com Windows 10

Este artigo se aplica ao Microsoft 365 Business Premium.

Depois de definir as configurações padrão de proteção do Windows na página instalação, você pode adicionar novas que se aplicam a todos os usuários ou a um conjunto de usuários. Você também pode editar qualquer um dos que você criou.
...
2. No canto esquerdo da  internet, escolha Políticas \> **de** \> **Dispositivos Adicionar.**
...
1. Vá para o centro de administração do<a href="https://go.microsoft.com/fwlink/p/?linkid=837890" target="_blank">https://admin.microsoft.com</a>.     
2. No canto esquerdo da internet, escolha Políticas **de** \> **Dispositivos.**
...
Para saber mais, confira Como os recursos de proteção do [Microsoft 365 Premium mapeiam para as configurações do Intune.](map-protection-features-to-intune-settings.md) 
...
|Permitir que os usuários acessem a Cortana  <br/> |A Cortana pode ser muito útil! A Cortana pode ativar ou desativar as configurações para você, oferecer instruções e garantir que você esteja no horário para compromissos, portanto, podemos manter essa configuração **1** por padrão.  <br/> |
