...
---
# <a name="set-or-edit-application-protection-settings-for-windows-10-devices"></a>Definir ou editar configurações de proteção de aplicativos para Windows 10 dispositivos

Este artigo se aplica a Microsoft 365 Business Premium.

## <a name="edit-an-app-management-policy-for-windows-10"></a>Editar uma política de gerenciamento de aplicativos para Windows 10
...
1. Escolha uma política de aplicativo Windows existente e **edite**.
...
9. Expanda **Recuperar dados em Windows dispositivos**. Recomendamos que você a **a ligue.**
...
10. Expanda **Proteger locais** de rede e nuvem adicionais se você quiser adicionar domínios adicionais ou SharePoint locais Online para garantir que os arquivos em todos os aplicativos listados sejam protegidos. Se desejar inserir mais de um item em um campo, use um ponto e vírgula (;) entre os itens.
