...
|Não permita que os usuários copiem conteúdo de aplicativos Office aplicativos pessoais  <br/> |Quando a configuração estiver **Em**, o usuário não poderá copiar informações em um arquivo de trabalho para um arquivo pessoal. Se a configuração for **Off**, o usuário poderá copiar informações de um arquivo de trabalho para um aplicativo pessoal ou conta pessoal.  <br/> |
