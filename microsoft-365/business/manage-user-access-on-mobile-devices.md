...
|Exigir um PIN ou uma impressão digital para acessar aplicativos do Office  <br/> |Se essa configuração for **On**, os usuários devem fornecer outra forma de autenticação, além de seu nome de usuário e senha, para que possam usar aplicativos do Office em seu dispositivo móvel.  <br/> |
...
|Não permita que os usuários copiem conteúdo de aplicativos do Office em aplicativos pessoais  <br/> |Quando a configuração estiver **Em**, o usuário não poderá copiar informações em um arquivo de trabalho para um arquivo pessoal. Se a configuração for **Off**, o usuário poderá copiar informações de um arquivo de trabalho para um aplicativo pessoal ou conta pessoal.  <br/> |
