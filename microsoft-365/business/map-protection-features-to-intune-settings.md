---
title: Como os recursos de proteção no Microsoft 365 Business Premium mapeiam para configurações do Intune
f1.keywords:
- NOCSH
ms.author: sharik
author: skjerland
...
description: Saiba como os recursos de proteção Microsoft 365 Business Premium mapear para as configurações do Intune. A assinatura fornece uma licença para modificar as configurações do Intune.
...
---
# <a name="how-do-protection-features-in-microsoft-365-business-premium-map-to-intune-settings"></a>Como os recursos de proteção no Microsoft 365 Business Premium mapeiam para configurações do Intune
...
Para encontrar a configuração do Intune, entre com suas credenciais de administrador do Microsoft 365 Business Premium e vá para **Centros** de administração e, em seguida, **Intune**.
 ...
 > [!IMPORTANT]
 > 
 > Uma assinatura Microsoft 365 Business Premium oferece uma licença para modificar todas as configurações do Intune. Consulte [Introdução ao Intune para começar.](/intune/introduction-intune)
...
Para encontrar a configuração do Intune, entre com suas Microsoft 365 Business Premium de administrador e acesse o [portal do Azure.](https://portal.azure.com) Selecione **Mais serviços** e digite Intune no **Filtro**. Selecione Política de Aplicativo de Proteção de Aplicativo do **Intune.** \> 
  
 > [!IMPORTANT]
 >
 >Uma Microsoft 365 Business Premium oferece uma licença para modificar apenas as configurações do Intune que mapeiam para as configurações disponíveis no Microsoft 365 Business Premium. 
...
Para encontrar a configuração do Intune, entre com suas credenciais de administrador do Microsoft 365 Business Premium e vá para o portal do [Azure,](https://portal.azure.com)selecione Mais serviços e digite Intune no Filtro **,** selecione Perfis de configuração do dispositivo **do Intune.** \>  \>  Selecione **Política de dispositivo para Windows 10** \> **Propriedades** \> **Configurações**.
...
|Permitir que os usuários acessem a Cortana  <br/> |**Geral** \> **A Cortana** é definida para **bloquear** no Intune quando **definida** como Microsoft 365 Business Premium.  <br/> |
|Permitir que os usuários recebam anúncios e dicas sobre o Windows da Microsoft  <br/> |**Windows destaque**, todos bloqueados se isso **estiver** definido como off no Microsoft 365 Business Premium.  <br/> |
|Manter dispositivos Windows 10 atualizados automaticamente  <br/> | Essa configuração está **Microsoft Intune** Atualizações de serviço - Windows 10 Toques de Atualização, escolha Atualizar política para \> **dispositivos** Windows 10 e, em seguida, **Propriedades** \> **Configurações**.  <br/>  Quando a Microsoft 365 Business Premium configuração for definida como **On**, todas as seguintes configurações serão definidas:  <br/> **O branch** de serviço é definido como **CB** (CBB quando está desligado no Microsoft 365 Business Premium).  <br/> **Atualizações de produtos Microsoft** é definida como **Permitir**.  <br/> **Drivers do Windows** é definida como **Permitir**.  <br/> **Comportamento de atualização automática** é definida como **Instalar automaticamente no horário de manutenção** com:  <br/> **Início após o expediente** é definida como **6h**.  <br/> **Término após o expediente** é definida como **22h**.  <br/> **Período de adiamento de atualização de qualidade (dias)** é definida como **0**.  <br/> **Período de adiamento de atualização de recursos (dias)** é definida como **0**.  <br/> **Modo de download de otimização de entrega** é definida como **HTTP combinado com emparelhamento atrás do mesmo NAT**.  <br/> |
|||
