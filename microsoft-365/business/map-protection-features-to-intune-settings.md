---
title: Como os recursos de proteção do Microsoft 365 Business Premium mapeiam para as configurações do Intune
f1.keywords:
- NOCSH
ms.author: sirkkuw
author: Sirkkuw
...
description: Saiba como os recursos de proteção no Microsoft 365 Business Premium mapeiam as configurações do Intune. A assinatura fornece uma licença para modificar as configurações do Intune.
...
---
# <a name="how-do-protection-features-in-microsoft-365-business-premium-map-to-intune-settings"></a>Como os recursos de proteção do Microsoft 365 Business Premium mapeiam para as configurações do Intune
...
Para encontrar a configuração do Intune, entre com suas credenciais de administrador do Microsoft 365 Business Premium e vá para centros de administração e, em seguida, **Intune.**
 ...
 > [!IMPORTANT]
 > 
 > Uma assinatura do Microsoft 365 Business Premium oferece uma licença para modificar todas as configurações do Intune. Consulte [Introdução ao Intune para começar.](https://docs.microsoft.com/intune/introduction-intune)
  
Selecione o nome da política que &mdash; você deseja, por exemplo, Política de aplicativo para Android &mdash; e, em seguida, escolha **Configurações de política.**
...
Para encontrar a configuração do Intune, entre com suas credenciais de administrador do Microsoft 365 Business Premium e acesse o [portal do Azure.](https://portal.azure.com) Selecione **Mais serviços** e digite Intune no **Filtro.** Selecione a Política de Aplicativo de Proteção de Aplicativo do **Intune.** \> 
  
 > [!IMPORTANT]
 >
 >Uma assinatura do Microsoft 365 Business Premium oferece uma licença para modificar apenas as configurações do Intune mapeando para as configurações disponíveis no Microsoft 365 Business Premium. 
  
Para explorar as configurações disponíveis, selecione o nome da política que você deseja e escolha Geral, Atribuições **,** **Aplicativos permitidos** **,** aplicativos **isentos**, configurações necessárias ou configurações **avançadas** do painel de navegação esquerdo. 
...
Para encontrar a configuração do Intune, entre com suas credenciais de administrador do Microsoft 365 Business Premium e acesse o portal do [Azure,](https://portal.azure.com)selecione Mais serviços e digite Intune no Filtro, selecione Perfis de configuração do dispositivo do  **Intune.** \>  \>  Selecione **Política de dispositivo para Windows 10** \> **Propriedades** \> **Configurações**.
