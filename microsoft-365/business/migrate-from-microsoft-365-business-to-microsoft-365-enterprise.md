...
A migração é fácil: basta mudar de licença. Todos os dados e a configuração da sua assinatura atual são mantidos. Não há nada para se preparar para a migração e nada a fazer posteriormente, exceto aproveitar os novos recursos. 

>[!Note]
>Você também pode usar uma assinatura do Microsoft 365 Business para até 300 estações e obter uma assinatura do Microsoft 365 Enterprise E3 por mais de 300 estações. No entanto, o Office 365 ATP não está incluído no Microsoft 365 Enterprise E3. Você deve adicionar mais licenças do Office 365 ATP para os usuários em sua assinatura do Microsoft 365 Enterprise E3.
>
...
Esta tabela mostra as diferenças entre o Microsoft 365 Business e o Microsoft 365 Enterprise E3.

| Recurso   | Suporte no Microsoft 365 Business | Suporte no Microsoft 365 Enterprise E3 | 
|:-------|:-----|:-----|
| **No local**       | | | 
...
| Teams | ![Incluído no Microsoft 365 Business](./media/check-mark.png)   | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| OneDrive for Business | limite de armazenamento de 1 TB por usuário   | Ilimitado | 
| Yammer, SharePoint Online, Planner, Stream    | ![Incluído no Microsoft 365 Business](./media/check-mark.png)   | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| StaffHub  | ![Incluído no Microsoft 365 Business](./media/check-mark.png)   | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
...
| Redefinição de senha de autoatendimento para contas híbridas do Azure Active Directory (Azure AD), autenticação multifator do Azure (MFA), acesso condicional, write-back de senha para identidades locais|    ![Incluído no Microsoft 365 Business](./media/check-mark.png) | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| Descoberta do Cloud app, integridade do Azure AD Connect  |   | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| Logon único (SSO) de aplicativos do Azure AD Office 365:10 aplicativos por usuário (Galeria de aplicativos SaaS como Salesforce) * | ![Incluído no Microsoft 365 Business](./media/check-mark.png) | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| Azure AD Premium 1 SSO: sem limite (aplicativos locais por meio do proxy de aplicativo do Azure AD e aplicativos não-Galeria usando modelos de integração de aplicativos de autoatendimento)  |   | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| **Gerenciamento de dispositivos e aplicativos**     | | | 
| Microsoft Intune, piloto automático do Windows|  ![Incluído no Microsoft 365 Business](./media/check-mark.png) | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
|Acesso à área de trabalho virtual (VDA)   |  |    ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
|Área de trabalho virtual do Windows (WVD)  | ![Incluído no Microsoft 365 Business](./media/check-mark.png) |     ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
|Ativação de computador compartilhado (SCA)   | ![Incluído no Microsoft 365 Business](./media/check-mark.png) |     ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| Pacote de otimização de área de trabalho da Microsoft    | |     ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| **Proteção de informações**        | | | 
| Prevenção de perda de dados do Office 365, plano de proteção de informações do Azure 1  | ![Incluído no Microsoft 365 Business](./media/check-mark.png)   | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| Proteção de informações da janela para o Endpoint DLP    | ![Incluído no Microsoft 365 Business](./media/check-mark.png)   | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| **Licença de acesso para cliente (direitos de CAL)**    | | |   
| Enterprise CAL Suite (Exchange, SharePoint, Skype, Windows, System Center Configuration Manager, gerenciamento de direitos do Windows)| |        ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| **Conformidade**        | | | 
| Arquivamento ilimitado de email | ![Incluído no Microsoft 365 Business](./media/check-mark.png)   | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| Gerente de Conformidade    | ![Incluído no Microsoft 365 Business](./media/check-mark.png)   | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| Descoberta eletrônica    | ![Incluído no Microsoft 365 Business](./media/check-mark.png)   | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| Bloqueio in-loco e retenção de litígio | ![Incluído no Microsoft 365 Business](./media/check-mark.png)   | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
| Marcas de retenção e políticas de retenção do MRM (gerenciamento de registros de mensagens)  | ![Incluído no Microsoft 365 Business](./media/check-mark.png)   | ![Incluído no Microsoft 365 Enterprise E3](./media/check-mark.png) | 
||||
...
>[!Note]
>Após a migração para o Microsoft 365 Enterprise E3, você não mais é o Outlook Customer Manager e o MileIQ.
>
...
>[!Note]
>Após a migração para o Microsoft 365 Enterprise E3, você não tem mais o Office 365 ATP. Você pode adquirir licenças adicionais do Office 365 ATP para sua assinatura do Microsoft 365 Enterprise E3 e atribuí-las às suas contas de usuário.
>
...
O Microsoft 365 Business inclui o Windows 10 Business, que você pode instalar com o Windows AutoPilot. Quando você migra para o Microsoft 365 Enterprise E3, cada licença de usuário inclui o Windows 10 Enterprise E3, que também pode ser instalado com o Windows AutoPilot.
