...
2. Vá para **configurações** \> avançadas de **atualização de &amp; segurança** do \> **Windows Update** \> **Advanced options** e confirme se todas as configurações estão acinzentadas. 
