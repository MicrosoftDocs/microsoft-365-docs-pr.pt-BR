...
A tabela a seguir mostra qual ação os usuários/administradores finais podem precisar executar, dependendo do estado inicial, para ter uma versão bem-sucedida de clique para executar de 32 bits da implantação do Office do console de administração do Microsoft 365 para empresas.<br/>
