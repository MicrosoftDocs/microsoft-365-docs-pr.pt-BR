...
Se um usuário prefere trabalhar em um idioma diferente do inglês, ele pode solicitar que o administrador de ti local implante pacotes de idiomas adicionais em dispositivos gerenciados por meio do aplicativo portal da empresa do Intune. A partir do Windows 10, versão 1803, pacotes de idiomas são entregues como pacotes Appx da Microsoft Store. Para saber mais, confira [Microsoft Store para aplicativos de negócios](https://docs.microsoft.com/microsoft-365/managed-desktop/get-started/deploy-apps#msfb-apps).


>[!NOTE]
>O aplicativo gethelp em um dispositivo de área de trabalho gerenciada da Microsoft dá suporte apenas ao inglês. Para que os usuários obtenham ajuda com a área de trabalho gerenciada da Microsoft por meio do aplicativo gethelp, eles devem mudar o idioma de exibição para inglês.