...
Quando o dispositivo tiver sido redefinido, você poderá dá-lo a uma pessoa diferente em sua organização. Nenhum dos dados do usuário anterior ou dados corporativos estarão no dispositivo. O próximo usuário passará pelo mesmo processo que a pessoa anterior fez com um novo dispositivo de Área de Trabalho Gerenciada da Microsoft.
