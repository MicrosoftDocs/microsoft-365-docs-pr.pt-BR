...
##### [Etapas para os parceiros registrarem dispositivos](get-started/register-devices-partner.md)
#### [Registrar os dispositivos existentes por conta própria](get-started/register-reused-devices-self.md)
#### [Preparar seus usuários para usar dispositivos](get-started/get-started-devices.md)
