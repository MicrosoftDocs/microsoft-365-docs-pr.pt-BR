...
[Microsoft Defender para Ponto de Extremidade | Especialistas em ameaças](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-threat-experts) | A Área de Trabalho Gerenciada da Microsoft se integra aos dados e insights de Especialistas em Ameaças por meio de notificações de ataque direcionadas. Os clientes devem fornecer consentimento adicional antes que esse serviço seja habilitado.  
