...
Recursos incluídos e gerenciados como parte Área de Trabalho Gerenciada da Microsoft:
 ...
 |
 --- | ---
BitLocker Criptografia de Unidade | BitLocker A Criptografia de Unidade é usada para criptografar todas as unidades do sistema. Para obter mais informações, [consulte BitLocker Criptografia de Unidade](/windows/security/information-protection/bitlocker/bitlocker-overview).
