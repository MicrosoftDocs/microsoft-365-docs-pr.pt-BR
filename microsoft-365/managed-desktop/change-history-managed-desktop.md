...
[Privacidade e dados pessoais](service-description/privacy-personal-data.md) | Artigo atualizado
[Conformidade](intro/compliance.md) | Artigo atualizado
[Pré-requisitos](get-ready/prerequisites.md) | Artigo atualizado
[Configuração da rede](get-ready/network.md) | Artigo atualizado
...
[Ferramenta de avaliação de preparação](get-ready/readiness-assessment-tool.md) | Novo artigo
...
[Obter ajuda para usuários](working-with-managed-desktop/end-user-support.md) | Artigo atualizado
[Referência de configurações configuráveis - Área de Trabalho Gerenciada da Microsoft](working-with-managed-desktop/config-setting-ref.md) | Artigo atualizado
[Implantar e controlar configurações configuráveis - Área de Trabalho Gerenciada da Microsoft](working-with-managed-desktop/config-setting-deploy.md) | Artigo atualizado
...
[Novo aplicativo Microsoft Edge](get-started/edge-browser-app.md) | Artigo atualizado
[Registrar novos dispositivos sozinho](get-started/register-devices-self.md) | Artigo atualizado
...
Artigo novo ou alterado | Descrição
--- | ---
[Novo aplicativo Microsoft Edge](get-started/edge-browser-app.md) | Novo artigo
...
[Dispositivos da Área de Trabalho Gerenciada da Microsoft](service-description/device-list.md) | Artigo atualizado
[Página principal da Área de Trabalho Gerenciada da Microsoft](https://docs.microsoft.com/microsoft-365/managed-desktop/) | Artigo atualizado
[O que é a Área de Trabalho Gerenciada da Microsoft?](https://docs.microsoft.com/microsoft-365/managed-desktop/intro/index) | Artigo atualizado
[Preparar usuários para o uso dos dispositivos](get-started/get-started-devices.md) | Artigo atualizado
...
Artigo novo ou alterado | Descrição
--- | ---
[Operações e monitoramento da Área de Trabalho Gerenciada da Microsoft](service-description/operations-and-monitoring.md) | Foi adicionado o equilíbrio da tabela de responsabilidade e outras tabelas atualizadas.
