...
>[!NOTE]
>Este tópico descreve as etapas para você reutilizar dispositivos que você já tem e registrá-los Área de Trabalho Gerenciada da Microsoft. Se você estiver trabalhando com dispositivos novos, siga as etapas em Registrar novos dispositivos [Área de Trabalho Gerenciada da Microsoft você](register-devices-self.md) mesmo.
...
Área de Trabalho Gerenciada da Microsoft identifica cada dispositivo exclusivamente fazendo referência ao hash de hardware. Você tem quatro opções para obter essas informações de dispositivos que já está usando:

- Peça ao fornecedor OEM para o arquivo de registro do AutoPilot, que incluirá os hashes de hardware.
- Coletar informações em [Microsoft Endpoint Configuration Manager](#microsoft-endpoint-configuration-manager).
...
> [!IMPORTANT]
> Todos os dispositivos para os que você deseja obter essas informações devem estar executando Windows 10, versão 1703 ou posterior. 
...
3. Execute o relatório, Windows Informações do **Dispositivo autopilot** e veja os resultados.
4. No visualizador de relatório, selecione o ícone **Exportar** e escolha a opção **CSV (delimitado** por vírgula).
5. Depois de salvar o arquivo, você precisará filtrar os resultados para apenas os dispositivos que você planeja registrar com Área de Trabalho Gerenciada da Microsoft e carregar os dados para Área de Trabalho Gerenciada da Microsoft. Abra Microsoft Endpoint Manager e navegue até o menu **Dispositivos,** procure Área de Trabalho Gerenciada da Microsoft seção e selecione **Dispositivos**. Selecione **+ Registrar dispositivos**, que abre um fly-in para registrar novos dispositivos.
