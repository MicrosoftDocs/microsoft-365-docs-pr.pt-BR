...
Para tornar isso ainda mais fácil, oferecemos um guia que orienta seus usuários durante a configuração inicial e fornece recursos de ajuda tanto para a instalação quanto para uso posterior, se necessário. Você pode personalizar este guia para incluir determinados detalhes específicos da sua organização. Em seguida, distribua o guia diretamente para seus usuários juntamente com o dispositivo. Há duas versões, uma para organizações que usam o sistema de suporte da Microsoft (o aplicativo Obter Ajuda), uma para aquelas que estão fornecendo suporte alternativo para seus usuários.

## <a name="to-prepare-the-guide"></a>Para preparar o guia

1. Baixe a versão apropriada para sua organização:
- Área de Trabalho Gerenciada da Microsoft - Começar com seu dispositivo [(Obter Ajuda versão)](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/managed-desktop/get-started/downloads/microsoft-managed-desktop-user-guide-help-custom-v3.pdf) - use essa versão se os usuários usarem o sistema de suporte da Microsoft.
- [Área de Trabalho Gerenciada da Microsoft - Começar com seu](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/managed-desktop/get-started/downloads/microsoft-managed-desktop-user-guide-no-help-custom-v2.pdf) dispositivo - use essa versão se os usuários não *usarem* o sistema de suporte da Microsoft.
...
Também fornecemos uma versão mais genérica do guia para essas organizações que não precisam personalizá-la. Há duas versões, uma para organizações que usam o sistema de suporte da Microsoft (o aplicativo Obter Ajuda), uma para aquelas que estão fornecendo suporte alternativo para seus usuários. 

- Área de Trabalho Gerenciada da Microsoft - Começar com seu dispositivo [(Obter Ajuda versão -](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/managed-desktop/get-started/downloads/microsoft-managed-desktop-user-guide-help-v3.pdf) pronto para uso) - use essa versão se os usuários usarem o sistema de suporte da Microsoft.
- [Área de Trabalho Gerenciada da Microsoft - Começar](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/managed-desktop/get-started/downloads/microsoft-managed-desktop-user-guide-no-help-v2.pdf) com seu dispositivo (pronto para uso) - use  essa versão se os usuários não usarem o sistema de suporte da Microsoft.
