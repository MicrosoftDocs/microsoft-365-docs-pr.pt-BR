...
Este tópico lista as categorias de configurações que os clientes podem configurar com Área de Trabalho Gerenciada da Microsoft. Cada categoria de configuração inclui informações sobre requisitos, práticas recomendadas e como personalizar a categoria de configuração. 

## <a name="desktop-background-picture"></a>Imagem em segundo plano da área de trabalho
Você pode personalizar a imagem de plano de fundo da área de trabalho para Área de Trabalho Gerenciada da Microsoft dispositivos em sua organização. Você pode usar isso para aplicar uma marca da empresa ou material de marketing. 
...
3. No **Configurações** de trabalho, selecione **Imagem de plano de fundo da área de trabalho**. 
...
As páginas de início do navegador são abertas em guias individuais quando os usuários começam a Microsoft Edge. Se você quiser facilitar a abertura de um conjunto de sites que eles usam com frequência, adicione uma página inicial do navegador para cada site. 
...
1. Entre [no](https://endpoint.microsoft.com/) Microsoft Endpoint Manager e navegue até o menu **Dispositivos**
2. Procure a seção Área de Trabalho Gerenciada da Microsoft, selecione **Configurações**.
3. No **Configurações** de trabalho, selecione **Página inicial do navegador.** 
...
## <a name="enterprise-mode-site-list-location"></a>Enterprise local da lista de sites do modo

Se você tiver sites e aplicativos específicos que você sabe que têm problemas de compatibilidade com o Microsoft Edge, poderá usar Enterprise lista de sites do modo Enterprise para que os sites abram automaticamente usando o Internet Explorer 11. Além disso, se você sabe que seus sites de intranet não funcionarão corretamente com o Microsoft Edge, você pode definir todos os sites da intranet para abrir usando o Internet Explorer 11 automaticamente. Usar Enterprise modo significa que você pode continuar a usar o Microsoft Edge como navegador padrão, além de garantir que seus aplicativos continuem funcionando no Internet Explorer 11. Para obter mais informações sobre listas de sites do modo empresarial, [consulte Enterprise Mode e Enterprise Mode Site Lists](/internet-explorer/ie11-deploy-guide/what-is-enterprise-mode). 
...
### <a name="customize-and-deploy-enterprise-site-mode-list-location"></a>Personalizar e implantar Enterprise local da lista de modos de site

**Para adicionar um local de lista do modo de site empresarial**

1. Entre [no](https://endpoint.microsoft.com/) Microsoft Endpoint Manager e navegue até o menu **Dispositivos**
2. Procure a seção Área de Trabalho Gerenciada da Microsoft, selecione **Configurações**.
3. No **Configurações** de trabalho, selecione Enterprise local da **lista de sites do modo**. 
...
1. Entre [no](https://endpoint.microsoft.com/) Microsoft Endpoint Manager e navegue até o menu **Dispositivos**
2. Procure a seção Área de Trabalho Gerenciada da Microsoft, selecione **Configurações**.
3. No **Configurações** de trabalho, selecione **Sites confiáveis** e selecione **Adicionar site confiável**. 
...
1. Entre [no](https://endpoint.microsoft.com/) Microsoft Endpoint Manager e navegue até o menu **Dispositivos**
2. Procure a seção Área de Trabalho Gerenciada da Microsoft, selecione **Configurações**.
3. No **Configurações** de trabalho, selecione **Sites confiáveis**. 
...
Você pode gerenciar configurações de proxy de rede para sua organização. Adicione seu servidor proxy e número de porta e adicione suas exceções de site de proxy. Área de Trabalho Gerenciada da Microsoft inclui um conjunto de exceções de proxy padrão que são necessárias para o serviço operar. A lista de exclusão padrão só pode ser modificada pelo serviço Área de Trabalho Gerenciada da Microsoft padrão.  Para obter mais informações, consulte [Configuração de rede para Área de Trabalho Gerenciada da Microsoft](../get-ready/network.md). 

As exceções de site de proxy adicionadas no portal Área de Trabalho Gerenciada da Microsoft são adicionadas às exceções de proxy padrão incluídas no serviço Área de Trabalho Gerenciada da Microsoft. 
...
1. Entre [no](https://endpoint.microsoft.com/) Microsoft Endpoint Manager e navegue até o menu **Dispositivos**
2. Procure a seção Área de Trabalho Gerenciada da Microsoft, selecione **Configurações**.
3. No **Configurações** de trabalho, selecione **Proxy**. 
