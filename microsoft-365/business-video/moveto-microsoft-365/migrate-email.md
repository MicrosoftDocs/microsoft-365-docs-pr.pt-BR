...
1. No Centro de administração do **Microsoft 365**, na nav esquerda, selecione **Mostrar tudo** **,** Configurações, **Domínios** e, em seguida, **Adicionar domínio**. 
...
1. Volte para onde você foi deixado no Centro de administração do **Microsoft 365** e selecione **Continuar**. 
...
1. No nav esquerdo do Centro de administração do **Microsoft 365,** role para baixo até **Centros** de administração e selecione **Exchange**. 
1. Em **destinatários,** escolha **migração,** selecione **Novo,** Migrar para **o Exchange Online,** escolha **Migração do G Suite** **e,** em seguida, Próximo . 
