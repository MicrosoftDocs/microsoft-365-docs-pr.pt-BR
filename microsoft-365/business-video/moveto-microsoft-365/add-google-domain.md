...
---
# <a name="add-your-google-workspace-domain-to-microsoft-365"></a>Adicione seu domínio do Google Workspace ao Microsoft 365
...
1. No Centro de administração Microsoft 365, na nav esquerda, selecione **Mostrar** tudo **,** Configurações e **domínios**.
...
1. Retorne ao centro de administração Microsoft 365, selecione **Verificar** **e,** em seguida, Fechar . 
...
1. Repita esse processo para cada usuário. 
    ...
    Quando terminar, você estará pronto para instalar Office aplicativos e migrar seus itens de email e calendário para Microsoft 365. 