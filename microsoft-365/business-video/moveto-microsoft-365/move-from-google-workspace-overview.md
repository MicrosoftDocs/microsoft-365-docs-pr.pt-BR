...
|Etapa 8|Use [o Mover para mover os dados de todos da](mover-migrate-files.md) Unidade para o OneDrive e de unidades compartilhadas para sites de equipe.</br> Nesta etapa, todos os dados em Unidades pessoais e compartilhadas são copiados e movidos para o Microsoft 365.|
|Etapa 9| [Interrompa o Google Workspace,](cancel-google.md) mas mantenha seu domínio. </br> Se o Google gerenciar seu domínio, você poderá mantê-lo lá mesmo depois de interromper sua assinatura do Google Workspace. Você também pode optar por movê-lo para outro host DNS, se quiser.|
|||
