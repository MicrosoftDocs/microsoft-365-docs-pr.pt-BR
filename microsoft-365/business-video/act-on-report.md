...
---
# <a name="review-usage-reports-in-microsoft-365"></a>Analisar relatórios de uso em Microsoft 365

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE1SOFC?autoplay=false]

Descubra como os funcionários estão usando Microsoft 365 serviços como email ou OneDrive e tome medidas.
...
1. Como exemplo, vamos em frente e ver o relatório de OneDrive. Aqui podemos ver quantas pessoas têm uma conta, você também pode exibir o número de arquivos totais e ativos, bem como o armazenamento usado. Para ver todos os outros relatórios, vá para o menu suspenso.
1. Aqui podemos dar uma olhada no relatório de uso do aplicativo de email e ver quais métodos seus funcionários usam mais para acessar seus emails. Você também pode exibir informações específicas de um indivíduo, mas os detalhes são ocultos por padrão. Para mostrar os detalhes individuais do usuário, vá para **o** Configurações e, em seguida, serviços & **os complementos**.
