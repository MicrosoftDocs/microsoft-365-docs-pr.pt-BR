...
---
# <a name="reset-passwords-for-your-users"></a>Redefinir senhas para seus usuários
...
1. Você verá seu endereço de email na **caixa Email da nova senha para os destinatários a** seguir. Adicione o endereço de email alternativo do usuário ou qualquer endereço que você escolher.
1. Escolha **Enviar email e fechar**.

    O usuário receberá um email com as instruções de redefinição de senha.