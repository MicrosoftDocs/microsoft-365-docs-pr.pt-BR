...
1. Na janela **Enviar Link,** insira o endereço de email do cliente, digite uma mensagem e escolha **Enviar**.
    ...
    Seu cliente receberá um email com um código de verificação, que ele precisará enviar para si mesmo para acessar sua pasta. Se eles não puderem encontrar o email, eles devem verificar a pasta Spam.
