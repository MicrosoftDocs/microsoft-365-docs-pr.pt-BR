...
1. Selecione **Recarga automática para** comprar créditos de comunicação, se necessário, e evite interrupções de serviço.
    ...
    Os créditos de comunicação são usados para chamadas internacionais, números de chamada gratuita e minutos de chamada adicionais.
1. Selecione **Avançar**.
1. Verifique o método Payment.
1. Selecione **Colocar ordem** e **Continuar**.

Você adicionou com êxito o complemento do Business Voice.