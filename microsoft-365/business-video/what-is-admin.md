...
1. Des limpar a caixa de seleção Usuário **(sem acesso** ao administrador) e selecione uma das funções de administrador. Para saber mais sobre uma função, passe o mouse sobre o ponto de exclamação (!) e leia a dica da ferramenta. Para dar ao usuário a mesma função que a sua, selecione **Administrador global**.
