...
Obtém ou atualiza informações sobre um modelo de compreensão de documento Microsoft Office SharePoint Online Syntex usando o título do modelo (consulte o [exemplo](rest-getbytitle-method.md#examples)).
...
Para GET, não é necessário nenhum corpo da solicitação.
...
### <a name="get-information-about-the-contoso-contract-model"></a>Obter informações sobre o modelo de Contrato da Contoso

Neste exemplo, o nome do modelo de compreensão de documento Syntex é `Contoso Contract`.
...
### <a name="get-and-delete-the-contoso-contract-model-by-name"></a>Obter e excluir o modelo de Contrato da Contoso por nome

Neste exemplo, o nome do modelo de compreensão de documento do Contrato da Contoso é `Contoso Contract`.
