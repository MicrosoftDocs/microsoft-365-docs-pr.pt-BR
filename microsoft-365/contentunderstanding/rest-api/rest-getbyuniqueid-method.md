...
Obtém ou atualiza informações sobre um modelo de compreensão de documento do Microsoft Office SharePoint Online Syntex (consulte o [exemplo](rest-getbyuniqueid-method.md#examples)).
...
|-----|---|--------|----|-----------|
|modelUniqueId|consulta|True|string|ID do arquivo do modelo Syntex.|
...
### <a name="get-the-contoso-contract-model-by-id"></a>Obter o modelo de Contrato da Contoso por ID
...
```
### <a name="get-and-delete-the-contoso-contract-model-by-id"></a>Obter e excluir o modelo de Contrato da Contoso por ID
