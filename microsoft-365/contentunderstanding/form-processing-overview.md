...
> [!NOTE]
> Confira [Adoção do SharePoint Syntex: guia de introdução](./adoption-getstarted.md#form-processing-scenario-example) para saber mais sobre os exemplos de cenários de processamento de formulário.
...
Um administrador do Office 365 precisa [habilitar o processamento de formulário](./set-up-content-understanding.md#to-set-up-content-understanding) da biblioteca de documentos do SharePoint para que os usuários possam [criar um modelo de processamento de formulário](create-a-form-processing-model.md) nele. Você pode selecionar os sites durante a instalação ou após a instalação das suas configurações de gerenciamento.
