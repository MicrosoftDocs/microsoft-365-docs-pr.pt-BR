...
Você pode acessar relatórios do repositório de termos no Centro de administração do SharePoint. Este recurso requer uma licença [SharePoint Syntex](index.md).

Expanda **Relatórios** e, em seguida, clique em **Serviços de conteúdo**.
