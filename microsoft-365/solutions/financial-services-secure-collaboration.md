...
***O Teams, juntamente com o abrangente conjunto de ofertas de segurança e conformidade do Microsoft 365, fornece um canal de comunicação corporativa digital para instituições de serviços financeiros realizarem negócios de maneira eficaz e cumprirem os regulamentos.*** O restante deste artigo descreve como os recursos internos do Microsoft 365 para gerenciamento de registros, proteção de informações, barreiras de informações e controle de supervisão fornecem o Teams um conjunto de ferramentas robusto para ajudar a cumprir essas obrigações regulatórias.
