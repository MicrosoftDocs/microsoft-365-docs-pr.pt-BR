...
Você pode desabilitar o compartilhamento de convidados para um Microsoft OneDrive individual clicando no usuário no Centro de administração do Microsoft 365 e selecionando **Gerenciar compartilhamento externo** na guia **Microsoft OneDrive**.
...
O Microsoft Office SharePoint Online fornece integração direta com o acesso condicional do Microsoft Azure Active Directory para o local de rede e os dispositivos não gerenciados. Veja as seguintes referências para detalhes:
