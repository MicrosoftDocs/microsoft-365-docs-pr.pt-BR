...
Se você tiver mais de uma assinatura, peça aos usuários com uma licença para uma assinatura, mas quiser movê-las para outra assinatura, poderá substituir a licença existente por outra.
...
5. Alterne o botão de alternância para a posição **ativado** das licenças que você deseja atribuir a esses usuários.
...
[Comprar outra assinatura do Microsoft 365 for Business](../buy-another-subscription.md) (artigo)