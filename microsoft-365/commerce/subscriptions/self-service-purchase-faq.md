...
Agora as compras de autoatendimento estão disponíveis para a plataforma de alimentação em vários países e regiões.
...
Os compradores de autoatendimento podem gerenciar suas compras no modo de exibição limitado do <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">centro de administração do Microsoft 365</a>. Os compradores podem sempre acessar o centro de administração do bloco de **Administração** no inicializador de aplicativos incorporado a todos os aplicativos do Microsoft 365 e do Dynamics online. Eles podem exibir as compras feitas, comprar assinaturas adicionais para o mesmo serviço e atribuir licenças para essas assinaturas a outros usuários em sua organização. Além disso, os compradores podem exibir e pagar suas faturas, atualizar a forma de pagamento e cancelar sua assinatura.
...
Os administradores globais e de cobrança podem ver as assinaturas compradas por meio de compras de autoatendimento na **cobrança**  >  **de seus produtos** no <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">centro de administração do Microsoft 365</a> junto com todas as outras assinaturas adquiridas por meio da aquisição central. Eles podem filtrar a lista apenas com as assinaturas adquiridas por meio da aquisição central ou incluir assinaturas compradas por meio de compras de autoatendimento.
