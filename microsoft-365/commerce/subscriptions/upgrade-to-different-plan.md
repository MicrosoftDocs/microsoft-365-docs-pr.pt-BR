...
Se a **guia** Atualização estiver vazia, você verá uma explicação do motivo pelo qual não pode atualizar no momento. Você pode tentar alterar [os planos manualmente](change-plans-manually.md). Para obter mais informações, consulte [Por que não posso atualizar planos?](#why-cant-i-upgrade-plans).
...
Se você quiser atualizar apenas alguns usuários para um plano diferente, mas precisar comprar a nova assinatura primeiro, consulte [Alterar planos manualmente](change-plans-manually.md). Se você já tiver a assinatura para a que deseja atualizar os usuários, consulte [Mover usuários para uma assinatura diferente.](move-users-different-subscription.md)
...
**Verificações de crédito ao alterar planos:** Se você pagar por fatura ou atingir um determinado nível de custo, uma verificação de crédito pode ser necessária. Uma verificação de crédito pode levar até dois dias úteis. Os usuários terão acesso total ao plano atual até que você os mova para o novo. Você receberá uma notificação se uma verificação de crédito for necessária.

## <a name="why-cant-i-upgrade-plans"></a>Por que não posso atualizar planos?

Se você não vir nenhum plano na guia **Atualização,** isso significa que seu plano não pode ser atualizado automaticamente. Em alguns casos, você pode ser capaz de resolver o problema para que você possa exibir planos disponíveis para atualização, ou pode ser capaz de atualizar ou alterar planos manualmente, em vez disso.
...
Você pode não ver nenhum plano na guia **Atualização** porque o serviço está em processo de atualização de um alto volume de planos. Tente novamente depois de cerca de uma hora após sua primeira tentativa.
...
Quando você atualiza os planos automaticamente  usando o botão **Mudar** planos (ou a guia Atualização no novo centro de administração), seus serviços e cobrança são afetados.
...
No dia em que a atualização do plano for concluída, a cobrança em sua assinatura antiga será desligada e a cobrança em sua nova assinatura será 2016. Você obterá um crédito prorrado para qualquer serviço nãousado na assinatura antiga. Você receberá uma nova fatura que inclui o crédito da sua assinatura antiga dentro de 30 dias após a atualização para a nova assinatura.
