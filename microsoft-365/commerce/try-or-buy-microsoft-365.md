...
Você é um novo cliente e ainda não tem uma conta com a Microsoft? Use estas etapas para criar uma conta e inscrever-se para uma assinatura de avaliação gratuita do Microsoft 365 Business Standard, Do Microsoft 365 Business Premium ou do Microsoft 365 Apps para empresas.

1. Vá para o <a href="https://www.aka.ms/office365signup" target="_blank">site produtos do Microsoft 365</a>.
2. Selecione o plano para o que você deseja se inscrever, como **o Microsoft 365 Business Standard,** role para baixo a página e selecione Experimentar gratuitamente **por 1 mês**.
...
5. Na próxima página, verifique a assinatura e selecione **Checkout**.
6. Na próxima página, verifique o **endereço Vendido para,** o **Cobrado para** informações e Itens **nesta ordem**. Se precisar fazer alterações, selecione **Alterar** ao lado da seção aplicável.
7. Quando \' terminar, selecione **Aceitar contrato & ordem de colocação**.

## <a name="extend-your-trial"></a>Prorrogar a avaliação

Você precisa de mais tempo para experimentar os recursos do Microsoft 365 para empresas antes de comprar? Se sua assinatura de avaliação só tiver mais 15 dias até expirar e a avaliação não tiver sido estendida até então, você pode estender sua avaliação por mais 30 dias. Isso pode ser feito apenas uma vez.
...
3. Na página detalhes da assinatura, na seção **Assinaturas e configurações de** pagamento, selecione **Estender data de término**.
...
Quando estiver pronto para comprar, consulte [Comprar sua versão de avaliação.](#buy-a-subscription-from-your-free-trial)
...
Se você já tiver uma assinatura do Microsoft 365 para empresas, poderá usar o Centro de administração do Microsoft 365 para tentar uma assinatura diferente.
...
2. Na página **Serviços de** Compra, você vê os planos que estão disponíveis para sua organização. Escolha o plano do Microsoft 365 que você deseja experimentar.
3. Na próxima página, selecione **Obter avaliação gratuita**. A avaliação fornece 25 licenças de usuário para um período de um mês.
4. Escolha receber um texto ou uma chamada, insira seu número de telefone e, em seguida, escolha **Text me** ou **Call me**.
5. Insira o código de verificação e selecione **Iniciar sua avaliação gratuita**.
6. Na página **Check-out,** selecione **Tentar agora**.
7. Na página **recebimento do pedido,** selecione **Continuar**.

## <a name="buy-a-different-subscription"></a>Comprar uma assinatura diferente

Se você já tiver uma assinatura do Microsoft 365 para empresas, poderá passar pelo Centro de administração do Microsoft 365 para comprar uma assinatura diferente para sua organização.
...
1. No centro de administração, vá para a página **Serviços de** Compra \> <a href="https://go.microsoft.com/fwlink/p/?linkid=868433" target="_blank">de</a> Cobrança.
2. Na página **Comprar serviços,** selecione o plano que você deseja comprar, selecione **Detalhes**, em seguida, selecione **Comprar**.
3. Insira o número de licenças de que você precisa e escolha se deve pagar por mês ou por todo o ano. Escolha se deseja atribuir licenças automaticamente a todos os que não têm uma licença no momento. Em **seguida, selecione Check-out now**.
4. Revise as informações de preços e selecione **Next**.
5. Forneça suas informações de pagamento e selecione **Local order** Go to \> **Admin Home**.
...
Se você tiver uma nova conta e estiver configurando sua primeira assinatura, poderá usar os artigos de instalação guiada para ajudá-lo a começar.
...
[Comprar ou editar um complemento para o Microsoft 365 for business](buy-or-edit-an-add-on.md) (artigo)\
