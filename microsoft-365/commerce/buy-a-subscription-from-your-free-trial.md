...
ms.topic: article
keywords:
- avaliação, avaliação, compra, compra
...
4. Na próxima página, verifique a assinatura e selecione **checkout**.

5. Na próxima página, verifique o endereço **vendido para** , as informações **cobradas** e os **itens nesta ordem**. Se você precisar fazer alterações, selecione **alterar** ao lado da seção aplicável.

6. Quando tiver terminado, selecione **aceitar contrato & ordem de local**.
...
2. Na página **Assinaturas**, selecione o botão **Comprar agora** referente à assinatura de avaliação que você deseja comprar.

3. Revise as informações de preços e selecione **Avançar**.

4. Forneça suas informações de pagamento e, em seguida, selecione **fazer pedido**.

5. Na página confirmação, selecione **ir para a home page do administrador**.
...
3. Insira o número de licenças necessárias e escolha se deseja pagar a cada mês ou pelo ano inteiro. Escolha se você deseja atribuir licenças automaticamente a todos que não têm licença no momento. Em seguida, selecione **fazer check-out agora**.

4. O carrinho é exibido. Se o carrinho desaparecer da tela, selecione **carrinho** para reabri-lo, examine a ordem e selecione **check-out**.

5. Revise as informações de preços e selecione **Avançar**.

6. Forneça suas informações de pagamento e, em seguida, selecione **fazer pedido** \> **ir para a página inicial do administrador**.
...
2. Na página **assinatura** , selecione **adicionar assinaturas**.
    ...
    Você verá as assinaturas disponíveis para sua organização. Todas as assinaturas que você já comprou serão identificadas como **em avaliação** ou **compradas**.
  
3. Encontre a assinatura que você deseja comprar e selecione **comprar agora**.
...
5. O carrinho é exibido. Se o carrinho desaparecer da tela, selecione **carrinho** para reabri-lo, examine a ordem e selecione **check-out**.

6. Revise as informações de preços e selecione **Avançar**.

7. Forneça suas informações de pagamento e, em seguida, selecione **fazer pedido**.
