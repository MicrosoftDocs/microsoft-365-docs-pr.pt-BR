...
Ao comprar uma assinatura do Microsoft 365 para empresas, inscreva-se em um conjunto de aplicativos e serviços que você paga mensalmente ou anualmente. Os aplicativos e serviços que você recebe como parte da sua assinatura dependem de qual produto você comprou, como o Microsoft 365 Apps for business ou o Microsoft 365 Business Standard. Você pode ver o que vem com cada produto na [página do Microsoft 365 para pequenas e médias](https://products.office.com/compare-all-microsoft-office-products?&activetab=tab:primaryr1) empresas.
...
|:-----|:-----|
|Exchange Online  <br/> |Uma caixa de correio será criada para tal pessoa. <br/> Para saber mais sobre o SLA para que essa tarefa seja concluída, consulte ["Configurando..." mensagens no centro de administração do Microsoft 365](https://support.microsoft.com/help/2635238/setting-up-messages-in-the-office-365-admin-center). |
...
- [Caixas de correio compartilhadas no Exchange Online](/exchange/collaboration-exo/shared-mailboxes) para todos os outros planos do Microsoft 365.
