...
Durante o processo de compra de check-out, quando você chegar à **etapa 4. Pagamento e cobrança**, selecione a caixa para inserir um RFC. Esta etapa é necessária para que você possa vê-la refletida na fatura de compra.
...
A Microsoft Corporation, como residente fiscal nos Estados Unidos da América, só é capaz de emitir faturas sob as leis de jurisdição e não é obrigada a fornecer uma fatura eletrônica CFDI.

## <a name="5-is-the-invoice-i-receive-valid-for-my-accounting-operations-in-mexico"></a>5. A fatura que recebo é válida para minhas operações de contabilidade no México?

Uma fatura gerada por entidades estrangeiras (nesse caso, a Microsoft Corporation) que inclui a respectiva RFC é válida para fins fiscais no México. (Recomendamos consultar seu contador para obter mais informações).
