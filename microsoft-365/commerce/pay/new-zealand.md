...
---
# <a name="payment-information-for-new-zealand"></a>Informações de pagamento para a Nova Zelândia
...
**Por favor, pague em NZD e os números de fatura de referência em sua remessa de pagamento.**

Se você tiver uma fatura cobrada pela **MICROSOFT REGIONAL SALES PTE LTD,** use essas informações bancárias:

Banco: Citibank\
Código do Banco: 31\
Código de Filial: 2840\
Código SWIFT: CITINZ2X\
Sufixo (3 dígitos): 004\
Sufixo (2 dígitos): 04\
Número da conta: 0026181\
Nome da conta: MICROSOFT

Se você tiver uma fatura cobrada pelo **Microsoft New Zealand Limited** para pedidos e consumo a partir de 1º de março de 2021, use essas informações bancárias:

Banco: Citibank, N.A. Filial da Nova Zelândia\
Código SWIFT: CTINZ2X\
BSB: 312825\
Número da conta: 0008655083\
Nome da conta: MICROSOFT