...
[Microsoft Endpoint Manager](/mem/endpoint-manager-overview) é uma plataforma de solução que unifica vários serviços. Ele inclui [Microsoft Intune](/mem/intune/fundamentals/what-is-intune) para gerenciamento de dispositivos baseados em nuvem.
...
- Etapa 2: Configurar o Defender para recursos de ponto de extremidade usando Microsoft Endpoint Manager

Essas diretrizes de integração orientarão você pelas seguintes etapas básicas que você precisa seguir ao usar Microsoft Endpoint Manager:

-   [Identificar dispositivos de destino ou usuários](#identify-target-devices-or-users)

    -   Criando um Azure Active Directory (Usuário ou Dispositivo)
...
-   [Criando um Perfil de Configuração](#step-2-create-configuration-policies-to-configure-microsoft-defender-for-endpoint-capabilities)
    ...
    -   Em Microsoft Endpoint Manager, vamos orientá-lo na criação de uma política separada para cada recurso.
...
-   [Linhas de base de segurança do Intune](/mem/intune/protect/security-baseline-settings-defender-atp#microsoft-defender)

Para obter mais informações Microsoft Endpoint Manager, confira estes recursos:
- [Microsoft Endpoint Manager página](/mem/)
...
>[!NOTE]
>O Intune usa Azure Active Directory grupos (Azure AD) para gerenciar dispositivos e usuários. Como administrador do Intune, você pode configurar grupos para atender às suas necessidades organizacionais.<br>
Para obter mais informações, [consulte Adicionar grupos para organizar usuários e dispositivos](/mem/intune/fundamentals/groups-add).
...
2.  Abra **Grupos > Novo Grupo**.
    ...
    > ![Imagem do Microsoft Endpoint Manager portal1](images/66f724598d9c3319cba27f79dd4617a4.png)

3.  Insira detalhes e crie um novo grupo.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal2](images/b1e0206d675ad07db218b63cd9b9abc3.png)
...
7.  Encontre seu usuário de teste ou dispositivo e selecione-o.
    ...
    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal3](images/149cbfdf221cdbde8159d0ab72644cd0.png)
...
2.  Navegue **até Endpoint security > Endpoint detection and response**. Clique em **Criar Perfil**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal4](images/58dcd48811147feb4ddc17212b7fe840.png)
...
4.  Insira um nome e uma descrição e selecione  **Next**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal5](images/a5b2d23bdd50b160fef4afd25dda28d4.png)

5.  Selecione configurações conforme necessário e selecione  **Próximo**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal6](images/cea7e288b5d42a9baf1aef0754ade910.png)

    > [!NOTE]
    > Nesse caso, isso foi preenchido automaticamente, pois o Defender para Ponto de Extremidade já foi integrado ao Intune. Para obter mais informações sobre a integração, consulte [Enable Microsoft Defender for Endpoint in Intune](/mem/intune/protect/advanced-threat-protection-configure#to-enable-microsoft-defender-atp).
    > 
...
6.  Adicione marcas de escopo, se necessário, em seguida, selecione  **Next**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal8](images/ef844f52ec2c0d737ce793f68b5e8408.png)

7.  Adicione grupo de teste clicando em **Selecionar grupos para incluir** e escolher seu grupo e selecione  **Próximo**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal9](images/fc3525e20752da026ec9f46ab4fec64f.png)

8.  Revise e aceite e selecione  **Criar**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal10](images/289172dbd7bd34d55d24810d9d4d8158.png)

9.  Você pode exibir sua política concluída.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal11](images/5a568b6878be8243ea2b9d82d41ed297.png)
...
2.  Navegue **até Endpoint security > Antivírus > Criar Política**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal12](images/6b728d6e0d71108d768e368b416ff8ba.png)
...
4.  Insira o nome e a descrição e selecione  **Next**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal13](images/a7d738dd4509d65407b7d12beaa3e917.png)

5.  Na página **Configuração configurações**: de definir as configurações necessárias para Microsoft Defender Antivírus (Proteção na Nuvem, Exclusões, Real-Time Proteção e Correção).

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal14](images/3840b1576d6f79a1d72eb14760ef5e8c.png)

6.  Adicione marcas de escopo, se necessário, em seguida, selecione  **Next**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal15](images/2055e4f9b9141525c0eb681e7ba19381.png)

7.  Selecione grupos para incluir, atribua ao grupo de teste e selecione  **Próximo**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal16](images/48318a51adee06bff3908e8ad4944dc9.png)

8.  Revise e crie e selecione  **Criar**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal17](images/dfdadab79112d61bd3693d957084b0ec.png)

9.  Você verá a política de configuração criada.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal18](images/38180219e632d6e4ec7bd25a46398da8.png)
...
4.  Selecione Plataforma - Windows 10 e Posterior - Perfil - Regras de **redução de superfície de ataque > Criar**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal19](images/522d9bb4288dc9c1a957392b51384fdd.png)

5.  Insira um nome e uma descrição e selecione  **Next**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal20](images/a5a71fd73ec389f3cdce6d1a6bd1ff31.png)
...
6.  Na página **Configuração de configuração:** de definir as configurações necessárias para regras de redução de superfície de ataque e selecione  **Próximo**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal21](images/dd0c00efe615a64a4a368f54257777d0.png)

7.  Adicione Marcas de Escopo conforme necessário e selecione  **Next**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal22](images/6daa8d347c98fe94a0d9c22797ff6f28.png)

8.  Selecione grupos para incluir e atribuir ao grupo de teste e selecione  **Próximo**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal23](images/45cefc8e4e474321b4d47b4626346597.png)

9. Revise os detalhes e selecione  **Criar**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal24](images/2c2e87c5fedc87eba17be0cdeffdb17f.png)

10. Exibir a política.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal25](images/7a631d17cc42500dacad4e995823ffef.png)
...
4.  Selecione **Windows 10 e Posterior – Proteção da Web > Criar**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal26](images/cd7b5a1cbc16cc05f878cdc99ba4c27f.png)

5.  Insira um nome e uma descrição e selecione  **Next**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal27](images/5be573a60cd4fa56a86a6668b62dd808.png)
...
6.  Na página **Configuração configurações:** de definir as configurações necessárias para a Proteção da Web e selecione  **Próximo**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal28](images/6104aa33a56fab750cf30ecabef9f5b6.png)

7.  Adicione **marcas de escopo conforme necessário > Next**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal29](images/6daa8d347c98fe94a0d9c22797ff6f28.png)

8.  Selecione **Atribuir ao grupo de teste > Próximo**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal30](images/45cefc8e4e474321b4d47b4626346597.png)

9.  Selecione **Revisar e Criar > Criar**.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal31](images/8ee0405f1a96c23d2eb6f737f11c1ae5.png)

10. Exibir a política.

    > [!div class="mx-imgBorder"]
    > ![Imagem do Microsoft Endpoint Manager portal32](images/e74f6f6c150d017a286e6ed3dffb7757.png)
...
Para obter informações sobre o tempo, consulte [Informações de configuração do Intune.](/mem/intune/configuration/device-profile-troubleshoot#how-long-does-it-take-for-devices-to-get-a-policy-profile-or-app-after-they-are-assigned)
...
1.  Abra o portal do MEM e navegue até a política relevante, conforme mostrado nas etapas acima. O exemplo a seguir mostra as configurações de proteção de próxima geração.
    ...
    > [!div class="mx-imgBorder"]
    > [![Imagem do Microsoft Endpoint Manager portal33 ](images/43ab6aa74471ee2977e154a4a5ef2d39.png)](images/43ab6aa74471ee2977e154a4a5ef2d39.png#lightbox)

2.  Selecione a **Política de Configuração** para exibir o status da política.

    > [!div class="mx-imgBorder"]
    > [![Imagem do Microsoft Endpoint Manager portal34 ](images/55ecaca0e4a022f0e29d45aeed724e6c.png)](images/55ecaca0e4a022f0e29d45aeed724e6c.png#lightbox)

3.  Selecione  **Status do Dispositivo** para ver o status.

    > [!div class="mx-imgBorder"]
    > [![Imagem do Microsoft Endpoint Manager portal35 ](images/18a50df62cc38749000dbfb48e9a4c9b.png)](images/18a50df62cc38749000dbfb48e9a4c9b.png#lightbox)

4.  Selecione  **Status do Usuário** para ver o status.

    > [!div class="mx-imgBorder"]
    > [![Imagem do Microsoft Endpoint Manager portal36 ](images/4e965749ff71178af8873bc91f9fe525.png)](images/4e965749ff71178af8873bc91f9fe525.png#lightbox)
...
5.  Selecione  **Status por configuração** para ver o status.
    ...
    > [!div class="mx-imgBorder"]
    > [![Imagem do Microsoft Endpoint Manager portal37 ](images/42acc69d0128ed09804010bdbdf0a43c.png)](images/42acc69d0128ed09804010bdbdf0a43c.png#lightbox)

### <a name="endpoint-detection-and-response"></a>Detecção de ponto de extremidade e resposta


1.  Antes de aplicar a configuração, o serviço Defender para Endpoint Protection não deve ser iniciado.
...
2.  Depois que a configuração for aplicada, o Defender for Endpoint Protection Service deve ser iniciado.
...
3.  Depois que os serviços são executados no dispositivo, o dispositivo aparece Central de Segurança do Microsoft Defender.

    > [!div class="mx-imgBorder"]
    > [![Imagem de Central de Segurança do Microsoft Defender ](images/df0c64001b9219cfbd10f8f81a273190.png)](images/df0c64001b9219cfbd10f8f81a273190.png#lightbox)
...
3.  Depois de aplicar a política em um dispositivo de teste, abra um powershell Windows e digite `Get-MpPreference` .
...
1.  No dispositivo de teste, abra um powershell Windows e digite `(Get-MpPreference).EnableNetworkProtection` .
...
3.  Depois de aplicar a política, abra um powershell Windows e digite `(Get-MpPreference).EnableNetworkProtection` .
