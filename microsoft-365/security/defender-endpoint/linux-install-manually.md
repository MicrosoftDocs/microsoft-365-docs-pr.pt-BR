...
- Observe sua distribuição e versão e identifique a entrada mais próxima (por principal, então secundária) para ela em `https://packages.microsoft.com/config/` . Por exemplo, o RHEL 7.9 está mais próximo de 7,4 do que 8.
    ...
    Por exemplo, se você estiver executando o CentOS 7 e quiser implantar o MDE para Linux a partir *do canal prod:*
...
Como alternativa, você pode usar um script de bash do [instalador automatizado](https://github.com/microsoft/mdatp-xplat/blob/master/linux/installation/mde_installer.sh) fornecido em nosso [repositório público do GitHub.](https://github.com/microsoft/mdatp-xplat/)
