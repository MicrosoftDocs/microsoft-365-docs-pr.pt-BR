...
Para obter informações gerais sobre funções de administrador, consulte [Sobre funções de administrador](/microsoft-365/admin/add-users/about-admin-roles).
...
## <a name="open-a-service-request"></a>Abrir uma solicitação de serviço
