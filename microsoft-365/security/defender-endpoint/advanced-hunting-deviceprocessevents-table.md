...
A `DeviceProcessEvents` tabela no esquema de busca [avançado](advanced-hunting-overview.md) contém informações sobre a criação de processos e eventos relacionados. Use esta referência para criar consultas quer retiram informações desta tabela.
