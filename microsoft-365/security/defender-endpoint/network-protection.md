...
A proteção de rede é suportada Windows, começando com Windows 10 versão 1709. A proteção de rede ainda não é suportada em outros sistemas operacionais, mas a proteção da Web é suportada usando o novo Microsoft Edge com base no Chromium. Para saber mais, confira [Proteção da Web](web-protection-overview.md).
...
A proteção de rede requer Windows 10 Pro ou Enterprise e Microsoft Defender Antivírus proteção em tempo real.

| Versão do Windows | Microsoft Defender Antivírus |
|:---|:---|
| Windows 10 versão 1709 ou posterior <p>Windows Servidor 1803 ou posterior | [Microsoft Defender Antivírus proteção em tempo real](configure-real-time-protection-microsoft-defender-antivirus.md) e proteção entregue na [nuvem](enable-cloud-protection-microsoft-defender-antivirus.md) devem ser habilitadas |
...
Você pode revisar o log Windows de eventos para ver eventos criados quando a proteção de rede bloqueia (ou audita) o acesso a um IP ou domínio mal-intencionado:
...
## <a name="considerations-for-windows-virtual-desktop-running-windows-10-enterprise-multi-session"></a>Considerações sobre Windows área de trabalho virtual executando Windows 10 Enterprise Multi-Session

Devido à natureza multiusuária da Windows 10 Enterprise, lembre-se dos seguintes pontos:
...
3. Se você precisar diferenciar entre grupos de usuários, considere criar pools e atribuições separados Windows host da Área de Trabalho Virtual.
...
Para Windows 10 Enterprise Multi-Session 1909 e para cima, usada na área de trabalho virtual Windows no Azure, a proteção de rede para Microsoft Edge pode ser habilitada usando o seguinte método:
