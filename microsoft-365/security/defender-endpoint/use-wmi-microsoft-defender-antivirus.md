...
---
# <a name="use-windows-management-instrumentation-wmi-to-configure-and-manage-microsoft-defender-antivirus"></a>Use Windows WMI (Instrumentação de Gerenciamento) para configurar e gerenciar Microsoft Defender Antivírus
...
Windows Instrumentação de Gerenciamento (WMI) é uma interface de script que permite recuperar, modificar e atualizar configurações.
...
A biblioteca de referência do [provedor WMIv2 Windows Defender MSDN](/previous-versions/windows/desktop/defender/windows-defender-wmiv2-apis-portal) lista as classes WMI disponíveis para Microsoft Defender Antivírus e inclui scripts de exemplo.
