...
## <a name="select-networks-to-monitor"></a><span data-ttu-id="a10c6-124">Selecionar redes para monitorar</span><span class="sxs-lookup"><span data-stu-id="a10c6-124">Select networks to monitor</span></span>
