...
---
# <a name="get-ip-related-alerts-api"></a>Obter API de alertas de IP
...
Recupera uma coleção de alertas relacionados a um determinado endereço IP.
...
Se bem-sucedido e o IP existir - 200 OK com a [lista](alerts.md) de entidades de alerta no corpo. Se o IP não existir - 404 Não Encontrado.
