...
---
# <a name="get-domain-related-machines-api"></a>Obter API de máquinas relacionadas ao domínio
...
Recupera uma coleção de [Máquinas](machine.md) que se comunicaram com ou com um determinado endereço de domínio.
...
>- A resposta incluirá apenas dispositivos que o usuário pode acessar, com base nas configurações do grupo de dispositivos (Consulte Criar e gerenciar grupos de [dispositivos](machine-groups.md) para obter mais informações)
...
Se bem-sucedido e o domínio existir - 200 OK com a lista de [entidades do](machine.md) computador. Se o domínio não existir - 404 Não Encontrado.
