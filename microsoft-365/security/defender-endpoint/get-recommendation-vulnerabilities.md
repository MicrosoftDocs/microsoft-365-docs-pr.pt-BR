...
---
# <a name="list-vulnerabilities-by-recommendation"></a>Listar vulnerabilidades por recomendação
...
Recupera uma lista de vulnerabilidades associadas à recomendação de segurança.
...
Se tiver êxito, este método retornará 200 OK, com a lista de vulnerabilidades associadas à recomendação de segurança.
