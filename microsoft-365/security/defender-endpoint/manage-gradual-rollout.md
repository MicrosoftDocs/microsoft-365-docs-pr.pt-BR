...
O modelo de lançamento gradual a seguir é seguido para atualizações mensais do Defender:
...
Você também pode atribuir um computador a um canal para definir a cadência em que ele recebe atualizações de definição diárias. Observe que, diferentemente do processo mensal, não há canal Beta e esse ciclo gradual de lançamento ocorre várias vezes por dia.
