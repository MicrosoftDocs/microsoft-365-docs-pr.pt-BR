...
### <a name="block-outlook-from-launching-child-processes"></a>Impedir o Outlook de iniciar processos filho
...
### <a name="block-office-apps-from-launching-child-processes-and-from-creating-executable-content"></a>Impedir o Office Apps de iniciar processos filho e de criar conteúdo executável
...
- **Regras de Redução de** Superfície de Ataque - As regras asR não suportam esses cenários porque fazem parte da proteção do Microsoft Defender Antivírus.
...
- **Regras de Redução** de Superfície de Ataque - as regras asR não suportam esses cenários porque estão protegidas com proteções de segurança internas do Windows 10.
