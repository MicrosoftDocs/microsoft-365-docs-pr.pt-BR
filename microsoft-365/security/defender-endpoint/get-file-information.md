...
---
# <a name="get-file-information-api"></a>Obter API de informações de arquivo
...
Recupera um [arquivo pelo](files.md) identificador Sha1 ou Sha256
...
:---|:---|:---
Aplicativo |   File.Read.All | 'Ler todos os perfis de arquivo'
Delegado (conta corporativa ou de estudante) | File.Read.All |    'Ler todos os perfis de arquivo'
...
Se houver êxito e houver arquivo - 200 OK com a [entidade de](files.md) arquivo no corpo. Se o arquivo não existir - 404 Não Encontrado.
