...
### [Gerenciar o Defender para Ponto de Extremidade após a migração]()
#### [Visão geral do gerenciamento do Defender para Ponto de Extremidade](manage-atp-post-migration.md)
...
##### [Configure as notificações de vulnerabilidade por email](configure-vulnerability-email-notifications.md)
...
#### [Visão geral da proteção de última geração](next-generation-protection.md)
##### [Visão geral do Microsoft Defender Antivírus](microsoft-defender-antivirus-windows.md)
