...
Recupera uma lista de todas as vulnerabilidades que afetam a organização por [máquina](machine.md) e [software.](software.md)
- Se a vulnerabilidade tiver um KB de correção, ela aparecerá na resposta.
- Oferece suporte [a consultas OData V4.](https://www.odata.org/documentation/)
...
- [Dados baseados em Gerenciamento de Ameaças e Vulnerabilidades](/microsoft-365/security/defender-endpoint/next-gen-threat-and-vuln-mgt)
