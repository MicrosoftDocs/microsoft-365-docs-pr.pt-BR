...
A Microsoft está comprometida em fornecer as informações e controles necessários para fazer escolhas sobre como seus dados são coletados e usados quando você está usando o Defender para o Ponto de Extremidade para Linux.
...
Os dados de diagnóstico são usados para manter o Defender para o Ponto de Extremidade seguro e atualizado, detectar, diagnosticar e corrigir problemas e também fazer melhorias no produto.
...
Há dois níveis de dados de diagnóstico para software cliente do Defender for Endpoint que você pode escolher:

* **Obrigatório**: os dados mínimos necessários para ajudar a manter o Defender for Endpoint seguro, atualizado e com desempenho conforme esperado no dispositivo em que ele está instalado.
...
Os controles de privacidade para os vários tipos de dados descritos na seção anterior são descritos em detalhes em [Definir preferências](linux-preferences.md)para Defender para Ponto de Extremidade para Linux .
...
| app_version             | Versão do aplicativo Defender para Ponto de Extremidade para Linux. Permite que a Microsoft identifique quais versões do produto estão mostrando um problema para que ele possa ser priorizado corretamente.|
...
**Os dados de diagnóstico** necessários são os dados mínimos necessários para ajudar a manter o Defender for Endpoint seguro, atualizado e a executar conforme esperado no dispositivo em que está instalado.

Os dados de diagnóstico necessários ajudam a identificar problemas com o Microsoft Defender para Ponto de Extremidade que podem estar relacionados a uma configuração de dispositivo ou software. Por exemplo, ele pode ajudar a determinar se um recurso Defender for Endpoint falha com mais frequência em uma determinada versão do sistema operacional, com recursos recém-introduzidos ou quando determinados recursos do Defender para Ponto de Extremidade estão desabilitados. Os dados de diagnóstico necessários ajudam a Microsoft a detectar, diagnosticar e corrigir esses problemas mais rapidamente para que o impacto para usuários ou organizações seja reduzido.
...
| cloud_service.timeout                               | Tempo de tempo quando o aplicativo se comunica com a nuvem do Defender for Endpoint. |
...
| Campo            | Descrição |
| ---------------- | ----------- |
| versão          | Versão do Defender para Ponto de Extremidade para Linux. |
...
- Subconjunto de arquivos *em /etc/opt/microsoft/mdatp* criados e usados pelo Defender para Endpoint para Linux
- Instalação do produto e logs de desinstalação em */var/log/microsoft_mdatp_ \* .log*
...
| Campo                                              | Descrição |
| -------------------------------------------------- | ----------- |
| connection_retry_timeout                           | O tempo de conexão repetirá quando a comunicação com a nuvem. |
