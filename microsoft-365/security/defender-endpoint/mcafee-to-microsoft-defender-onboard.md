...
|macOS<br/>- 11.3.1 (Big Sur)<br/>- 10.15 (Catalina)<br/>- 10.14 (Mojave)     |Baixe e use o aplicativo DIY em [https://aka.ms/mdatpmacosdiy](https://aka.ms/mdatpmacosdiy) . <p>Para obter mais informações, consulte [Microsoft Defender for Endpoint on Mac](microsoft-defender-endpoint-mac.md).        |
...
Agora que você insinuou os dispositivos da sua organização no Microsoft Defender para Ponto de Extremidade, sua próxima etapa é desinstalar o McAfee.

Para obter ajuda com esta etapa, vá para seu McAfee ServicePortal ( [http://mysupport.mcafee.com](http://mysupport.mcafee.com) ).
...
Agora que você desinstalou a McAfee, sua próxima etapa é garantir que o Microsoft Defender Antivírus e a detecção e a resposta do ponto de extremidade estão habilitados e no modo ativo.
