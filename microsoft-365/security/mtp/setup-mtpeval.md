...
>[!NOTE]
>Inscrever-se em uma avaliação oferece 25 licenças de usuário para usar por um mês. Consulte [Try or Buy an M365 subscription para](../../commerce/try-or-buy-microsoft-365.md#try-or-buy-a-microsoft-365-subscription-1) obter detalhes.
...
|[Fase 3: Configurar o & Onboard](config-mtpeval.md) | Configure cada pilar do Microsoft 365 Defender para seu laboratório de avaliação do Microsoft 365 Defender ou ambiente piloto e aborde seus pontos de extremidade.
|:-------|:-----|