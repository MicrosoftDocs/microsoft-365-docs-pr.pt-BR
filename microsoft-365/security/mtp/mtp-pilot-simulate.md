...
1. Verifique se o locatário [habilitar o Microsoft 365 Defender](./mtp-enable.md#starting-the-service).
...
1. Verifique se seu locatário [habilitar o Microsoft 365 Defender](./mtp-enable.md#starting-the-service).
...
|![Fase de fechamento e resumo](../../media/mtp/close.png) <br>[Fase de fechamento e resumo](mtp-pilot-close.md)|Analise o resultado piloto do Microsoft 365 Defender, apresente-os aos participantes e dê a próxima etapa.
|:-----|:-----|