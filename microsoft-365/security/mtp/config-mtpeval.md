...
8. Certifique-se de que **a opção Não rastrear quando os** usuários clicarem em links seguros não estiver selecionada, enquanto o restante das opções estiver selecionado. Consulte [Configurações de Links Seguros](../office-365-security/recommended-settings-for-eop-and-office365-atp.md) para obter detalhes. Clique em **Salvar**. 
