...
- Verifique as configurações RBAC do Microsoft defender para ponto de extremidade na [central de segurança do Microsoft defender](https://securitycenter.windows.com/) em funções de permissões de **configurações**  >  **Permissions**  >  **Roles**. Selecione a função correspondente para atribuir a permissão **gerenciar configurações de segurança** .

> [!NOTE]
> Para gerenciar detecções personalizadas, os **operadores de segurança** precisarão da permissão **gerenciar configurações de segurança** no Microsoft defender para o ponto de extremidade se o RBAC estiver ativado.
...
- Uma das seguintes colunas que identificam dispositivos, usuários ou caixas de correio específicas:
    ...
    - `SenderFromAddress` (endereço de remetente ou Return-Path)
...
- **Isolar dispositivo** — usa o Microsoft defender para ponto de extremidade para aplicar o isolamento completo da rede, impedindo o dispositivo de se conectar a qualquer aplicativo ou serviço. [Saiba mais sobre o Microsoft defender para isolamento da máquina ponto de extremidade](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/respond-machine-alerts#isolate-devices-from-the-network)
- **Coletar pacote de investigação** — coleta informações de dispositivo em um arquivo zip. [Saiba mais sobre o pacote de investigação de ponto de extremidade do Microsoft defender](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/respond-machine-alerts#collect-investigation-package-from-devices)
...
> [!NOTE]
> A ação de permissão ou bloqueio para regras de detecção personalizada atualmente não é suportada no Microsoft 365 defender.
