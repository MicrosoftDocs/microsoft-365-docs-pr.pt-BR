...
- **Funções do Azure Active Directory Global (Azure AD)**
- **Acesso de função personalizado**

As contas atribuídas às seguintes **funções do Azure AD global** podem acessar a funcionalidade e os dados do Microsoft 365 Defender:
...
>! [OBSERVAÇÃO] Este artigo se aplica apenas ao gerenciamento de funções globais do Azure AD. Para obter mais informações sobre como usar o controle de acesso baseado em função personalizado, consulte [Funções personalizadas para controle de](custom-roles.md) acesso baseado em função
