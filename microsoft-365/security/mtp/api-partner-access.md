...
As etapas a seguir guiam como criar um aplicativo Azure AD de vários locatários, obter um token de acesso para o Microsoft 365 Defender e validar o token.

## <a name="create-the-multi-tenant-app"></a>Criar o aplicativo multi-locatário
...
3. No formulário de registro:
   ...
   - Preencha a seção **URI de redirecionamento.** Selecione o **tipo de Web** e dê o URI de redirecionamento como **https://portal.azure.com** .
...
Para saber mais sobre tokens do Azure AD, confira o [tutorial do Azure AD.](https://docs.microsoft.com/azure/active-directory/develop/active-directory-v2-protocols-oauth-client-creds)
...
1. De TENANT_ID a ID de locatário do Azure do usuário que deseja usar seu aplicativo para acessar o Microsoft 365 Defender.
