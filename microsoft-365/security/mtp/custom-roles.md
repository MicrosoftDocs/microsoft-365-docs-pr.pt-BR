...
O acesso ao Microsoft 365 Defender pode ser gerenciado coletivamente usando funções [globais no Azure Active Directory (AAD)](mtp-permissions.md)
...
- Microsoft Defender para Ponto de Extremidade – [Editar funções no Microsoft Defender para Ponto de Extremidade](/windows/security/threat-protection/microsoft-defender-atp/user-roles)
...
- [Gerenciar o acesso ao Microsoft 365 Defender](mtp-permissions.md)
