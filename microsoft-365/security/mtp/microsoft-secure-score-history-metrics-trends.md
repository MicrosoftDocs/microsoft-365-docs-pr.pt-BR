...
O primeiro local é na guia **visão geral** , onde você poderá ver um gráfico de barra de comparação. Passe o mouse sobre o gráfico para exibir a oportunidade de Pontuação e pontuação.
