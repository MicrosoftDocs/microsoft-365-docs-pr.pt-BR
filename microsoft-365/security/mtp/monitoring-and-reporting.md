...
* [Identities](monitor-and-report-identities.md) -contas de usuário e credenciais
* [Dados](monitor-data.md) – email e conteúdo do documento
...
* **Configuração e** cartões de integridade que abrangem a configuração e a implantação de controles de segurança, incluindo Estados de integração de dispositivos para serviços de gerenciamento
