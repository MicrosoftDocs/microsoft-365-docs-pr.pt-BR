...
description: Saiba mais sobre as alterações do Centro de Conformidade & segurança para Microsoft 365 Defender.
...
A tabela a seguir lista as alterações na navegação entre o Centro de Conformidade & Segurança e Microsoft 365 Defender.

<br>

****

|[Centro de conformidade e segurança](https://protection.office.com)|[Microsoft 365 Defender](https://security.microsoft.com)|[Centro de conformidade do Microsoft 365](https://compliance.microsoft.com/homepage)|[Centro de administração do Exchange](https://admin.exchange.microsoft.com)|
|---|---|---|---|
...
[Microsoft 365 Defender](./overview-security-center.md) at combina recursos de segurança de portais de segurança existentes da Microsoft, incluindo o Centro de Conformidade & <https://security.microsoft.com> Segurança. Este centro aprimorado ajuda as equipes de segurança a proteger suas organizações de ameaças de maneira mais eficaz e eficiente.

Se você estiver familiarizado com o Centro de & de Conformidade (protection.office.com), este artigo descreve algumas das alterações e melhorias no Microsoft 365 Defender.
...
Acompanhe e investigue ameaças ao email de seus usuários, acompanhe campanhas e muito mais. Se você tiver usado o Centro de Conformidade & segurança, isso será familiar.
...
> Para o Defender para Office 365 usuários,  agora você pode gerenciar e girar chaves DKIM por meio de Microsoft 365 Defender: , ou navegar até Política & regras Regras de ameaças seção <https://security.microsoft.com/threatpolicy>  \>  \> \>  \> **DKIM**.
>
...
|[Fila de alertas](../../compliance/alert-policies.md)|O **painel De exibição alertas** do flyout no Centro de Conformidade & segurança agora inclui links para Microsoft 365 Defender. Clique no link **Abrir Página de Alerta e** Microsoft 365 Defender abre. Você pode acessar a página **Exibir alertas** clicando em qualquer alerta do Office 365 na fila de Alertas.|
...
Também está incluído um link para o Centro de Conformidade & **segurança** para comparação. O último link é para a página **Novidades** que descreve as atualizações recentes.

## <a name="related-information"></a>Informações relacionadas

- [Redirecionando o & de Conformidade para Microsoft 365 Defender](microsoft-365-security-mdo-redirection.md)
