...
A imagem e a tabela a seguir lista as alterações na navegação entre o Office 365 Centro de Conformidade & Segurança e o Microsoft 365 Defender.
...
|Conformidade e Segurança do Office 365|Microsoft 365 Defender|Centro de conformidade do Microsoft 365|Centro de administração do Exchange|
|---|---|---|---|
...
## <a name="microsoft-365-defender-home-page"></a>Microsoft 365 Página Inicial do Defender
...
> [!NOTE]
> Para usuários do Defender Office 365, agora  você pode gerenciar e girar as teclas DKIM (DomainKeys Identified Mail) por meio do Microsoft 365 Defender: ou navegar até Política & regras Políticas de ameaça <https://security.microsoft.com/threatpolicy>  \>  \> **DKIM**.
