...
>[!CAUTION]
>**O período de visualização do conector ServiceNow terminou**<br>
>Esse recurso não está mais disponível. Obrigado por seus comentários e suporte contínuo enquanto determinamos as próximas etapas.

ServiceNow é uma plataforma de computação em nuvem popular que ajuda as empresas a gerenciar fluxos de trabalho digitais para operações corporativas. Sua plataforma Now tem fluxos de trabalho de TI, fluxos de trabalho de funcionários e fluxos de trabalho do cliente.
