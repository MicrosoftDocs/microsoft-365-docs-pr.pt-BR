...
keywords: implantar, licenças, serviços com suporte, provisionamento, configuração Microsoft 365 Defender, M365, qualificação de licença, Microsoft Defender para Ponto de Extremidade, Microsoft Defender para Office 365, Microsoft Defender para Identidade, Microsoft Cloud App Security, MCAS, E5, A5, EMS
...
[Microsoft 365 o Defender](microsoft-365-defender.md) integra vários serviços de segurança da Microsoft para fornecer recursos centralizados de detecção, prevenção e investigação contra ataques sofisticados. Este artigo descreve os serviços com suporte, seus requisitos de licenciamento, as vantagens e limitações associadas à implantação de um ou mais serviços e links para como você pode implantá-los totalmente individualmente.

## <a name="supported-services"></a>Serviços com suporte
Uma Microsoft 365 E5, uma licença de Segurança do E5, A5 ou A5 ou uma combinação válida de licenças fornece acesso aos seguintes serviços com suporte e permite que você use o Microsoft 365 Defender no centro de segurança Microsoft 365. [Consulte requisitos de licenciamento](prerequisites.md#licensing-requirements)
...
Microsoft 365 O Defender oferece melhor visibilidade, correlação e correção à medida que você implanta serviços mais suportados.
...
|Microsoft Defender para Office 365 | - Estados de email e caixa de correio e eventos brutos<br />- Detecções de email, anexo e link | - Caixas de correio<br />- Microsoft 365 contas |
...
|Microsoft Defender para Office 365 | *Nenhum, provisionado com Office 365* | [Configurar politicas do Microsoft Defender para Office 365](/microsoft-365/security/office-365-security/defender-for-office-365#configure-atp-policies) |
...
| Microsoft Cloud App Security | *Nenhum* | [Início rápido: começar a Microsoft Cloud App Security](/cloud-app-security/getting-started-with-cloud-app-security) |

Depois de ter implantado os serviços com suporte, [a Microsoft 365 Defender](m365d-enable.md).
...
- [Visão geral do Microsoft Defender Office 365 visão geral](../office-365-security/defender-for-office-365.md)
