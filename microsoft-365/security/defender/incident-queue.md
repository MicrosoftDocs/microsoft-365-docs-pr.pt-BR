...
- [Gerencie](manage-incidents.md) as propriedades do incidente para marcas, atribuição a um analista de segurança e comentários.
- Comece sua [investigação.](investigate-incidents.md)
