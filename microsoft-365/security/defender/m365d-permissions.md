...
As contas atribuídas às seguintes funções de Azure Active Directory **(AD)** globais podem acessar Microsoft 365 funcionalidade e dados do Defender:
...
> ! [OBSERVAÇÃO] Este artigo se aplica apenas ao gerenciamento de funções Azure Active Directory globais. Para obter mais informações sobre como usar o controle de acesso baseado em função personalizado, consulte [Funções personalizadas para controle de](custom-roles.md) acesso baseado em função
...
Durante a visualização, Microsoft 365 Defender não impõe controles de acesso com base Cloud App Security configurações. O acesso Microsoft 365 dados do Defender não são afetados por essas configurações.
