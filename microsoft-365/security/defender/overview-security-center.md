...
---
# <a name="microsoft-365-defender-overview"></a>Microsoft 365 Visão geral do Defender
...
Microsoft 365 O Defender reúne funcionalidades de portais de segurança da Microsoft existentes, como o Central de Segurança do Microsoft Defender e o Office 365 de conformidade & segurança. O centro de segurança enfatiza o acesso rápido a informações, layouts mais simples e a aproveitamento de informações relacionadas para facilitar o uso. Este centro inclui:
...
- [Defender para Office 365 no Microsoft 365 Defender](microsoft-365-security-center-mdo.md)
- [Defender para Ponto de Extremidade no Microsoft 365 Defender](microsoft-365-security-center-mde.md)
...
Microsoft 365 O Defender ajuda as equipes de segurança a investigar e responder a ataques trazendo sinais de cargas de trabalho diferentes para um conjunto de experiências unificadas para:
...
Para obter mais informações, [consulte incidentes no Microsoft 365 Defender](incidents-overview.md).
...
Os relatórios também são unificados no Microsoft 365 Defender. Os administradores podem começar com um relatório de segurança geral e ramificar em relatórios específicos sobre pontos de extremidade, email & colaboração. Os links aqui são gerados dinamicamente com base na configuração da carga de trabalho.
...
Essas informações rápidas ajudam você a acompanhar as atividades mais recentes em sua organização. Microsoft 365 O Defender reúne sinais de diferentes fontes para apresentar uma visão holística do ambiente Microsoft 365 ambiente.
...
3. Você tem duas opções:
    1. Role para baixo até a caixa de texto Como podemos melhorar a conformidade ou proteger melhor seus usuários *no Office 365?* e colar *no Microsoft 365 Defender*. Você pode pesquisar os resultados de uma ideia como a sua e in-locar ou usar o botão para **Postar uma nova ideia.**
...
Continue explorando os recursos e recursos no Microsoft 365 Defender:
