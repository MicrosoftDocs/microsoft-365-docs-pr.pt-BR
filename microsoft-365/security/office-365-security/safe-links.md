...
Para adicionar entradas à lista em políticas Cofre Links novas ou existentes, consulte [Create Cofre Links policies](set-up-safe-links-policies.md#use-the-microsoft-365-defender-portal-to-create-safe-links-policies) ou Modify Cofre Links [policies](set-up-safe-links-policies.md#use-the-microsoft-365-defender-portal-to-modify-safe-links-policies).
