...
6. Na caixa **especificar SCL** , selecione um dos seguintes valores e escolha **OK**:

   - **Ignorar filtragem de spam**: isso define o SCL como-1, o que significa que a filtragem de conteúdo não será executada.

   - **0-4**: a mensagem será passada junto com o filtro de conteúdo para processamento adicional.

   - **5-6**: a ação especificada para **spam** nas políticas de filtro de conteúdo aplicáveis será aplicada. Por padrão, a ação é enviar a mensagem para a pasta lixo eletrônico do destinatário.

   - **7-9**: a ação especificada para **spam de alta confiança** nas políticas de filtro de conteúdo aplicáveis será aplicada. Por padrão, a ação é enviar a mensagem para a pasta lixo eletrônico do destinatário.
