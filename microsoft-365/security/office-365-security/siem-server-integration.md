...
> [!TIP]
> Dê uma olhada no [Azure Sentinel](/azure/sentinel/overview). O Azure Sentinel vem com conectores para soluções da Microsoft. Esses conectores estão disponíveis "fora da caixa" e fornecem integração em tempo real. Você pode usar o Azure Sentinel com suas soluções Microsoft 365 Defender e serviços Microsoft 365, incluindo Office 365, Azure AD, Microsoft Defender for Identity, Microsoft Cloud App Security e muito mais.
...
- Para SharePoint Online, OneDrive for Business e Azure Active Directory, consulte [Ativar ou desativar a auditoria.](../../compliance/turn-audit-log-search-on-or-off.md)
