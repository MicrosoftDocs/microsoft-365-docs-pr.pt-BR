...
|---|---|---|
|[Obter o Microsoft Defender para Office 365](office-365-atp.md)|Logs de auditoria|[Integração do SIEM com o Microsoft Defender para Office 365](siem-integration-with-office-365-ti.md)|
|[Microsoft Defender para Ponto de Extremidade](/windows/security/threat-protection/)|Ponto de extremidade HTTPS hospedado no Azure <p> API REST|[Puxar alertas para suas ferramentas SIEM](/windows/security/threat-protection/microsoft-defender-atp/configure-siem)|
