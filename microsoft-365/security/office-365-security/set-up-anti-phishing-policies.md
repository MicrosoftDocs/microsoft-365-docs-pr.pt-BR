...
|**Habilitar inteligência de caixa de correio** <br/> |Habilita ou desabilita a inteligência de caixa de correio para esta política. Você só pode habilitar a inteligência de caixa de correio para contas baseadas em nuvem, ou seja, contas cuja caixa de correio está hospedada inteiramente no Office 365. <br/> | A inteligência de caixa de correio é criada em torno das pessoas que você envia e recebe emails de dentro da organização e de fora da organização. <br/> |
