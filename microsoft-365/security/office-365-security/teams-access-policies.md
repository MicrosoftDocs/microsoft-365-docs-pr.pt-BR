...
Recomendações adicionais específicas para a implantação do Teams estão incluídas neste artigo para abranger circunstâncias de autenticação específicas, inclusive para usuários de fora da sua organização. Você precisará seguir essas orientações para obter uma experiência de segurança completa.
...
Você não precisa habilitar serviços dependentes para começar a trabalhar com o Microsoft Teams. Todas elas funcionarão "apenas". No entanto, você precisa estar preparado para gerenciar o seguinte:
...
Estes são os serviços dependentes a incluir na atribuição de aplicativos de nuvem para o Teams:
...
||[Bloquear clientes sem suporte para a autenticação moderna](identity-access-policies.md#block-clients-that-dont-support-modern-authentication)|Inclua o Teams e serviços dependentes na atribuição de aplicativos de nuvem.|
...
Como referência, o diagrama a seguir ilustra os serviços dos quais o Teams depende. Para obter mais informações e ilustrações adicionais, consulte o Microsoft Teams e os serviços de produtividade relacionados no [Microsoft 365 para arquitetos de IT.](../../solutions/productivity-illustrations.md)
...
-  O acesso de convidados usa uma conta B2B do Azure AD para um convidado ou usuário externo que pode ser adicionado como membro de uma equipe e tem acesso total à comunicação e aos recursos da equipe.
...
O acesso externo às vezes é confundido com o acesso de convidados, portanto, é importante deixar claro que esses dois mecanismos de acesso não internos são realmente bem diferentes.
