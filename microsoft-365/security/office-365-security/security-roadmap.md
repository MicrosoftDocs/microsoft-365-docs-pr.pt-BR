...
|Área|Tarefas|
|---|---|
|Gerenciamento de segurança|<ul><li>Verifique a Pontuação Segura e anote sua pontuação atual ( <https://securescore.office.com> ).</li><li>Ativar o log de auditoria para Office 365. Consulte [Pesquisar o log de auditoria](../../compliance/search-the-audit-log-in-security-and-compliance.md).</li><li>[Configure Microsoft 365 para aumentar a segurança](tenant-wide-setup-for-increased-security.md).</li><li>Revise regularmente painéis e relatórios no portal Microsoft 365 Defender e Cloud App Security.</li></ul>|
