 ...
 **Resumo:** Esta solução informa quais são os indicadores para os ataques de segurança cibernética mais comuns no Office 365, como confirmar positivamente qualquer ataque determinado e como responder a ele.
...
- Quais sinais, chamados indicadores de comprometimento (IOC), para procurar e como procurar por eles.
...
Verifique aqui mensalmente como mais artigos serão adicionados ao longo do tempo.
...
- Tarefas para realizar em 90 dias. Eles levam um pouco mais de tempo para planejar e implementar, mas melhoram muito sua postura de segurança
