...
4. Na página **Configurações** exibida, configure as seguintes configurações:
   ...
   - **Não permita que os usuários cliquem** na URL original : Selecione essa configuração para impedir que os usuários cliquem na URL original em páginas [de aviso.](atp-safe-links.md#warning-pages-from-safe-links)
   ...
   - **Não reescreva as SEGUINTES URLs**: Permite acessar as URLs especificadas que seriam bloqueadas por Links Seguros.
     ...
     Para a sintaxe de entrada, consulte [Sintaxe de entrada para a lista "Não reescrever as URLs a seguir".](atp-safe-links.md#entry-syntax-for-the-do-not-rewrite-the-following-urls-list)

   Para obter informações detalhadas sobre essas configurações, consulte [Configurações](atp-safe-links.md#safe-links-settings-for-email-messages) de Links Seguros para mensagens de email e configurações de Links Seguros [para o Microsoft Teams.](atp-safe-links.md#safe-links-settings-for-microsoft-teams)
...
> [!NOTE]
> 
> - Para obter detalhes sobre a sintaxe de entrada a ser usada para o parâmetro _DoNotRewriteUrls,_ consulte Sintaxe de entrada para a lista "Não reescrever as [URLs a seguir".](atp-safe-links.md#entry-syntax-for-the-do-not-rewrite-the-following-urls-list)
> 
