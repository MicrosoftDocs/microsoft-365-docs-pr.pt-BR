...
|Corresponder subdomínios|Para obter mais informações sobre a habilitação do fluxo de emails de e para os sub-domínios de seus domínios aceitos, consulte [Mail flow in EOP](mail-flow-in-eop.md).|
...
|Dicionários personalizados|As regras de fluxo de emails podem incluir longas listas de texto e palavras-chave, fornecendo a mesma funcionalidade de um dicionário personalizado.|
...
|**Administração**||
|Administração com base na Web|Os administradores podem gerenciar o serviço no Centro de administração do Exchange (EAC), que tem suporte em 60 idiomas. Para saber mais, confira [o Centro de administração do Exchange no EOP autônomo.](exchange-admin-center-in-exchange-online-protection-eop.md)|
...
|PowerShell|A funcionalidade completa do EOP está disponível no EOP PowerShell autônomo. Para saber mais, confira [o PowerShell da Proteção do Exchange Online.](https://docs.microsoft.com/powershell/exchange/exchange-online-protection-powershell)|
