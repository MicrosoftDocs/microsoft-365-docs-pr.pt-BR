...
ms.custom:
- seo-marvel-apr2020
description: Neste artigo, você aprenderá a mudar para o Exchange Online Protection (EOP) de um dispositivo de higienização de email local ou serviço de proteção baseado em nuvem.
ms.technology: mdo
...
Se você for novo no EOP e quiser ler uma visão geral de seus recursos antes de decidir alternar, comece com o tópico visão geral da Proteção [do Exchange Online.](exchange-online-protection-overview.md)
...
Talvez você tenha caixas de correio locais protegidas por um dispositivo local e queira ir para caixas de correio hospedadas na nuvem do Exchange Online e proteção do EOP para aproveitar os recursos de proteção e mensagens na nuvem do Microsoft 365. Para começar, você pode se inscrever no Microsoft 365 e adicionar seu domínio. Esse cenário não exige que você configurar conectores, porque não há nenhum roteamento para caixas de correio locais. Comece em [Obter os recursos avançados mais recentes com o Microsoft 365](https://www.microsoft.com/microsoft-365/business/compare-more-office-365-for-business-plans) para se inscrever e se familiarizar com seus recursos.

Durante o processo de instalação do Microsoft 365, você criará seus usuários de caixa de correio baseados em nuvem.
...
O melhor local para iniciar, se você estiver considerando uma implantação híbrida, é Exchange Server [implantações híbridas.](/exchange/exchange-hybrid) Além disso, existem algumas maneiras diferentes de você rotear o seu email em um cenário híbrido que é importante que você entenda. [Roteamento de Transporte](/exchange/transport-routing) em implantações híbridas do Exchange explica cada tipo, para que você possa escolher o melhor cenário de roteamento, com base em seus requisitos de negócios.
