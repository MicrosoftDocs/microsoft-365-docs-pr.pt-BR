...
- No PowerShell do Exchange Online, substitua o \< nome \> pelo Office365 antiphish padrão ou o nome de uma política personalizada e execute o seguinte comando para verificar as configurações:
