...
1. Se necessário, use um navegador do seu computador local e entre no centro de administração (<https://admin.microsoft.com>) usando sua conta de administrador global.
...
1. Usando um navegador no seu computador local, entre no centro de administração (<https://admin.microsoft.com>) usando sua conta de administrador global.
...
1. Se necessário, use um navegador no seu computador local e entre no centro de administração (<https://admin.microsoft.com>) com uma conta com a função de Administrador de Segurança ou Administrador da Empresa.
...
1. Entre no centro de administração com uma conta que tenha a função Administrador de Segurança ou Administrador da Empresa. Para obter ajuda, confira [Onde entrar no Office 365](https://support.microsoft.com/office/e9eb7d51-5430-4929-91ab-6157c5a050b4).

2. Em uma guia separada do navegador, vá para o portal do Microsoft Azure (<https://portal.azure.com>).

3. No painel de pesquisa, digite **informações** e, em seguida, clique em **Proteção de Informações do Azure**.

4. Clique em **Rótulos**.

5. Clique com o botão direito do mouse no rótulo **Altamente Confidencial** e clique em **Adicionar um sub-rótulo**.

6. Digite **CampaignStrategy** em **Nome** e **Rótulo para documentos no Site de equipe de estratégia de campanha** em **Descrição**.

7. Em **Definir permissões para documentos e emails que contenham este rótulo**, clique em **Proteger**.

8. Na seção **Proteção**, clique em **Azure (chave de nuvem)**.

9. Na folha **Proteção**, em **Configurações de proteção**, clique em **+ Adicionar permissões**.

10. Na folha **Adicionar permissões**, em **Especificar usuários e grupos**, clique em **+ Procurar no diretório**.

11. No painel **Usuários e Grupos do AAD**, selecione **Funcionários sênior e estratégicos** e clique em **Selecionar**.

12. Em **Escolher permissões a partir de valores predefinidos ou definir valores personalizados**, clique em **Personalizar** e, em seguida, clique nas caixas de seleção **Exibir Direitos**, **Editar Conteúdo**, **Salvar**, **Responder** e **Responder a Todos**.

13. Clique em **OK** duas vezes.

14. Na folha **Sub-rótulo**, clique em **Salvar** e em **OK**.

15. Na folha **Proteção de Informações do Azure**, clique em **Políticas > + Adicionar uma nova política**.

16. Digite **CampaignStrategy** em **Nome** e **Documentos no Site de equipe de estratégia de campanha** em **Descrição**.

17. Clique em **Selecionar usuários ou grupos que obtêm essa política > Usuário/Grupos** e selecione **Funcionários sênior e estratégicos**.

18. Clique em **Selecionar\> OK**.

19. Clique em **Adicionar ou remover rótulos**. No painel **Política: adicionar ou remover rótulos**, clique em **CampaignStrategy** e em **OK**.

20. Clique em **Salvar** e em **OK**.
