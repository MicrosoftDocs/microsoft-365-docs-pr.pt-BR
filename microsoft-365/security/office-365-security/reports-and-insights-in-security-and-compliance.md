...
|**Fluxo de mensagens** <br/> Informações sobre mensagens de email enviadas e recebidas, alertas recentes, principais remetentes e destinatários, relatórios de encaminhamento de emails e muito mais  <br/> |No centro de &amp; conformidade de segurança, vá para \> **painel** de **fluxo de emails** <br/> |[Insights de fluxo de emails no Centro de Conformidade e Segurança](mail-flow-insights-v2.md)<br/> |
