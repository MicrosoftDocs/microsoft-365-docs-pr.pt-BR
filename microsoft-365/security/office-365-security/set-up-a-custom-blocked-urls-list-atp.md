...
A lista de URLs bloqueadas é definida pela equipe de segurança do Microsoft 365 for Business da sua organização e essa lista se aplica a todos na organização que estão cobertos pelas políticas de links seguros do Office 365 ATP.
...
2. Na navegação à esquerda, em **Gerenciamento de ameaças**, **Policy** escolha \> **links seguros**de política.
...
- Não inclua uma barra ( **/** ) no final da URL. Por exemplo, em vez de inserir `https://www.contoso.com/` , insira `https://www.contoso.com` .
...
> [!NOTE]
> Por padrão, você só pode adicionar URLs 500 à lista de URLs bloqueadas na política padrão do Office 365 ATP Safe links. Uma URL individual não pode exceder 128 caracteres. A lista inteira de URLs bloqueadas não pode exceder 10.000 caracteres.
