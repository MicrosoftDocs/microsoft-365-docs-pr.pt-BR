...
Depois de obter as informações do cabeçalho da mensagem, localize o cabeçalho **X-Forefront-Antispam-Report**. Haverá vários campos de cabeçalho e pares de valores nesse cabeçalho separados por ponto e vírgula (;). Por exemplo:
