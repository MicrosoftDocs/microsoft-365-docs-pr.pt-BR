...
Em um nível alto, um alerta é disparado e um guia de análise de segurança inicia e investigação automatizada, resultando em resultados e recomendações. Este é o fluxo de ar geral, passo a passo:
