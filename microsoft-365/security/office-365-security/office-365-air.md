...
> [!TIP]
> Para saber mais sobre políticas de alerta ou editar as configurações padrão, consulte [Alert policies in the Microsoft 365 compliance center](../../compliance/alert-policies.md).
