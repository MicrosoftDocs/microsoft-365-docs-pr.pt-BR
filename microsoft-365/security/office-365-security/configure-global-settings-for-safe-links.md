...
Você define as configurações de links mais seguros em políticas de links seguros. Para obter instruções, consulte [set up Safe links Policies in Office 365 ATP](set-up-atp-safe-links-policies.md).
