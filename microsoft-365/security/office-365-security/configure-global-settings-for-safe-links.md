...
2. Na política **de Links seguros para a sua organização,** vá para a caixa Bloquear as **URLs a** seguir.
...
A proteção de Links Seguros para aplicativos do Office 365 se aplica a documentos em aplicativos da Web, móveis e da área de trabalho do Office com suporte. Para saber mais, confira as [configurações de Links seguros para aplicativos do Office 365.](atp-safe-links.md#safe-links-settings-for-office-365-apps)
