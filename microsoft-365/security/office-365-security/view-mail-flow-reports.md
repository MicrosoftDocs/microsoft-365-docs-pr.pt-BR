...
- **Email total**
- **Permissão de borda** e **borda filtradas**
- **Não malware**, **detecção de anexos seguros** <sup>\*</sup> , **detecção de mecanismo anti-malware** e **mensagens de regra**
- **Não Phish**, **falha DMARC**, **detecção de personificação**, **detecção de falsificação** e **detecção de phishing**
- **Nenhuma detecção com URL acionamento** e **detecção de URL acionamento**<sup>\*</sup>
- **Não spam** e  **spam**
- **Email não mal-intencionado**, **detecção de links seguros** <sup>\*</sup> e **zap**
