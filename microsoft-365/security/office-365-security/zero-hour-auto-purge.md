...
O phishing ZAP está habilitado por padrão na política de spam. O phishing ZAP pode ser desabilitado usando o parâmetro *PhishZapEnabled* de [set-HostedContentFilterPolicy](https://docs.microsoft.com/powershell/module/exchange/antispam-antimalware/Set-HostedContentFilterPolicy), um cmdlet EOP.
...
O ZAP de spam está habilitado por padrão na política de spam. Você pode desabilitar o ZAP de spam usando o parâmetro *SpamZapEnabled* do cmdlet [set-HostedContentFilterPolicy](https://docs.microsoft.com/powershell/module/exchange/antispam-antimalware/Set-HostedContentFilterPolicy) no PowerShell do Exchange Online ou do Exchange Online Protection.
...
Para desabilitar o Phish e spam ZAP para seu locatário do O365, ou um conjunto de usuários, use os parâmetros *PhishZapEnabled* e *SpamZapEnabled* de [set-HostedContentFilterPolicy](https://docs.microsoft.com/powershell/module/exchange/antispam-antimalware/Set-HostedContentFilterPolicy), um cmdlet EOP.
...
Para informações detalhadas de sintaxes e de parâmetros, consulte [set-HostedContentFilterPolicy](https://docs.microsoft.com/powershell/module/exchange/antispam-antimalware/Set-HostedContentFilterPolicy).
