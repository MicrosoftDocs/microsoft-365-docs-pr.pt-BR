...
Este artigo é um guia de implantação passo a passo para criar e configurar um site de equipe do SharePoint Online isolado no Microsoft Office 365. Essas etapas assumem o uso dos três grupos padrão do SharePoint e níveis de permissão correspondentes, com um único grupo de acesso baseado no Azure Active Directory (AD) para cada nível de acesso.
...
Esta é a configuração resultante com os três grupos de acesso a sites preenchidos com contas de usuário ou grupos.
