...
1. No navegador, vá para o portal do Azure em <https://portal.azure.com> e entre com as credenciais de uma conta que tenha sido atribuída com o administrador de gerenciamento de usuário ou a função de administrador da empresa.
...
1. Adicione a lista de usuários da etapa 1 ao grupo de acesso de administradores de site.
2. Adicione a lista de usuários da etapa 2 ao grupo de acesso de membros do site.
3. Adicione a lista de usuários da etapa 3 ao grupo de acesso visualizadores de sites.
