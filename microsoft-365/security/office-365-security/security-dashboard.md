...
As informações que você verá no Resumo de Gerenciamento de Ameaças dependem do que sua assinatura inclui. A tabela a seguir descreve quais informações são incluídas para o Office 365 E3 e o Office 365 E5.
...
Os detalhes dependem se sua assinatura do Microsoft 365 inclui o [Exchange Online Protection](exchange-online-protection-overview.md) (EOP) com ou sem o Microsoft Defender para Office [365](office-365-atp.md).
...
|Obter o Microsoft Defender para Office 365|Conteúdo mal-intencionado e emails mal-intencionados detectados e bloqueados pelo EOP e pelo Defender para Office 365 <p> Contagem agregada de mensagens de email [exclusivas](atp-safe-attachments.md)com conteúdo mal-intencionado bloqueado pelo mecanismo anti-malware, limpeza automática de hora [zero](zero-hour-auto-purge.md)e recursos do Defender para Office 365 (incluindo [Links](atp-safe-links.md)Seguros, Anexos Seguros e [Anti-phishing no Defender para Office 365](set-up-anti-phishing-policies.md#exclusive-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365)). <p> Consulte [Relatório de status de proteção contra ameaças.](view-reports-for-atp.md#threat-protection-status-report)|
...
|Bloqueado pelo [Defender para Office 365 ](office-365-atp.md)|Número de mensagens de email bloqueadas pelo Defender para Office 365 multiplicada pelo número de destinatários|
...
E, se a assinatura da sua organização incluir o [Defender for Office 365 Plano 2](office-365-ti.md), você também terá um relatório de **alertas** de gerenciamento de ameaças recentes nesta seção que permite que sua equipe de segurança extiver e tomar medidas em alertas de segurança de alta prioridade.
