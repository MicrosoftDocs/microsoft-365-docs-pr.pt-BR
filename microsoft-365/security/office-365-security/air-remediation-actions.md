...
|User|Regras de delegação de email <br/>(Uma conta de usuário tem A delegação configurada.)|Remover regra de delegação <br/><br/> Se sua organização estiver usando o [Microsoft defender para ponto de extremidade](https://docs.microsoft.com/windows/security/threat-protection/), considere [investigar o usuário](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/investigate-user) que está obtendo a permissão de delegação.|
