...
|Email|URL mal-intencionada<br/>(Uma URL maliciosa foi detectada por [links seguros no Microsoft defender para Office 365](atp-safe-links.md).|Exclusão reversível de email/cluster <br/><br/>O email que contém uma URL mal-intencionada é considerado mal-intencionado.|
