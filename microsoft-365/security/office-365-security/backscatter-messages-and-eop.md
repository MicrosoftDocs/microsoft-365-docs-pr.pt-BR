...
> [!TIP]
> O Backscatter.org site ( ) recomenda usar seu serviço para verificar emails de entrada no modo Cofre em vez do modo Rejeitar (grandes serviços de email quase sempre enviam algum <http://www.backscatterer.org/?target=usage> backscatter).
