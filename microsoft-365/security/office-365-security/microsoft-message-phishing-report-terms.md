...
> [!IMPORTANT]
> If you live in or are a business with a principal place of business based in the United States, please read Section 7, *Binding arbitration and class action waiver*. Ele descreve como as controvérsias são resolvidas.

> [!NOTE]
> *Em inglês:* Como este software é distribuído no Canadá, algumas das cláusulas deste contrato (especificamente nas seções 10, 11 e 12) são fornecidas em francês.
>
...
Se você estiver em conformidade com estes termos de licença, você tem os direitos abaixo. Ao usar o software, você aceita estes termos.
...
3. **SCOPE OF LICENSE.** The software is licensed, not sold. Microsoft reserves all other rights. Unless applicable law gives you more rights despite this limitation, you will not (and have no right to):
    ...
    1. usar o software para atividades comerciais, sem fins lucrativos ou de geração de receita;
...
4. **EXPORT RESTRICTIONS.** You must comply with all domestic and international export laws and regulations that apply to the software, which include restrictions on destinations, end users, and end use. Para obter mais informações sobre restrições de exportação, [https://aka.ms/exporting](https://aka.ms/exporting) visite.
...
12. *Em inglês:* **LIMITAÇÃO E EXCLUSÃO DE DANOS.** Se você tiver qualquer base para recuperar danos apesar do aviso de isenção de responsabilidade anterior da garantia, poderá recuperar da Microsoft e de seus fornecedores apenas danos diretos até US$ 5,00. Você não pode recuperar outros danos, incluindo conseqüenciais, lucros perdidos, danos especiais, indiretos ou incidentais.
    ...
    *En Français:* **LIMITATION DES DOMMAGES-INTÉRÊTS ET EXCLUSION DE RESPONSABILITÉ POUR LES DOMMAGES.** Vous pouvez obtenir de Microsoft et de ses fournisseurs une indemnisation en cas de dommages directs uniquement àsocialur de 5,00 $ US. Vous ne pouvez prétendre à aucune indemnisation pour les autres dommages, y compris les dommages spéciaux, indirects ou accessoires et pertes de bénéfices.
