...
- **A prioridade do tipo de proteção de email:** esta ordem não é configurável e é descrita na tabela a seguir:
  ...
  ****
  ...
  |4 |Spoofing|CAT:SPOOF|[Configurar inteligência contra spoof no EOP](learn-about-spoof-intelligence.md)|
...
1. A mensagem é marcada e tratada como falsa, porque a falsa tem prioridade maior (4) do que a representação de usuário (5).
...
Como é possível que os mesmos usuários sejam intencionalmente ou não incluídos intencionalmente em várias políticas personalizadas do mesmo tipo, use as seguintes diretrizes de design para políticas personalizadas:
