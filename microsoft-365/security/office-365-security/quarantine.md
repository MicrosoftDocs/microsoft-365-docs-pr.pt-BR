...
- [Gerenciar mensagens e arquivos em quarentena como um administrador no Office 365](manage-quarantined-messages-and-files.md): descreve como os administradores podem localizar e liberar qualquer mensagem que resida na quarentena no centro de administração do Exchange (Eat) e, opcionalmente, relatá-la como uma mensagem falso positivo (não sendo lixo eletrônico) para a Microsoft.
