...
- **Log de auditoria do administrador**: o log de auditoria do administrador registra qualquer ação (com base nos cmdlets do PowerShell EOP autônomo) por um administrador ou um usuário com privilégios administrativos. Para obter mais informações, consulte [Exibir o log de auditoria do administrador no Exchange Online](https://docs.microsoft.com/exchange/security-and-compliance/exchange-auditing-reports/view-administrator-audit-log).
