...
Para obter detalhes sobre como as configurações de política Estrita diferem das configurações de política padrão e Padrão, consulte Configurações recomendadas para o EOP e o Microsoft Defender para a segurança do [Office 365.](recommended-settings-for-eop-and-office365.md)
