...
- Email suspeito (dica de segurança vermelha).
    ...
    Uma dica de segurança vermelha em um email significa que a mensagem recebida contém algo suspeito, como um esquema de phishing. Recomendamos que você exclua esse tipo de mensagem de email da sua caixa de entrada sem abri-la.
...
- Email seguro (dica de segurança verde).
    ...
    Além de mensagens não seguras, também contaremos sobre mensagens válidas dos envios em que confiamos com uma dica de segurança verde. Uma dica de segurança verde em um email significa que verificamos o remetente da mensagem e verificamos se ela é segura. A Microsoft mantém essa lista de envios confiáveis que inclui organizações financeiras e outras que são frequentemente falsas ou personificadas.
