...
Antes de começar a adotar, você precisa entender os conceitos envolvidos no gerenciamento de conhecimento e tópicos do Viva. O diagrama a seguir mostra o que acontece durante a descoberta e a cura do tópico:

![Arquitetura de Tópicos do Viva](../media/knowledge-management/topic-management-architecture.png)

- **Descoberta**: os usuários podem descobrir o conhecimento nos aplicativos que usam todos os dias por meio de cartões de tópicos - eles também podem descobrir tópicos na Pesquisa da Microsoft.
- **Curação**: os especialistas em assuntos (SMEs) refinam tópicos por meio de páginas de tópicos e a IA aprende com suas entradas. O Centro de tópicos contém páginas de tópicos que os usuários podem explorar e os especialistas podem gerenciar.
- **Identificação**: com conhecimento do Microsoft Graph e Inteligência Artificial (AI), as pessoas (tópicos, habilidades e assim por diante) são identificadas e organizadas automaticamente em tópicos relacionados. O conteúdo do SharePoint é indexado com conteúdo de segurança.
...
Para obter mais informações, você pode revisar a [visão geral](topic-experiences-overview.md) para obter uma introdução.

Lembre-se de que:

- A descoberta de tópicos é aprimorada quando há mais conteúdo disponível.
- A segurança, a privacidade e a localização de seus dados são preservadas mesmo que as informações são apresentadas em uma nova experiência.
...
- Qual conteúdo deve ser usado para a descoberta de tópicos?
- Quem gerenciará tópicos?
- Quem verá tópicos e destaques?
- Quais tópicos são esperados?

Revise esta lista de pré-requisitos para obter o máximo de Tópicos do Viva:
...
1. Planeje sua abordagem e cenários de destino:
    ...
    - Pense nos [participantes e](#identify-stakeholders) membros da equipe do projeto que você precisa ter envolvido.  
    - Descubra o impacto dos negócios que você deseja levar e como medirá [o sucesso.](#create-a-success-plan)

2. Envolva sua organização:
    - Identifique os grupos de negócios e equipes de negócios que precisam estar envolvidos e obtenha alinhamento entre esses e os cenários que você está planejando.
    - Comece a pensar em como envolver alguns adotantes in-loco para obter comentários críticos e antecipados para que você possa iterar para chegar à melhor solução.
    - Comece a criar a comunidade e pense em como os Tópicos do Viva podem ser usados em sua organização por esses grupos diferentes.

3. Treine sua organização: a maioria das pessoas compreenderá intuitivamente o conceito de tópicos e como os cartões de tópico compilam informações relevantes e entenderão e verão o valor. Mas talvez você queira criar um treinamento personalizado para sua própria cultura e organização, para mostrar como você deseja que os Tópicos do Viva sejam usados. Alguns recursos de treinamento:
    - [Centro de Recursos do Project Cortex.](https://aka.ms/projectcortex) Inclui visão geral e informações de recursos, vídeos e apresentações gravados do office hour e informações sobre parceiros e suas ofertas.
...
- Kim era uma SME e tinha permissões para ver páginas de tópicos não confirmadas. Páginas de tópico não confirmadas são ótimos pontos de partida para o que a IA descobriu e criou, e Kim foi capaz de editá-las para adicionar recursos especializados, definições e fixar outros recursos.
...
| Especialistas no assunto e colaboradores de tópicos | Gerar ou revisar tópicos e descrições | Qualquer departamento |
...
| Administrador ou gerente de pesquisa | Configurar configurações de pesquisa | Departamento de IT |

Em uma organização maior, você também pode ter várias pessoas nessas funções e precisará conduzir a coordenação entre elas. Em uma empresa menor, uma única pessoa pode executar várias dessas funções. Funções diferentes podem estar mais envolvidas em diferentes fases do projeto. Por exemplo, os administradores de locatários estão mais envolvidos na configuração dos recursos, enquanto os especialistas em assunto e os Campeões não se envolvem até que você comece a definir tópicos.
...
Use esses indicadores para medir o sucesso dos Tópicos do Viva em sua organização. Olhar para:

1. Uso do tópico:
      - Impressões de tópicos
      - Quantidade de tópicos – confirmados e não confirmados em sua lista de tópicos com cura.
      - Número de páginas de tópico publicadas.
1. Comentários do usuário final dos cartões de tópico.
1. Faça pesquisas de satisfação dos funcionários. Os Tópicos do Viva devem melhorar a capacidade dos funcionários de encontrar informações, portanto, encontre maneiras de coletar suas informações e comentários sobre essa experiência.
1. Impacto positivo na análise de pesquisa. Como os tópicos aparecem na experiência de pesquisa, com o tempo, você pode ver as taxas de pesquisa abandonadas menores porque as pessoas são mais facilmente capazes de encontrar os tópicos na pesquisa. 

### <a name="build-a-champion-network"></a>Criar uma rede de campeões

Crie uma rede de campeões em sua organização. Os campeões são importantes porque podem:
...
Muitas redes de campeões usam o Yammer como sua plataforma. No Yammer, as pessoas podem postar perguntas e obter respostas e compartilhar histórias de sucesso. É difícil obter a palavra sozinho, para que você possa contar com a rede de pessoas em toda a sua empresa para oferecer conselhos aos seus pares e mostrar como sua equipe está usando Tópicos do Viva para que outras equipes possam pensar em seus próprios cenários.

Algumas organizações estão usando hackathons (formais ou informais, virtuais ou pessoalmente) para reunir grupos de pessoas para trabalhar em um projeto específico. Por exemplo, você pode reunir seus especialistas no assunto e fazer com que eles trabalhem juntos para fazer a cura de um conjunto de páginas de tópicos.
...
Agora que você está pronto para lançar, você deseja garantir que está incentivando o envolvimento contínuo.
...
- Definir desafios para pessoas e executar competições.

## <a name="next-steps"></a>Próximas etapas

Quando estiver pronto para lançar tópicos do Viva, você precisará envolver as pessoas.

- Comece a introduzir o conjunto de recursos e fazer com que eles pensem sobre seus cenários.
- Reúna as partes interessadas e crie cenários.
- Conduza a comunidade e pense em como você vai engajar eles.
- Em seguida, conclua as etapas de preparação. Algumas podem ser preparação técnica e algumas de prontidão empresarial.
