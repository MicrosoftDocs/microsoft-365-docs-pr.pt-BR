...
Se um usuário não recebe permissões durante a instalação, um administrador pode fazer o seguinte para conceder permissões aos usuários por meio do centro de administração do Microsoft 365:
...
[Trabalhar com tópicos no centro de tópicos](work-with-topics.md)
