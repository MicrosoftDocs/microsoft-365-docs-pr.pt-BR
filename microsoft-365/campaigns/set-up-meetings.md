...
[![Uma ilustração de dois usuários que têm uma reunião de um computador desktop e de um telefone celular](media/HostOnlineMeeting-thumb-358x201.png)](https://go.microsoft.com/fwlink/?linkid=2078712)
...
1. Agende suas reuniões online diretamente no Microsoft Teams. Você pode escolher uma equipe e um canal, e ele convidar os participantes dessa equipe ou canal automaticamente.
2. Precisa de uma reunião improvisada? Se você estiver em um chat de um em um, basta escolher **reunir agora** para iniciar uma chamada de vídeo ou áudio com a pessoa com quem você está batendo papo. 
...
Saiba mais sobre a reunião no Microsoft Teams:
