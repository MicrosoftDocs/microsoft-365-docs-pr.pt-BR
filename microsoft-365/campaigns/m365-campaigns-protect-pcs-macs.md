...
Você pode gerenciar os computadores com Windows 10 e Macs, registrando-os no Microsoft Intune, o que permite garantir que eles sejam íntegros e seguros antes de acessar dados em seu ambiente. No entanto, muitas campanhas e pequenas empresas incluem funcionários que trazem seus próprios dispositivos (BYOD), que não serão gerenciados pela organização. Para esses PCs e Macs não gerenciados, use este artigo para garantir que os recursos de segurança mínimos sejam configurados. 
