...
Você pode gerenciar computadores com o Windows 10 e Macs, registrando-os no Microsoft Intune, o que permite garantir que o tht seja saudável e seguro antes de acessar dados em seu ambiente. No entanto, muitas campanhas e pequenas empresas incluem funcionários que trazem seus próprios dispositivos (BYOD), que não serão gerenciados pela organização. Para esses PCs e Macs não gerenciados, use este artigo para garantir que os recursos de segurança mínimos sejam configurados. 
