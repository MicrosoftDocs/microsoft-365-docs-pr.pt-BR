...
---
# <a name="create-teams-for-collaboration-in-microsoft-teams"></a>Criar equipes para colaboração em Microsoft Teams

Microsoft Teams é um aplicativo de colaboração que ajuda sua equipe a se manter organizada e ter conversas, de qualquer dispositivo. Você pode usar Microsoft Teams para ter conversas instantâneas com membros da sua equipe ou convidados fora da sua organização. Você também pode fazer chamadas telefônicas, reuniões de host e compartilhar arquivos.
...
- Um novo [Microsoft 365 grupo](/MicrosoftTeams/office-365-groups)
- Um [SharePoint online e](/MicrosoftTeams/sharepoint-onedrive-interact) biblioteca de documentos para armazenar arquivos de equipe
- Uma [Exchange Online](/MicrosoftTeams/exchange-teams-interact) de correio e calendário compartilhados
- Um bloco de anotações do OneNote
- Vincula-se a outros Office 365 aplicativos como o Planner e o Power BI

Dentro Microsoft Teams, você pode encontrar:
...
2. **Reuniões:** Veja tudo o que você tem alinhado para o dia ou semana. Ou agende uma reunião. Esse calendário sincroniza com seu calendário Outlook calendário.
3. **Chamadas:** Em alguns casos, se sua organização a tiver configurada, você poderá chamar qualquer pessoa Microsoft Teams, mesmo que não esteja usando Microsoft Teams.
...
Saiba mais sobre Microsoft Teams na [Microsoft Teams técnica](/microsoftteams/microsoft-teams)
