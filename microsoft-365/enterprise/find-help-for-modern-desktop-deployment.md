...
<ul>
<li><p>
  <a href="https://docs.microsoft.com/en-us/fasttrack/o365-onboarding-and-migration#core">Integração principal</a>, na qual os especialistas do Microsoft FastTrack proporcionam uma integração de identidade entre seus serviços de diretório atuais e o Azure Active Directory. Isso é requerido para o Office 365 ProPlus, Microsoft Intune, OneDrive e outros serviços do Office 365 e da nuvem EMS como parte de sua implantação de área de trabalho.</p></li>
</ul></td>
</tr>
<tr class="even">
...
<ul>
<li><p><a href="https://www.microsoft.com/en-us/microsoft-365/success/productivitylibrary/quickly-and-easily-transform-new-devices?rtc=2">Biblioteca de Produtividade</a>, um conjunto de recursos online da Microsoft para a comunicação e treinamento do usuário final no Microsoft 365.</p></li>
...
## <a name="related-resources"></a>**Recursos relacionados**
  ...
  - [Centro de implantação do Computador Moderno](http://www.aka.ms/howtoshift)

  - [Vídeos da série Implantação do Computador Moderno do Microsoft Mechanics](http://www.aka.ms/watchhowtoshift)

  - [Kit de laboratório de implantação e gerenciamento de computador moderno](https://aka.ms/howtoshiftlabs)
