...
1. Usando uma instância privada do navegador da Internet, entre no centro de [Administração do microsoft 365](https://admin.microsoft.com) com a conta de administrador global da sua assinatura de laboratório de teste do Microsoft 365 e5.
