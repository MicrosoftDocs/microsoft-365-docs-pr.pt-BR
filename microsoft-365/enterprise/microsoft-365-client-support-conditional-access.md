...
---
# <a name="microsoft-365-client-app-support-conditional-access"></a>Microsoft 365 Suporte ao aplicativo cliente: Acesso condicional
...
Com Azure Active Directory dispositivo, local e Acesso Condicional baseado em autenticação multifacional, você pode atender a esse novo requisito. O Acesso Condicional é um recurso de Azure Active Directory que permite impor controles no acesso a aplicativos em seu ambiente, tudo com base em condições específicas e gerenciados de um local central.

Saiba mais sobre [Azure Active Directory Acesso Condicional](/azure/active-directory/conditional-access/).

## <a name="supported-clients--platforms"></a>Clientes com suporte & plataformas

As versões mais recentes dos seguintes clientes e plataformas suportam o acesso condicional. Para obter mais informações sobre o suporte à plataforma Microsoft 365, consulte [System requirements for Microsoft 365](/microsoft-365/microsoft-365-and-office-resources).
<br>
<br>
