...
Você pode usar o PowerShell para Microsoft 365 como uma alternativa ao centro de administração Microsoft 365 para gerenciar senhas em Microsoft 365. 

Quando um bloco de comandos neste artigo exigir que você especifique valores variáveis, use estas etapas.

1. Copie o bloco de comando para a área de transferência e a colar em Bloco de notas ou no Ambiente de Script Integrado do PowerShell (ISE).
...
Use esses comandos para especificar uma senha para uma conta de usuário.
...
```
### <a name="force-a-user-to-change-their-password"></a>Forçar um usuário a alterar sua senha

Use esses comandos para definir uma senha e forçar um usuário a alterar sua nova senha.
...
Use esses comandos para forçar um usuário a alterar sua senha.
