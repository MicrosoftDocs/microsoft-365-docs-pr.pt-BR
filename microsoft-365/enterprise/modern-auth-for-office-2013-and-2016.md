...
Leia este artigo para saber como os aplicativos cliente do Office 2013, Office 2016 e Office 2019 usam recursos de autenticação modernos com base na configuração de autenticação no locatário do Microsoft 365 para Exchange Online, SharePoint Online e Skype for Business Online.

> [!NOTE]
> Aplicativos cliente herddos, como o Office 2010 e o Office para Mac 2011, não são suportados pela autenticação moderna e só podem ser usados com autenticação básica.
...
- Ligado **para** o Exchange Online por padrão. Consulte [Habilitar ou desabilitar a autenticação moderna no Exchange Online](https://support.office.com/article/58018196-f918-49cd-8238-56f57f38d662) para desativá-la ou habilita-la. 
    
- Ligado **para** o SharePoint Online por padrão. 
    
- Ligado **para** o Skype for Business Online por padrão. Consulte [Habilitar o Skype for Business Online para autenticação moderna ](https://social.technet.microsoft.com/wiki/contents/articles/34339.skype-for-business-online-enable-your-tenant-for-modern-authentication.aspx)para ative ou desativar.
...
Os aplicativos cliente do Office 2013 suportam a autenticação herdada por padrão. Herdação significa que eles suportam o Assistente de Login do Microsoft Online ou a autenticação básica. Para que esses clientes usem recursos de autenticação moderna, o cliente Windows deve ter chaves do Registro definidas. Para obter instruções, consulte [Habilitar a autenticação moderna para o Office 2013 em dispositivos Windows.](https://support.office.com/article/7dc1c01a-090f-4971-9677-f1b192d6c910)
...
Leia [como usar a Autenticação Moderna (ADAL)](https://go.microsoft.com/fwlink/p/?LinkId=785431) com o Skype for Business para saber como ela funciona com o Skype for Business. 
  
Os clientes do Office 2016 e do Office 2019 suportam a autenticação moderna por padrão, e nenhuma ação é necessária para o cliente usar esses novos fluxos. No entanto, uma ação explícita é necessária para usar a autenticação herdado.
...
A tabela a seguir descreve o comportamento de autenticação para aplicativos clientes do Office 2013, Office 2016 e Office 2019 quando eles se conectam ao Exchange Online com ou sem autenticação moderna.
  
|Versão do aplicativo cliente do Office****|Chave do Registro presente?****|Autenticação moderna em?****|Comportamento de autenticação com a autenticação moderna responsabilidade para o locatário (padrão)****|Comportamento de autenticação com autenticação moderna desligada para o locatário****|
|:-----|:-----|:-----|:-----|:-----|
...
|Office 2016  <br/> |Não, <br> AlwaysUseMSOAuthForAutoDiscover = 1 <br/> |Sim  <br/> |Força a autenticação moderna em 2013, 2016 ou 2019. <br/> [Mais informações](https://support.microsoft.com/help/3126599/outlook-prompts-for-password-when-modern-authentication-is-enabled)|Força a autenticação moderna no cliente do Outlook.<br/> |
...
A tabela a seguir descreve o comportamento de autenticação para aplicativos clientes do Office 2013, Office 2016 e Office 2019 quando eles se conectam ao SharePoint Online com ou sem autenticação moderna.
  
|Versão do aplicativo cliente do Office****|Chave do Registro presente?****|Autenticação moderna em?****|Comportamento de autenticação com a autenticação moderna responsabilidade para o locatário (padrão)****|Comportamento de autenticação com autenticação moderna desligada para o locatário****|
|:-----|:-----|:-----|:-----|:-----|
|Office 2019  <br/> |Não, ou EnableADAL = 1  <br/> |Sim  <br/> |Somente autenticação moderna.  <br/> |Falha ao conectar.  <br/> |
|Office 2019  <br/> |Sim, EnableADAL = 1  <br/> |Sim  <br/> |Somente autenticação moderna.  <br/> |Falha ao conectar.  <br/> |
...
|Office 2016  <br/> |Não, ou EnableADAL = 1  <br/> |Sim  <br/> |Somente autenticação moderna.  <br/> |Falha ao conectar.  <br/> |
|Office 2016  <br/> |Sim, EnableADAL = 1  <br/> |Sim  <br/> |Somente autenticação moderna.  <br/> |Falha ao conectar.  <br/> |
...
|Office 2013  <br/> |Sim, EnableADAL = 1  <br/> |Sim  <br/> |Somente autenticação moderna.  <br/> |Falha ao conectar.  <br/> |
   
### <a name="skype-for-business-online"></a>Skype for Business Online
<a name="BK_SFBO"> </a>

A tabela a seguir descreve o comportamento de autenticação para aplicativos clientes do Office 2013, Office 2016 e Office 2019 quando eles se conectam ao Skype for Business Online com ou sem autenticação moderna.
  
|Versão do aplicativo cliente do Office****|Chave do Registro presente?****|Autenticação moderna em?****|Comportamento de autenticação com a autenticação moderna responsabilidade para o locatário****|Comportamento de autenticação com autenticação moderna desligada para o locatário (padrão)****|
|:-----|:-----|:-----|:-----|:-----|
...
[Entrar no Microsoft 365 com a autenticação multifa factor](https://support.microsoft.com/office/sign-in-to-microsoft-365-with-multi-factor-authentication-2b856342-170a-438e-9a4f-3c092394d3cb)
