...
## <a name="what-is-in-scope-for-teams-migration"></a>O que há no escopo para Teams migração?
...
Os clientes qualificados verão uma página em seu [Microsoft 365 de administração.](https://admin.microsoft.com/) Confira [Como solicitar a movimentação de dados](request-your-data-move.md) para obter instruções sobre como solicitar uma movimentação. 
...
## <a name="i-am-a-microsoft-365-customer-in-one-of-the-new-datacenter-geos-but-when-i-signed-up-i-selected-a-different-country-how-can-i-be-moved-to-the-new-datacenter-geo"></a>Sou um Microsoft 365 cliente em uma das novas geos do datacenter, mas quando me inscredei, selecionei um país diferente. Como posso ser movido para o novo datacenter geo?
...
## <a name="what-happens-if-we-are-in-process-of-email-data-migration-to-microsoft-365-during-the-exchange-online-move"></a>O que acontece se estamos em processo de migração de dados de email para Microsoft 365 durante a Exchange Online de movimentação?
...
## <a name="will-microsoft-365-tenants-hosted-in-the-new-datacenters-be-available-to-users-outside-of-the-country"></a>Os Microsoft 365 hospedados nos novos datacenters estarão disponíveis para usuários fora do país?
