...
> Opções da ferramenta de criação de mídia do Windows 10
...
> Arquivos extraídos de um ISO de 32 bits do Windows 10 Enterprise

Na configuração do Windows 10, você será orientado durante o processo de instalação e a primeira tela fornece uma opção para baixar atualizações, drivers e recursos opcionais. Isso é recomendável para ajudar a garantir o sucesso com a atualização

![](media/windows-7-to-windows-10-upgrade-media/windows-7-to-windows-10-upgrade-media-3.png)

> Tela de configuração inicial do Windows 10

Depois que as atualizações forem aplicadas, a Instalação do Windows 10 passará para a próxima fase, Selecionar imagem. Aqui, você precisará selecionar sua edição do Windows. Nesse caso, como o PC tem o Windows 7 Enterprise instalado, você selecionaria o Windows 10 Enterprise.

![](media/windows-7-to-windows-10-upgrade-media/windows-7-to-windows-10-upgrade-media-4.png)

> Tela de seleção de imagens do Windows 10 Enterprise de 32 bits

Na próxima tela da Configuração do Windows 10, você recebe os avisos e os termos de licençaa aplicáveis. Depois de ler e entender os avisos e termos, clique em "Aceitar" para continuar ou "Recusar" para cancelar.

![](media/windows-7-to-windows-10-upgrade-media/windows-7-to-windows-10-upgrade-media-5.png)

*Avisos e condições de licença aplicáveis do Windows 10*

Agora o programa de instalação do Windows 10 procurará atualizações adicionais.

![](media/windows-7-to-windows-10-upgrade-media/windows-7-to-windows-10-upgrade-media-6.png)

*Atualizações de configuração do Windows 10*
...
*Opção de atualização do programa de instalação do Windows 10*
...
*Opções de instalação do Windows 10*
...
Agora, o Windows 10 será instalado durante vários minutos, e caso você tenha optado por manter seus arquivos pessoais e aplicativos, tudo estará nos mesmos locais de arquivo, e seus aplicativos estarão disponíveis no Windows 10.

![](media/windows-7-to-windows-10-upgrade-media/windows-7-to-windows-10-upgrade-media-10.png)

*Progresso da instalação do Windows 10*
...
*Windows 10 perguntando por que você está voltando para o Windows 7*

Em muitos casos, a sua versão do Windows 10 terá sido emitida por atualizações, o que pode resolver problemas técnicos. É recomendável verificar se há atualizações e, se encontradas e instaladas, verifique se isso resolve os problemas que você enfrentou.

![](media/windows-7-to-windows-10-upgrade-media/windows-7-to-windows-10-upgrade-media-13.png)

*Recuperação de atualizações do Windows 10*

Se as atualizações não resolverem os problemas e você precisar reverter para a instalação anterior do Windows 7, há uma chance de alguns aplicativos precisarem ser reinstalados - como qualquer aplicativo instalado durante o período de execução do Windows 10 - e algumas configurações podem ser perdidas. É importante saber que os arquivos e os documentos salvos localmente enquanto você usa o Windows 10 permanecem e estarão disponíveis quando você estiver novamente no Windows 7. 

![](media/windows-7-to-windows-10-upgrade-media/windows-7-to-windows-10-upgrade-media-14.png)

*Recuperação do Windows 10: o que você precisa saber*
...
*Recuperação do Windows 10 garante que você tenha credenciais de logon da instalação anterior*
...
*Tela final de recuperação do Windows 10 para voltar para o Windows 7*
