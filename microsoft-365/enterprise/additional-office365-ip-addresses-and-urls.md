...
| 11  | Autenticação híbrida do Azure AD do Exchange | *.msappproxy.net | Tráfego somente do servidor de saída TCP |
...
[Intervalos de IP do Azure e Marcas de Serviço – Nuvem da China](https://www.microsoft.com/download/details.aspx?id=57062)
