...
<table border="0">
 <tr>
 <td>
  <strong>Atualizar do Windows 7 para o Windows 10 </strong><p>O suporte estendido do Windows 7 termina em 14 de janeiro de 2020. A atualização in-loco do Windows 7 para o Windows 10 é o método mais rápido de implantá-lo. Você pode <a href="https://docs.microsoft.com/pt-BR/microsoft-365/enterprise/windows-7-to-windows-10-upgrade-manual">atualizar um único PC</a> ou <a href="https://docs.microsoft.com/pt-BR/microsoft-365/enterprise/windows-7-to-windows-10-upgrade-automated">atualizar milhares de PCs usando o System Center Configuration Manager</a>. Não é necessário se concentrar na entrega de aplicativos, na migração de arquivos, na imagem personalizada ou na habilitação de serviços baseados na nuvem com atualizações in-loco. Você pode usar as ferramentas que já tem para atualizar os computadores existentes e se concentrar nas seguintes etapas de implantação para atualizações: </td>
 </tr>
 <tr>
 <td>
    <table border="0">
     ...
     <td>
        <table border="0">
             <tr>
              ...
              <td>
              <strong>Atualizar o ConfigMgr para o Branch atual</strong>
                  </td>
                 </tr>
                </table>
    </td>
        ...
        <table border="0">
             <tr>
              ...
              <td>
              <strong>Validar a preparação de dispositivos e aplicativos</strong>
                  </td>
                 </tr>
                </table>
    </td>
        ...
        <table border="0">
             <tr>
              ...
              <td>
              <strong>Atualizar computadores com Windows 7 para o Windows 10</strong>
                  </td>
                 </tr>
                </table>
        </td>
    ...
    <tr>
    <td>
Parte da etapa de prontidão de rede e de diretório para organizações que usam o SCCM </td>
    <td>
Parte da etapa de preparação do dispositivo e do aplicativo; a ajuda está disponível por meio da Garantia de Aplicativo da Área de Trabalho </td>
    <td>
Etapa das atualizações de recursos e implantação do OS para PCs mantidos pelo usuário </td>
    </tr>
</table>
...
Siga as etapas abaixo para planejar e executar sua implantação em grande escala do Windows 10 e do Office 365 ProPlus. Cada etapa abaixo faz parte de um processo geral de planejamento e implantação com etapas normalmente sendo executadas em paralelo umas às outras em uma implantação em fases. Baixe o aplicativo [Kit de Laboratório de Implantação e Gerenciamento do Computador](https://aka.ms/howtoshiftlabs) para ter um treinamento prático com as ferramentas destacadas no processo de implantação. Você também pode [obter ajuda](https://aka.ms/mddhelp) para a sua implantação do computador dos parceiros da Microsoft e serviços do FastTrack.
...
<p>Descubra os benefícios de mover para o Windows 10 e Office 365 ProPlus, as principais mudanças e considerações versus implantações anteriores e as práticas recomendadas para garantir uma transição suave para o Windows 10 e Office 365 ProPlus.</p></td>
...
<p>Certifique-se de que seus aplicativos estão empacotados e preparados para a instalação automatizada. Saiba como o empacotamento Clique para Executar com o Office 365 ProPlus oferece novas opções para configurar, oferecer e manter seus aplicativos do Office atualizados.</p></td>
...
<p>O Windows 10 e o Office 365 ProPlus fornecem novas maneiras de proteger seus dados, dispositivos, usuários e detecta e responde rapidamente a ameaças. Saiba também como lidar com problemas comuns associados a criptografia de disco, aplicativos anti-malware e políticas ao mover para o Windows 10.</p></td>
...
<p>Tanto o Windows 10 como o Office 365 ProPlus adicionam continuamente novos recursos para prosseguir com as experiências de usuários e segurança com as inovações mais recentes. Saiba como manter-se atualizado com as atualizações semestrais e mensais, como o novo modelo de manutenção funciona e as ferramentas e opções que você tem.</p></td>
...
<p>Certifique-se de que os usuários sejam informados sobre as novas experiências e novas maneiras de trabalhar à medida que você atualiza os PCs com o Windows 10 e o Office 365 ProPlus. Saiba como aproveitar a ajuda de adoção do usuário com o Microsoft FastTrack, materiais de treinamento e modelos de comunicação, bem como novas maneiras de monitorar o uso e a aceitação do usuário.</p></td>
...
<td><p><strong><a href="https://transform.microsoft.com" target="_blank">Integre sua liderança: Descoberta de valor e caso comercial</a></strong></p>
<p>Se você pesquisou sobre implantações, avaliou a preparação de aplicativos e dispositivos, criou o seu plano de implantação e começou a testar sua implantação, mas a sua equipe de gerenciamento não consegue oferecer o suporte ou os recursos necessários para atender seus cronogramas de implantação, o Business Value Program da Microsoft pode ajudar. Saiba como criar um caso de negócios para mover para o Windows 10 e o Office 365 ProPlus e para ajudá-lo a integrar todos.</p></td>
