        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Atualizar o ConfigMgr para o Branch Atual</h3>
            <p>Parte da etapa de Preparação de Redes e Diretórios para organizações que usam o Gerenciador de Configurações</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Validar a preparação de dispositivos e aplicativos</h3>
            <p>Parte da etapa de Preparação de Aplicativos e Dispositivos; a ajuda está disponível por meio da Garantia de Aplicativo da rea de Trabalho</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Atualizar computadores com Windows 7 para o Windows 10</h3>
            <p>Parte da etapa das Atualizações de Recursos e Implantação do OS para computadores mantidos pelo usuário</p>
                    </div>
                </div>
            </div>
        </div>
