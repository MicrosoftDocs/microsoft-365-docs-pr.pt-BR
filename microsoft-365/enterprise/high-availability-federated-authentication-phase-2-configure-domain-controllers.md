 ...
 **Tabela M - Máquinas virtuais para a autenticação federada de alta disponibilidade para Microsoft 365 no Azure**
...
Em seguida, você precisará atualizar os servidores DNS da sua rede virtual, para que o Azure atribua máquinas virtuais aos endereços IP dos dois novos controladores de domínio para uso como seus servidores DNS. Preencha as variáveis e execute esses comandos de um prompt de Windows PowerShell de comando no computador local:
