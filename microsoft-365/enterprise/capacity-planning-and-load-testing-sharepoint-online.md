...
description: Este artigo descreve como você pode implantar no SharePoint Online sem realizar testes de carga tradicionais, pois não é permitido.
...
Este artigo descreve como você pode implantar no SharePoint Online sem testes de carga tradicionais, pois o teste de carga não é permitido no SharePoint Online. O SharePoint Online é um serviço de nuvem e os recursos de carga, a saúde e o saldo geral de carga no serviço são gerenciados pela Microsoft.
...
## <a name="why-you-cannot-load-test-sharepoint-online"></a>Por que você não pode carregar o teste do SharePoint Online
