...
Todas as medições de teste de máquinas clientes incluem as informações de sub-rede da rede local, que são correlacionadas aos detalhes de local do Office inseridos. Os exemplos de medidas e locais do Office devem começar a aparecer 24 horas após os pré-requisitos terem sido atendidos.
