...
---
# <a name="turn-off-directory-synchronization-for-microsoft-365"></a>Desativar a sincronização de diretório para Microsoft 365
...
1. Primeiro, instale o software necessário e conecte-se à sua Microsoft 365 assinatura. Para obter instruções, [consulte Conexão com o módulo Microsoft Azure Active Directory para Windows PowerShell](connect-to-microsoft-365-powershell.md#connect-with-the-microsoft-azure-active-directory-module-for-windows-powershell).
