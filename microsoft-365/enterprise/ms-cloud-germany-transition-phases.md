...
Para saber mais sobre as diferenças entre as organizações na migração e após a migração dos recursos do Exchange Online, revise as informações na experiência do cliente durante a migração para os serviços do [Office 365](ms-cloud-germany-transition-experience.md)nas novas regiões de datacenter alemãs.
