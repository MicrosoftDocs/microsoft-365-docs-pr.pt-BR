...
#### [Etapa 1: criar e proteger suas contas de administrador global](identity-create-protect-global-admins.md)
#### [Etapa 2: proteger suas senhas](identity-secure-your-passwords.md)
#### [Etapa 3: proteger e gerenciar suas entradas de usuário](identity-secure-user-sign-ins.md)
#### [Etapa 4: adicionar suas contas de usuário](identity-add-user-accounts.md)
#### [Etapa 5: usar grupos para gerenciamento](identity-use-group-management.md)
#### [Etapa 6: configurar a governança de identidade](identity-configure-identity-governance.md)
