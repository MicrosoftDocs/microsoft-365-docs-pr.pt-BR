...
#### [Etapa 1: Planejar para usuários e grupos](identity-plan-users-groups.md)
#### [Etapa 2: Proteger contas de administradores globais](identity-designate-protect-admin-accounts.md)
#### [Etapa 3: Configurar administradores globais sob demanda](identity-privileged-identity-management.md)
#### [Etapa 4: Simplificar redefinições de senha](identity-password-reset.md)
#### [Etapa 5: Configurar autenticação multifatorial](identity-multi-factor-authentication.md)
#### [Etapa 6: Proteger contra o comprometimento de credenciais](identity-azure-ad-identity-protection.md)
#### [Etapa 7: Sincronizar diretórios](identity-azure-ad-connect.md)
#### [Etapa 8: Monitorar a integridade da sincronização](identity-azure-ad-connect-health.md)
#### [Etapa 9: Simplificar as atualizações de senha](identity-password-writeback.md)
#### [Etapa 10: Simplificar entrada de usuários](identity-single-sign-on.md)
#### [Etapa 11: Personalizar páginas de entrada do Office 365](identity-customize-office-365-sign-in.md)
#### [Etapa 12: Configurar licenciamento automático](identity-group-based-licensing.md)
#### [Etapa 13: Monitorar a atividade de entrada e do locatário](identity-azure-ad-access-usage-reporting.md)
#### [Etapa 14: Permitir que usuários criem e gerenciem os próprios grupos](identity-self-service-group-management.md)
#### [Etapa 15: Configurar associação de grupo dinâmica](identity-automatic-group-membership.md)
...
#### [Etapa 3: Configurar mais segurança para o Office 365](infoprotect-configure-increased-security-office-365.md)
...
#### [Write-back de senha](password-writeback-m365-ent-test-environment.md)
...
# [Centro de implantação do Computador Moderno](desktop-deployment-center-home.md)
...
## [Etapa 7: Windows e Office como um serviço](step-7-windows-and-office-as-a-service.md)
## [Etapa 8: Treinamento e comunicações de usuários](step-8-user-communications-and-training.md)
## [Kit de laboratório de implantação e gerenciamento de computador moderno](modern-desktop-deployment-and-management-lab.md)
...
## [Políticas de acesso recomendadas do Exchange Online](secure-email-recommended-policies.md)
