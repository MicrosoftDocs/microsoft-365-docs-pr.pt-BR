...
Para informações detalhadas, confira [Otimizar a conectividade para usuários remotos usando o túnel dividido VPN](https://docs.microsoft.com/office365/enterprise/office-365-vpn-split-tunnel).
