...
Uma nova seção aparece no lado direito da tela para aceitar sua confirmação. Selecione **Sim** e clique em **Salvar**.
...
## <a name="what-happens-after-opting-in-for-migration"></a>O que acontece depois de optar pela migração?

As migrações começarão no início de 2021 para organizações que optam pela abordagem orientada pela Microsoft e serão concluídas antes da data de aposentadoria do Microsoft Cloud Germany (Microsoft Cloud Deutschland) em 29 de outubro de 2021.  Como resultado da migração, os dados principais e assinaturas do cliente serão movidos para as novas regiões alemãs.  A Microsoft postará atualizações em todo o processo de migração no Centro de Mensagens. Confira [estes artigos](#more-information) para saber mais.
