...
- **Dynamics 365**, faça [esta etapa.](#dynamics-365)
...
Durante a migração, enquanto sua organização estiver entre a fase 2 e a fase 9, você não pode adicionar qualquer aplicativo multi-locatário (MTA) de terceiros à sua organização. Quando a migração terminar a fase 9, você poderá continuar adicionando ou consentindo em aplicativos MTA para sua organização.
