...
Ative Microsoft 365 contas de usuário para as contas migradas atribuindo licenças. Se você não atribuir uma licença, a caixa de correio será desabilitada quando terminar o período de cortesia (30 dias). Para atribuir uma licença no centro de administração Microsoft 365, consulte [Atribuir ou desatribuição de licenças](../admin/manage/assign-licenses-to-users.md).
