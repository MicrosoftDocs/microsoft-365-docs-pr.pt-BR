...
2. No centro de administração, escolha **Usuários** \> **Usuários ativos.**
...
- **Quão pequena ou grande pode ser a planilha?** A planilha deve ter pelo menos duas linhas. One is for the column headings (the user data column label) and one for the user. You cannot have more than 251 rows. If you need to import more than 250 users, you can create more than one spreadsheet.
...
|:-----|:-----|
|Nome de Usuário (Obrigatório)  <br/> |79 incluindo o sinal de at (@), no formato name@domain. \<extension\> . O alias do usuário não pode exceder 50 caracteres e o nome de domínio não pode exceder 48 caracteres.  <br/> |
|Nome  <br/> |64  <br/> |
|Sobrenome  <br/> |64  <br/> |
