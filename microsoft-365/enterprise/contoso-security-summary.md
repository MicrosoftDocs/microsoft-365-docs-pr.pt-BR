...
Para obter aprovação para implantar Microsoft 365 para empresas, o departamento de segurança de IT da Contoso realizou uma revisão completa de segurança. Eles identificaram os seguintes requisitos de segurança para a nuvem:
...
## <a name="the-contoso-path-to-microsoft-365-security-readiness"></a>O caminho da Contoso para Microsoft 365 de segurança

A Contoso seguiu estas etapas para preparar sua segurança para sua implantação de Microsoft 365 para empresas:
...
2. Classificar dados em três níveis de segurança
   ...
   A Contoso fez uma revisão cuidadosa e determinou os três níveis, que foram usados para identificar o Microsoft 365 para recursos corporativos para proteger os dados mais valiosos.
...
Para seguir as práticas recomendadas de segurança e Microsoft 365 requisitos de implantação corporativa, os administradores de segurança da Contoso e seu departamento de IT implantaram muitos recursos e recursos de segurança, conforme descrito nas seções a seguir.
...
- Autenticação Multifator para todas as contas de usuário
  ...
  O MFA adiciona uma camada adicional de proteção ao processo de login. Exige que os usuários reconheçam uma chamada telefônica, uma mensagem de texto ou uma notificação de aplicativo em seu smartphone depois de inserir corretamente a senha. Com o MFA, as contas de usuário do Azure AD são protegidas contra a in-loco não autorizada, mesmo que uma senha de conta seja comprometida.
   ...
   - Para proteger contra o comprometimento da assinatura Microsoft 365, a Contoso requer MFA em todas as contas de administrador global.
...
- Windows Hello para Empresas
  ...
  A Contoso [implantou o Windows Hello para Empresas](/windows/security/identity-protection/hello-for-business/hello-identity-verification) para eliminar a necessidade de senhas por meio da autenticação de dois fatores forte em PCs e dispositivos móveis que executam Windows 10 Enterprise.

- Windows Defender Credential Guard

  Para bloquear ataques direcionados e malware em execução no sistema [](/windows/security/identity-protection/credential-guard/credential-guard) operacional com privilégios administrativos, a Contoso Windows Defender Credential Guard por meio da política de grupo do AD DS.
...
- Proteger o fluxo de email e o log de auditoria de caixa de correio com o Microsoft Defender para Office 365 

  A Contoso está usando Proteção do Exchange Online [e o Defender para](/office365/securitycompliance/office-365-atp) Office 365 proteção contra malwares desconhecidos, vírus e URLs mal-intencionadas transmitidas por emails.
...
- Monitoramento e prevenção contra ataques com investigação e resposta a ameaças do Office 365
  ...
  A Contoso [usa Office 365](/office365/securitycompliance/office-365-ti) e resposta contra ameaças para proteger os usuários, facilitando a identificação e o endereço de ataques e evitando ataques futuros.
...
- Painel central de segurança para os usuários com a Central de Segurança do Windows Defender
  ...
  A Contoso implantou [o aplicativo Segurança do Windows](/windows/security/threat-protection/windows-defender-security-center/windows-defender-security-center) em seus PCs e dispositivos em execução Windows 10 Enterprise para que os usuários possam ver sua postura de segurança rapidamente e tomar medidas.