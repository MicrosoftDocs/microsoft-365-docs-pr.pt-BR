...
Quando uma conta do Microsoft 365 é atribuída a uma licença de um plano de licenciamento, os serviços do Microsoft 365 são disponibilizados para o usuário a partir dessa licença. No entanto, você pode controlar os serviços do Microsoft 365 que o usuário pode acessar. Por exemplo, mesmo que a licença permita acesso ao serviço do SharePoint Online, você pode desabilitar o acesso a ela. Você pode usar o PowerShell para desabilitar o acesso a qualquer número de serviços para um plano de licenciamento específico para:
...
Para ver os resultados antes e depois dos procedimentos neste tópico, consulte Exibir a licença da conta e os detalhes do serviço [com o PowerShell.](view-account-license-and-service-details-with-microsoft-365-powershell.md)
...
### <a name="disable-specific-microsoft-365-services-for-specific-users-for-a-specific-licensing-plan"></a>Desabilitar serviços específicos do Microsoft 365 para usuários específicos para um plano de licenciamento específico
...
#### <a name="step-1-identify-the-undesirable-services-in-the-licensing-plan-by-using-the-following-syntax"></a>Etapa 1: Identifique os serviços indesejáveis no plano de licenciamento usando a seguinte sintaxe:
...
Para obter mais informações sobre como criar contas de usuário no PowerShell para o Microsoft 365, consulte [Criar contas de usuário com o PowerShell.](create-user-accounts-with-microsoft-365-powershell.md)
...
Para desabilitar os serviços descritos na Etapa 1 para todos os usuários licenciados existentes, especifique o nome do seu plano do Microsoft 365 na exibição do cmdlet **Get-MsolAccountSku** (como **litwareinc:ENTERPRISEPACK)** e execute os seguintes comandos:
...
```
 ...
 Se você usar o cmdlet **Get-MsolUser** sem usar o parâmetro _All,_ somente as primeiras 500 contas de usuário serão retornadas.
...
1. Crie um arquivo de texto que contenha uma conta em cada linha da seguinte forma:
   ...
   Neste exemplo, o arquivo de texto é C: \\ Meus \\ DocumentosAccounts.txt.
...
Para desabilitar os serviços do Microsoft 365 para usuários enquanto você os atribui a um plano de licenciamento, confira Desabilitar o acesso aos serviços ao atribuir [licenças de usuário.](disable-access-to-services-while-assigning-user-licenses.md)
