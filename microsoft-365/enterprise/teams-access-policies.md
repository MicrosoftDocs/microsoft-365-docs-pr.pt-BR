...
Recomendações adicionais específicas para a implantação do Microsoft Teams estão incluídas neste artigo para abranger circunstâncias de autenticação específicas, incluindo usuários de fora da sua organização, e você precisará seguir estas orientações para uma experiência de segurança completa.
...
Para obter mais informações sobre acesso externo e como implementá-lo, caso precise, revise [gerenciar o acesso externo no Microsoft Teams](https://docs.microsoft.com/en-us/microsoftteams/manage-external-access)
...
É recomendável alterar a política padrão ou criar políticas personalizadas, e você pode saber mais sobre o gerenciamento de suas políticas neste link: [gerenciar políticas de equipes no Microsoft Teams](https://docs.microsoft.com/en-us/microsoftteams/teams-policies).
...
Consulte [gerenciar políticas de reunião no Teams](https://docs.microsoft.com/en-us/microsoftteams/meeting-policies-in-teams) para obter mais informações.
...
Para obter mais informações sobre políticas de permissão de aplicativo, confira [Manage app Permission Policies in Microsoft Teams](https://docs.microsoft.com/en-us/microsoftteams/teams-app-permission-policies).
