...
Este artigo fornece recomendações de desempenho para sites de portal modernos no SharePoint Online. Use as diretrizes deste artigo para otimizar o desempenho moderno do site do portal e evitar problemas comuns de desempenho.
...
|Chamadas para o serviço UPA  <br/> |1 por usuário por hora  <br/> |Recomendamos que você não faça chamadas _por_ solicitação para o serviço UPA (Aplicativo de Perfil de Usuário). A [API do Microsoft Graph](/graph/call-api) e [PageContext](/javascript/api/sp-page-context/pagecontext?view=sp-typescript-latest) podem ser usadas para consultar informações do usuário.  <br/> Se uma chamada de serviço UPA for necessária, faça uma única chamada quando necessário e, em seguida, armazenar em cache as informações para reutilização na mesma sessão. |
...
[Criando um portal do SharePoint saudável](/sharepoint/portal-health)
