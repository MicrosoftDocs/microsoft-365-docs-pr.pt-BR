...
---
# <a name="manage-sharepoint-with-powershell"></a>Gerenciar SharePoint com o PowerShell

*Esse artigo se aplica ao Microsoft 365 Enterprise e ao Office 365 Enterprise.*

SharePoint administradores têm que gerenciar sites, grupos de sites e usuários. Embora você possa fazer algumas dessas tarefas no centro de administração Microsoft 365, outras são mais fáceis no PowerShell. Para saber mais, confira os seguintes artigos:
