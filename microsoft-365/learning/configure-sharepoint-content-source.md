...
ms.locfileid: "53289938"
---
# <a name="configure-sharepoint-as-a-learning-content-source-for-microsoft-viva-learning-preview"></a><span data-ttu-id="d7225-103">Configurar SharePoint como uma fonte de conteúdo de aprendizagem para o Microsoft Viva Learning (Visualização)</span><span class="sxs-lookup"><span data-stu-id="d7225-103">Configure SharePoint as a learning content source for Microsoft Viva Learning (Preview)</span></span>

> [!NOTE]
> <span data-ttu-id="d7225-104">Esse recurso ainda não está disponível na visualização do produto.</span><span class="sxs-lookup"><span data-stu-id="d7225-104">This feature is not yet available in product preview.</span></span>
