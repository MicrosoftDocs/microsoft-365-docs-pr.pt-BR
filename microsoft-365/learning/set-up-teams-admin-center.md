...
1. Habilitar recursos de Visualização Pública para usuários Learning (Visualização).
...
2. Modifique a política de permissão do aplicativo para usuários Learning (Visualização).
...
3. Notifique os usuários que testarão o Viva Learning (Visualização) para alternar seu cliente de com build para [Visualização Pública para](set-up-teams-admin-center.md#user-steps-for-public-preview-tenants)Teams .

> [!IMPORTANT]
> Para locatários de Visualização Pública, o Viva Learning  (Visualização) não será exibido em aplicativos gerenciados no centro de administração Teams até a versão final do produto. No entanto, os usuários habilitados para Visualização Pública podem encontrar o Viva Learning (Visualização) no Teams de aplicativos e usá-lo, depois que as políticas e permissões corretas foram configuradas.
...
3. Os usuários agora podem encontrar o Viva Learning (Visualização) no Teams de aplicativos e começar a usá-lo.
...
Para locatários de Visualização Privada, não há políticas adicionais que precisam ser habilitadas. No entanto, o Viva Learning (Visualização) deve ser disponibilizado para usuários em sua organização.
...
3. Na página **Viva Learning (Visualização),** em **Status**, selecione **Permitido** ativar o Viva Learning (Visualização).
